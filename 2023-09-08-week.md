...
In my (figurative) backyard, we have the example that {% wiki Robert_Moses|Robert Moses|en %} apparently lowered bridges on major roads and reduced parking at our parks for large vehicles, all to decrease the chances of public transit dropping off non-white people.  We all hear versions of this, growing up, yet somehow, nobody ever fixes the problem, thus perpetuating over decades.
