...
Here's the creator's description of the strip.

 > O **Homem-Grilo** é um super-herói que ganhou seus poderes ao ser mordido por um grilo radioativo (se é que os grilos mordem). O personagem foi criado por [Cadu Simões](https://cadusimoes.com) (e o visual desenvolvido por **Ricardo Marcelino**). Ele é o principal defensor de **Osasco City** (uma versão megalópole da cidade real de Osasco) e suas histórias em quadrinhos são uma paródia ao universo dos super-heróis.
 >
...
Translated to English, that looks more like this.
