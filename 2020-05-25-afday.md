...
categories:
tags: [programming, project, devjournal, bicker]
labels: [cprep, font, javascript]
...
Today is {% wiki Africa_Day|Africa Day|en %}, commemorating the African Union's founding.

![Africa](/blog/assets/Africa_and_Europe_from_a_Million_Miles_Away.png "Africa")

If you want to be *that* person, it's apparently also {% wiki Geek_Pride_Day|Geek Pride Day|en %}, but since so-called "geek culture" revolves so much around big-corporate-controlled media franchises...eh.

Probably more importantly where I live, it's also {% wiki Memorial_Day|Memorial Day|en %} in the United States, where we mourn those who have died in the line of military duty.  It'd be nice if we could stop adding to their ranks.  It'd also be nice if politicians could just once remember what the holiday is for and not wish us a "happy" one and opining about who is blessing the country, but baby steps, I guess...
