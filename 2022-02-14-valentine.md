...
Yep, the best holiday that I could scrounge up for today is the absurdly obvious {% wiki Valentine%27s_Day|Valentine's Day|en %}.  It turns out that there were a bunch of Christian martyrs known as Valentine, which explains the varying contradictory claims about the "real" origins of the holiday.  Regardless of which Saint Valentine is supposed to be the one we care about, today, the celebration actually appears to have been a relatively recent creation, first reported by Geoffrey Chaucer in {% wiki Parlement_of_Foules|*Parliament of Fowls*|en %} (1382), possibly even accidentally *created* in that poem, as later readers assumed that a then-current event was actually a widespread celebration.
