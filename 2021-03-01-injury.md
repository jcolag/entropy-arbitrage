...
labels: [markdown, miniboost, nonogram]
...
Today celebrates a grassroots awareness campaign, {% wiki Self-injury_Awareness_Day|Self-Injury Awareness Day|en %}, in an attempt to destigmatize self-harm, so that it's easier for people to seek help.  Given the connections between self-harm and depression, this is important.
