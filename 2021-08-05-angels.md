...
There have been mentions of {% wiki Aldebaran|Aldebaran|en %} in [*Where No Man Has Gone Before*]({% post_url 2020-01-23-trek-no-man %}), [*Operation---Annihilate*]({% post_url 2020-07-30-opann %}), [*Amok Time*]({% post_url 2020-08-13-amok %}), and [*The Deadly Years*]({% post_url 2020-10-29-deadly %}), so there shouldn't be much reason to talk about it here, except to note that it's prominent enough to have a "sector" named after it, suggesting that a sector might be similar to a {% wiki Metropolitan_area|metropolitan area|en %}.

Muldoon is such a common Irish surname that it's functionally meaningless as a planet name.  Probably the most period-appropriate reference is the so-called {% wiki Curse_of_Muldoon|Curse of Muldoon|en %}.
...
I don't know if I'm ready to unpack Kirk's comment, here, from the food references with an implied scale of social value---and despite the name, I can't find any evidence that anybody considers {% wiki Chicken_%C3%A0_la_King|Chicken à la King|en %} to be fancy---to the idea that diplomatic {% wiki Attach%C3%A9|attachés|en %} (specialist advisors on a diplomat's team) are still fairly common.
...
Coridan, as a prior note mentions, comes from [*Journey to Babel*]({% post_url 2020-10-15-babel %}), but I mostly quote this for Sulu not knowing about {% wiki Clam|clams|en %}.  Because I'm an ugly American, I was going to mention the {% wiki Puja_%28Hinduism%29|puja|en %} and the {% wiki Corroboree|corroborree|en %} as "new," but the Internet kindly corrected that notion.

 > "Good grief, it is the {% wiki East_India_Company|British East India Company|en %}...Mister Sulu?"
 >
 > "The {% wiki North_West_Company|Yukon Fur Trading Company|en %}, sir."
 >
 > As the reports came in...The {% wiki South_Sea_Company|South Sea Bubble Company|en %}...The {% wiki Muscovy_Company|Muscovy Trading Company|en %}..."Vozdhrovia!" mumbled Chekov...The {% wiki Levant_Company|Governors and Company of the Merchants of the Levant|en %}...The {% wiki Great_Western_Railway|Great Western Railway Company|en %}... All with the same story. And contracts.
...
I can't find any useful reference to "Akladi," other than it being a family name in Eastern Europe.  {% wiki Actinium|Actinium|en %} exists, one of the first elements found that don't naturally exist on Earth; we might hypothesize that **pro**actinium could be an element that degrades into actinium, but it's otherwise original to the episode.
...
Sure.  Why not the {% wiki Taj_Mahal|Taj Mahal|en %}?
...
I believe that this is the first (only?) time that we've heard of a "Klingon-Romulan League."  I know that {% wiki Star_Trek:_The_Role_Playing_Game|one game|en %} would later posit an alliance between the two powers, but that's off in the future and not by this name.
...
Instead, he basically shouts a bunch of words that seem to be a Russian retelling of the story of {% wiki Alexander_the_Great|Alexander the Great|en %} or {% wiki Timur|Tamerlane|en %}, though we later find that he believes he's the latter.  Running the names through the computer, they find planets named for {% wiki Kuban|Kuban|en %} and {% wiki Sarai_%28city%29|Sarai|en %}.
...
The beep refers to quantum mechanics/quantum electrodynamics expert {% wiki Paul_Dirac|Paul Dirac|en %}.  {% wiki The_Quincunx_of_Time|**The Quincunx of Time**|en %} has nothing to do with the *Star Trek* franchise, other than the author's wife using this story to advertise the re-released novel version.  Despite the link on the Wikipedia page, the copyright on the original novella, **Beep**, was renewed on schedule in 1981, RE0000098735.

If you're here trying to figure out what the heck a quincunx is and came here instead of {% wiki Quincunx|the Wikipedia article|en %}, it's a set of five dots in a cross pattern (⁙).  The story refers to the analogous orchard layout.
...
Well, we now have a fairly good idea of where the Romulans live.  {% wiki 47_Tucanae|NGC 104|en %} or 47 Tucanae (47 Tuc) is the mentioned cluster, sitting around thirteen *thousand* light years from Earth.  It doesn't seem likely that Earth could have fought a war with them and enforced the restrictive borders that we've seen, though, prior to either power having access to faster-than-light travel.
...
That's a lot of quote, granted, to call out the {% wiki Small_Magellanic_Cloud|Small Magellanic Cloud|en %}.  Otherwise, I find it best not to ask why we're not worried about anybody's psychic powers or how the Barrier threw the *Enterprise* into another galaxy or how that constitutes a "barrier" at all.
...
Also, {% wiki Shere_Khan|Shere Khan|en %} is a character from **The Jungle Book**, apparently still popular enough of a book to inspire company names.
