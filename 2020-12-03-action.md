...
The book was also influential enough, apparently, that someone on the *Horizon* had a physical copy that they presented as a gift, along with (as Oxmyx says next) books about building radios.  Interestingly, as predictions go, this is fairly accurate, given that the commercial success of {% wiki Goodfellas|**Goodfellas**|en %} (1990) launched years of cheap knockoffs, though not much set in the 1920s.
...
It should go without saying, but even explicit Christian theocracies like {% wiki Vatican_City|Vatican City|en %} haven't used the Bible as a blueprint for their society.  Does this mean that the Federation does?  That could explain why Spock dutifully cites scripture so frequently, but the predominance of civilian concerns about money and general military power seem to conflict with what the book actually has to say.
...
As we've discussed a few times, {% wiki Antares|Antares|en %} is a star, not a constellation, so there is no "beta."
...
The term "flivver" was a nickname for the {% wiki Ford_Model_T|Ford Model T|en %} that came to be American slang for any automobile.  If you happen to be a Harold Lloyd fan, you've probably heard of {% wiki Luke%27s_Fatal_Flivver|**Luke's Fatal Flivver**|en %}, for example, and one of Upton Sinclair's lesser-known works is {% wiki The_Flivver_King|**The Flivver King**|en %}.
