...
thumbnail: /blog/assets/nanobots-in-circuits.png
...
![An army of tiny robots crawling across a futuristic circuit board](/blog/assets/nanobots-in-circuits.png "No kill I?")
...
**Credits**: I assembled the header image from [Integrated circuits (4)](https://commons.wikimedia.org/wiki/File:Integrated_circuits_(4).jpg) by [T137](https://commons.wikimedia.org/wiki/User:T137) and [Rocket Robot - 3D Animation](https://commons.wikimedia.org/wiki/File:Rocket_Robot_-_3D_Animation.png) by [Kurt Kaiser](https://commons.wikimedia.org/w/index.php?title=User:Kurtkaiser&action=edit&redlink=1), made available under the terms of the [Creative Commons Attribution Share-Alike 3.0 Unported](https://creativecommons.org/licenses/by-sa/3.0/deed.en) license and the [Creative Commons CC0 1.0 Universal Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0/deed.en), respectively.  It previously used an image assembling components generated by [NightCafé Studio](https://nightcafe.studio/) as a placeholder.
