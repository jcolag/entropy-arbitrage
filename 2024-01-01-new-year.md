...
labels: [newsletter, notoboto, twitter]
...
Like I assumed [last week that I didn't need to explain Christmas]({% post_url 2023-12-25-christmas %}) to anyone, this week, I assume that nobody needs me to tell them about {% wiki New_Year%27s_Day|New Year's Day|en %}, celebrated today wherever people use the Gregorian calendar.  I suppose that other calendars also celebrate New Year's Day today, but their today doesn't fall on today, and...no, that route through the conversation quickly grows too confusing...
