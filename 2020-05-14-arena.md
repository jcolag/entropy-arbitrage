...
Maybe related to this peculiarity, a {% wiki Cestus|cestus|en %} is a Greco-Roman equivalent to a boxing glove (the term is Roman; the Greek term is μειλίχαι/meilichae), though the glove in that case is designed more to damage the opponent like brass knuckles than to protect the delicate bones in the hand.
...
*Do* "most humans" "have an instinctive revulsion to reptiles"?  That doesn't sound right.  I can't find any statistics on {% wiki Herpetophobia|herpetophobia|en %}'s frequency in the population, so I guess we'll just need to take Kirk's word for it, for now.
 ...
 * The word "outpost" tends to refer to a small military base, and the primary non-military use is {% wiki Israeli_outpost|unauthorized Israeli settlements|en %} on land the builders don't own.
...
{% wiki Sirius|Sirius|en %} is the brightest star (other than the Sun) visible from Earth, seen in the Northern Hemisphere, and is about nine light years away.  {% wiki Canopus|Canopus|en %} is a bright star in the Southern Hemisphere, and is around three hundred light years away, last mentioned in [*Where No Man Has Gone Before*]({% post_url 2020-01-23-trek-no-man %}) as where Tarbold wrote *The Nightingale Woman*.  Arcanis appears to be original to the episode.
