...
I'm going to be blunt.  This is the *actual* reason that conservatives have picked Critical Race Theory.  It's their modern version of mis-quoting {% wiki Martin_Luther_King_Jr.|Martin Luther King, Jr.|en %} to pretend that it's less racist to ignore racism.  They *love* divisiveness, which is why they campaign on it exclusively.  But they're terrified of an engaged electorate that intends to improve the country.
...
I should note that, in the past, I have defended the filibuster on the grounds that it's one of the few actions that can block bad faux-emergency "we have to do something" legislation like the {% wiki Patriot_Act|Patriot Act|en %} from passing.  What convinced me that I was wrong was trying to find examples of that benefit, and only being able to turn up the attempt to stop the {% wiki Civil_Rights_Act_of_1964|Civil Rights Act|en %}.  In recent memory, bad *partisan* bills just get laundered through budget reconciliation rules, and nobody opposes the bad bipartisan bills.
