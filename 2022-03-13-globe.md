...
As with last week, this is *loosely* inspired by the {% wiki Wordle|Wordle|en %} craze, in that you're using guesses to zero in on your target.  But it's also a problem in multiple dimensions.
...
Like the Daily Nonogram and Daily Iungimoji, the Daily G.L.O.B.E. updates a bit after midnight, {% wiki Eastern_Time_Zone|Eastern Time|en %}.
