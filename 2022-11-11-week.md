...
Incidentally, happy {% wiki Armistice_Day|Armistice Day|en %}---{% wiki Veterans_Day|Veterans Day|en %} in the United States and {% wiki Remembrance_Day|Remembrance Day|en %} in former British territories---where depending on your circle, either celebrates peace or military service.
