...
Years ago, we would probably have stashed that choice in an {% wiki HTTP_cookie|HTTP cookie|en %}.  That's fine, and you can still do that, especially if you're already setting cookies for things like authentication.
