...
While it's not Free Culture, I'm always on-board for an excuse to re-watch {% wiki Star_Trek:_The_Original_Series|**Star Trek**|en %}.  And one of the interesting claims I often see dismissing new voices in the franchise has always been to claim that the world is "supposed to be a utopia" and that deviations from that vision are wrong.
...
If it turns out to be fun, I might continue into the animated series, the movies, and at least early {% wiki Star_Trek:_The_Next_Generation|**Next Generation**|en %} episodes, since a lot of that material either predates or comes from the unproduced {% wiki Star_Trek:_Phase_II|**Star Trek:  Phase II**|en %} series.
