...
Today is both the {% wiki Black_Ribbon_Day|European Day of Remembrance for Victims of Stalinism and Nazism|en %} and the {% wiki International_Day_for_the_Remembrance_of_the_Slave_Trade_and_its_Abolition|International Day for the Remembrance of the Slave Trade and its Abolition|en %}, mouthfuls that represent the lives lost to some of the most vile (and stupid, if we're being brutally honest) regimes in history.
