...
The sudden shift from cursing at each other talking about dating and coursework to a random {% wiki Public_service_announcement|PSA|en %} about drunk driving feels like it comes out of nowhere.  And the random expressions of hatred have also weirdly metastasized into a belief that personality is biological.
