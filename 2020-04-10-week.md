...
The news around {% wiki U.S._Immigration_and_Customs_Enforcement|ICE|en %} has been progressively getting worse since that report, with detained people---even people who have proof of citizenship that's being ignored---begging to be deported, just to get out of the facility.  Thank you to the journalists keeping an eye on that.
...
This is the same organization draging its feet on implementing {% wiki Contact_tracing|contact tracing|en %} due to alleged privacy concerns telling doctors it's fine if they sell your history to insurers.
