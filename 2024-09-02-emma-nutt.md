...
labels: [blog, lights-edge, notoboto, ruby, tcl]
...
Yesterday, we celebrated {% wiki Emma_Nutt|Emma Nutt|en %} Day, who became the world's first female telephone operator.
...
[^1]:  A {% wiki Series_of_tubes|series of tubes|en %}, you might even say...
...
You can also insert my usual early September rant, here, groaning about the {% wiki Labor_Day|American version of Labor Day|en %} that steadfastly avoids referring to the labor movement, to the point that the news will invariably stop at referring to it as "the unofficial end of summer" and probably look at some military demonstration and back-to-school sales.  It can't focus on unions, after all, because that might give somebody a whiff of {% sfx gasp! %} communism...
