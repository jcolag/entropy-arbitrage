...
He works so hard at trying to make this a legitimate conversation, and it never happens as he loiters in the room of a young woman for no legitimate reason other than the script needs to set up a later conflict...
...
Wouldn't *you* like to live in a world where that amazed you?  Actually, in our world, it'd probably amaze us of people went to the trouble of cleaning up...
...
The Federation appears to use centralized manufacturing for its technical equipment, with little enough quality assurance for end users to trust the results.
