...
labels: [bash, blog, fictopedia, html, ruby]
...
Today, we celebrate {% wiki World_Elephant_Day|World Elephant Day|en %} and {% wiki International_Youth_Day|International Youth Day|en %}, both of which seem sufficiently self-descriptive that I'll maybe recommend that you double up, today, and hug a young elephant or something.
