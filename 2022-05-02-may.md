...
labels: [dashboard, library-update, newsletter]
...
Yesterday, as something of a twist for my search for holidays, everybody *except* for the United States celebrated some combination of {% wiki May_Day|May Day|en %} and {% wiki International_Workers%27_Day|International Workers' Day|en %}.  The former celebrates what people once considered summer.  The latter celebrates the labor movement.
