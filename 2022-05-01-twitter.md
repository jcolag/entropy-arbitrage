...
In media terms, you can think of Twitter as the social media equivalent of a {% wiki Newspaper_of_record|newspaper of record|en %}, in other words.
...
Unfortunately, we can't even treat this problem as merely abstract, since a company run by a *slightly different* billionaire wanted to [suppress terms related to labor organizing <i class="fas fa-copyright"></i>](https://theintercept.com/2022/04/04/amazon-union-living-wage-restrooms-chat-app/).  And this billionaire similarly {% wiki Tesla_and_unions|opposes unionization|en %}...to an [illegal extent](https://apps.nlrb.gov/link/document.aspx/09031d45833d3fce).
...
Looking at [operating cost data <i class="fas fa-copyright"></i>](https://dazeinfo.com/2019/10/16/twitter-operating-costs-and-expenses-type-by-quarter-graphfarm/) derived from Twitter's own quarterly reports, we see that their {% wiki Cost_of_revenue|cost of revenue|en %}---the most direct costs of creating or operating product---makes the largest portion of their expenses, making that an obvious target.
