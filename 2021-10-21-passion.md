...
It seemed reasonable to attack all the stars at once.  {% wiki Rigel|Rigel|en %} (β Ori) has come up several times since [*Mudd's Women*]({% post_url 2020-02-20-trek-m-women %}).  I assume that "Ilyra" is a reference to {% wiki Illyria|Illyria|en %}, a part of Ancient Greece.  {% wiki Sirius|Sirius|en %} has gotten occasional mentions since [*Arena*]({% post_url 2020-05-14-arena %}).  The reference to Cygnus could refer to {% wiki Omega1_Cygni|ω<sup>1</sup> Cygni|en %} or {% wiki Omega2_Cygni|ω<sup>2</sup> Cygni|en %}, four hundred and thirteen hundred light years away, though the latter might just be bad data.  {% wiki Ophiuchus|Ophiuchus|en %}, rather than a star, and is probably most notable for causing occasional arguments in the astrology community, whenever anybody writes a book or publishes an online article insisting that there should be a thirteenth sign in the zodiac.
...
Today, the term "impound"---in the sense of law enforcement seizing a suspected criminal's property---is limited to vehicles.  When it refers to money, {% wiki Impoundment_of_appropriated_funds|impoundment|en %} refers to the informal right of a President of the United States to refuse to spend money allocated by Congress.
