...
{% wiki Ethylene|Ethylene|en %} has many uses, from making plastics---your trash can liner is probably made of polyethene---to artificially ripening fruits to (most relevant, here) an outdated human anesthetic.  The [neo-](https://en.wiktionary.org/wiki/neo-) means that it's a new variant.
