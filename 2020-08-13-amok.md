...
{% wiki Altair|Altair|en %} (α Aql) is one of the brightest stars in the sky, roughly seventeen light years away.  It comes up frequently in science-fiction (and referenced in literature, more generally), including five separate mentions in *Star Trek* live action television or movies.
...
By contrast, {% wiki Finagle%27s_law|Finagle's Law|en %}---the idea that {% wiki Murphy%27s_law|Murphy's Law|en %} applies at the worst poosible time---is the writers taking the opportunity to reference earlier science fiction works.

Also, the only reference to Komack that I can find that isn't a stretch is actor/writer/director/producer {% wiki James_Komack|James Komack|en %}, who would have been contemporary.

 > **MCCOY**: He does, and he's as tightlipped about it as an Aldebaran Shellmouth. No use to ask him, Jim. He won't talk.

{% wiki Aldebaran|Aldebaran|en %} (α Tau) is one of the brightest stars in the sky, sitting roughly sixty-five light-years from Earth.
...
{% wiki Regulus|Regulus|en %} (α Leo) is another of the brightest stars in the sky, actually a system of four stars, possibly more.  I assume that eelbirds are exactly what they sound like.
...
You might recognize some elements of this from people on the Internet prattling on about {% wiki Criticism_of_evolutionary_psychology#Specific_areas_of_controversy|evolutionary psychology|en %}, a field that's *probably* legitimate in some limited ways, but is more often used in exactly the way the plot unfolds, here, using some fictional biological history to justify bad behavior.
...
I wonder if Vulcans have an equivalent to {% wiki The_Fox_and_the_Grapes|*The Fox and the Grapes*|en %}, because this *really* just sounds like Spock trying to poison Stonn's relationship because he's frustrated.
