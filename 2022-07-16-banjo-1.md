...
Oh, but since I can't find an "official" release of this version of the book---the website doesn't appear to have anything useful anymore, and the one copy of the book that I could find had a non-commercial license---I uploaded [the copy that I generated](https://archive.org/details/thebanjoplayersmustdie_202206) to the Internet Archive.  My version has imperfections, and doesn't seem to warrant an in-page viewer, but for many of you, downloading my mediocre PDF will beat trying to convert {% wiki TeX|TeX|en %} to something more reasonable.
...
And I just noticed that the author released the book to GitHub in {% wiki 2012_phenomenon|2012|en %}, which seems like a nice touch, given its release exactly two months before *that* alleged end of the world.
