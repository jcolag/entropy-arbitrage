...
Oh, and I assume that nobody needs me to explain who {% wiki Gregor_Mendel|Gregor Mendel|en %} is, but he pioneered the ideas that have become the field of genetics.
...
{% wiki Ch%C3%A9ron|Chéron|en %} is a French family name, in which is included a couple of towns.  Perhaps relevant, but probably not more than superficially, the guardian of Emily St. Aubert in {% wiki The_Mysteries_of_Udolpho|**The Mysteries of Udolpho**|en %} is the selfish widow Madame Cheron.  More likely, the *intended* reference was to {% wiki Charon|Charon|en %}, the Greek mythological figure who ferried the souls of the dead to Hades.
...
As Yvonne Craig was recognizable [last week]({% post_url 2021-05-20-gods %}) from her role on **Batman**, modern audiences will recognize Bele as {% wiki Frank_Gorshin|Frank Gorshin|en %} from his role on the show as the Riddler, though he was probably known better at the time for his impressions.
...
Fabricated as the name might sound, the {% wiki Coalsack_Nebula|Coalsack|en %} is a dark nebula---used for the header image---visible in the Southern Celestial Hemisphere.  When Kirk referred to Cheron as being in "southernmost part of the galaxy," he apparently meant that relative to Earth.  I suppose I should have seen that coming, since the {% wiki Galactic_coordinate_system|galactic coordinate system|en %} is centered on Earth.
...
Compare this idea that "persecution is a primitive idea" with people who have insisted that we (in the United States, at least) live in a {% wiki Post-racial_America|post-racial America|en %} today.  You might notice that it hasn't ended particularly well.
...
This episode is adapted in **Star Trek 5**.  Other than a bizarre scene crammed in seemingly only to advertise Blish's own {% wiki Spock_Must_Die!|**Spock Must Die!**|en %}---where Spock suggests just passing by Cheron on the way to Ariannus, even though that can't possibly make sense based on everything that has happened---it's just a streamlined version of the episode as aired.
