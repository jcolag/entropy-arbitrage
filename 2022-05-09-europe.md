...
labels: [library-update, recipe, salavi]
...
Today, the European Union 🇪🇺 celebrates {% wiki Europe_Day|Europe Day|en %}, promoting peace and unity across the continent, and commemorating the {% wiki Schuman_Declaration|Schuman Declaration|en %}.
...
Consider this something of a new "secret project," though I'll still develop it publicly.  At least at the moment, it generates the skeleton of a {% wiki Snakes_and_ladders|**Snakes and Ladders**|en %}; I implemented it as a generator of game boards, not because I expect to create them regularly, but because it seemed easier than maintaining a single board and trying to quickly adjust it, as I want more or fewer squares.
