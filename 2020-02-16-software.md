...
when I started looking at {% wiki A_Pattern_Language|A Pattern Language|en %}. I started wondering if municipal design could be automated.
...
There isn't much of a story, here. I decided I wanted to take a good look at the Scala language and the first project that came to mind was to implement {% wiki Go_Fish|Go Fish|en %}.
...
Over the years, I used the program as a testbed for whatever programming ideas I thought of. The software has a network-capable terminal interface (i.e., you can connect to the application remotely), a {% wiki Logo_%28programming_language%29|Logo|en %}-like interpreter, export into multiple vector and CAD formats, and a groupware/collaborative mode.  In other words, this does a *lot* it shouldn't do.
