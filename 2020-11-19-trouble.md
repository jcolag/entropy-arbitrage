...
Also, this is another rare case of a human having a name uncommon in the twentieth century.  {% wiki Niels|Niels|en %} is a Danish equivalent of Nicholas, and {% wiki Nils|Nils|en %} are Norwegian and Swedish variants.  "Nilz" obviously derives from those, and is even phonetically indistinguishable, but that's what's in the script and the captions.
...
{% wiki Triticale|Triticale|en %} is real, but its ancestry passes *through* a University of Manitoba breeding program, to Europe in the nineteenth century.
...
In turn, that implies a Federation-wide law enforcement agency, akin to the {% wiki Federal_Bureau_of_Investigation|FBI|en %}, plus courts and correctional agencies.  There has been scattered evidence that Starfleet might serve as that law enforcement agency, on top of its other responsibilities.  However, given the cultural similarity that the Federation has to the United States, the combining of law enforcement and military seems like it should be shocking, given how much American law goes towards protecting the ideal of civilian governance.
...
{% wiki Spica|Spica|en %} or alpha Virginis (α Vir) is around 250 light years from Earth.  {% wiki Antares|Antares|en %} or alpha Scorpii (α Sco) is around 550 light years from Earth, and has gotten a handful of mentions in the series, most prominently in Uhura's song in [*Conscience of the King*]({% post_url 2020-04-09-trek-conscience %}), but this is the first time the star itself has been directly referenced.  Maybe interestingly, Spica and Antares are the brightest stars in each of the constellations of the {% wiki Zodiac|Zodiac|en %} on either side of {% wiki Libra_%28astrology%29|Libra|en %}.  That might give some indication of the trading routes Jones tends to take and (based on what we hear later) roughly where the Klingon Empire is meant to sit.
...
Spock is referencing a major translation of the {% wiki Sermon_on_the_Mount|Sermon on the Mount|en %}, again suggesting that he may have been raised Christian or converted to Christianity, at some point.  The phrase was probably most recognizable to the contemporary audience, however, because of {% wiki The_Lilies_of_the_Field_%28novel%29|**The Lilies of the Field**|en %} published in 1962 and made into a movie starring Sydney Poitier a year later, in a role that won Poitier his first Best Actor award.
...
It took me a while to get the joke, rather than assuming that "Ermine" was someone who crafted violins, because we (thankfully) no longer live in a world where fur coats are considered acceptable by most people.  But an ermine is a kind of {% wiki Stoat|stoat|en %}, especially when the stoat's white, winter fur is used for high-end coats.  So, Spock is suggesting a violin with a white fur coat to replace the tribbles.
...
I was going to try to track down the origins of the phrase, "money can't buy happiness," but honestly, the fact that there's an entire field of {% wiki Happiness_economics|happiness economics|en %} is far more interesting, and I'm sure practitioners would like to have a word with Mr. Jones.
