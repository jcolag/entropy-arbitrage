...
By the time the episode had aired (late March), the world had already seen the Vietnam War turn far worse, the start of protests that would {% wiki Protests_of_1968|last all year|en %}, and the repeal of the gold standard, with Martin Luther King, Jr.'s, {% wiki Assassination_of_Martin_Luther_King_Jr.|assassination|en %} less than a week in the future.  {% wiki Rowan_%26_Martin%27s_Laugh-In|**Rowan & Martin's Laugh-In**|en %} joined **Star Trek** on NBC, tapping into a lot of those fears, to give some maybe-clearer context.  In other words, 1968 had a lot of people fearing the future, even if we don't account for the fictional history we'll get in this episode, and Roberta Lincoln is a representative of that fear.
...
It's interesting that---even if we limit this to the twentieth century---neither World War and none of the {% wiki List_of_nuclear_close_calls|times we nearly stumbled into a nuclear war|en %} are as important as the incidents to be covered in the spinoff series.  Presumably, that's because the series would have covered at least twenty crises throughout the year, including nuclear escalation, assassinations, and so forth.
...
Given that this is 1968, it's likely that this is meant to imply that, in **Star Trek**'s version of history, this fictional incident led to a last-minute strengthening of the {% wiki Treaty_on_the_Non-Proliferation_of_Nuclear_Weapons|Treaty on the Non-Proliferation of Nuclear Weapons|en %}, which would be signed early that summer.
