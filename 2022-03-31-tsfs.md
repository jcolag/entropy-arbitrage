...
The Klingon played by {% wiki John_Larroquette|John Laroquette|en %} can see the civilian uses of Genesis in enhancing colonization efforts, showing that the culture isn't at all as monolithic as the stories generally lead us to believe.  Kruge, of course, you probably recognize as {% wiki Christopher_Lloyd|Christopher Lloyd|en %}.
...
By contrast to the *Reliant*, the *Grissom* is pretty clearly named for {% wiki Gus_Grissom|Gus Grissom|en %}, one of the Mercury Seven.
...
And since I've mentioned some other major actors breezing through this, Styles is played by {% wiki James_Sikking|James Sikking|en %}, who is mostly retired today, but had a fairly extensive career at the time.

 > **SAAVIK**: We have found the life sign. It is a Vulcan child, perhaps eight to ten Earth-years of age.

The actor, {% wiki Carl_Steven|Carl Steven|en %}, was nine years old when filming, which again seems to confirm that Vulcans and humans age at similar rates, and the years of both worlds are probably around the same length.
