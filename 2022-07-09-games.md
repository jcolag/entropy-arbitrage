...
labels: [gpl, grab-bag, video-game]
...
Inspired by 1985's {% wiki Paradroid|**Paradroid**|en %} and 1997's {% wiki Diablo_%28video_game%29|**Diablo**|en %} in structure, **Freedroid RPG** tells a story of a post-apocalyptic future where a virus has caused robots to attack anything that moves.  You play a penguin-thing restored from cryogenic freeze by a doctor, who sends you on quests.
