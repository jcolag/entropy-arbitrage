...
I admittedly haven't paid *that* much attention so far, but we might find it worth thinking about how the scripts refer to various characters.  It seems especially worth looking at in the context of LaForge, whose actor {% wiki LeVar_Burton|LeVar Burton|en %} received a fair amount of acclaim as {% wiki Kunta_Kinte|Kunta Kinte|en %} in the television adaptation of {% wiki Roots_%281977_miniseries%29|**Roots**|en %}, a character whose name becomes central to his character arc.
...
I find it baffling that the crew doesn't already learn {% wiki Metaphysics|metaphysics|en %}, given that "being, identity and change, space and time, causality, necessity, and possibility" sound a lot like the sorts of things that you want to think about when exploring the universe.
...
Does...the Federation no longer understand how limericks work?  I ask, because even though Data identifies the form, the transgressive line normally matches the punchline.  And sure, the mere word "penis" no longer rates as transgressive outside the {% wiki Watershed_%28broadcasting%29|watershed hours|en %} on television---where the FCC's stricter 1987 rules specifically called out references to "sexual or excretory activities or organs"---but the limerick doesn't really have anywhere racier to go that fits the rhyme.
...
You might remember that the adaptation of [**The Motion Picture**]({% post_url 2022-03-17-tmp-2 %}) included what I think we might all agree was an excessive amount of concern about sex, particularly for a story that doesn't actually contain any.  Much of that comes from the film's origins as a potential pilot for {% wiki Star_Trek:_Phase_II|**Phase II**|en %}, which would have launched the {% wiki Paramount_Television_Service|Paramount Television Service|en %} network.  To draw attention to the "fourth network"---as has happened with *all* the networks to appear beyond the Big Three and PBS---writers imagined the show to have more explicit sexual content.
