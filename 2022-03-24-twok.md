...
{% wiki Kobayashi|Kobayashi|en %} is one of the most common Japanese family names, and a [*maru*](https://en.wiktionary.org/wiki/%E3%81%BE%E3%82%8B) (Japanese for "circle") usually refers to {% wiki Japanese_ship-naming_conventions|merchant ships|en %}.  I point this out, because I have seen a surprising number of fan sources over the years embarrass themselves by trying to guess what mysterious alien species the target ship represents, when we can be fairly sure that they try to save Japanese merchants.

You might already recall that [*Amok Time*]({% post_url 2020-08-13-amok %}) described {% wiki Altair|Altair|en %} VI as having a totalitarian government with a strong commitment to providing high-quality recreation to the powerful.
...
Spock gives Kirk an edition of {% wiki A_Tale_of_Two_Cities|**A Tale of Two Cities**|en %}, of which Kirk helpfully reads the first few words.
...
We met Surak in [*The Savage Curtain*]({% post_url 2021-07-15-savage %}), where he was decidedly *not* portrayed as a scientist.  I assume that everybody is already familiar with {% wiki Isaac_Newton|Isaac Newton|en %} and {% wiki Albert_Einstein|Albert Einstein|en %} or can read Wikipedia for yourselves.

Maybe more importantly, David only names white male scientists, here, and only from the two worlds that we know best.  Of course, this is probably more indicative of a 1980s audience than the world, since (happy Women's history month!) the contributions of non-white people and those who don't identify as male have often gotten written out of history.  For example, {% wiki Rosalind_Franklin|Rosalind Franklin|en %}'s career just started receiving media coverage.  {% wiki Mario_Molina|Mario Molina|en %}'s work wouldn't see prominence for another decade when he received the Nobel Prize.  {% wiki Ibn_al-Haytham|Ibn al-Haytham|en %}'s work still sits mostly ignored in favor of Newton.  People still only barely know about {% wiki Emmy_Noether|Emmy Noether|en %}.  Even {% wiki Marie_Curie|Marie Curie|en %} seems mostly like an afterthought in most discussions of science.
...
Also, the {% wiki Boy_Scouts_of_America|Boy Scouts of America|en %} either still exist---the wonders of suing or buying out competing scouting programs will never cease, I guess---or have become more of an idiom referring to someone judged to be overly bound in honor and honesty.
...
In the shelter, Chekhov sees a bookshelf with {% wiki Inferno_%28Dante%29|**The Inferno**|en %}, {% wiki Paradise_Lost|**Paradise Lost**|en %} (also mentioned in *Space Seed*), {% wiki Paradise_Regained|**Paradise Regained**|en %} (combined with its predecessor), {% wiki Moby-Dick|**Moby Dick**|en %}, some regulatory statue, a second copy of **Paradise Lost** without the sequel, two books with the titles too dim to see, and {% wiki King_Lear|**King Lear**|en %}.
...
The name "Regula" currently has no astronomical significance that I can find.  It's a name in some parts of the world, though, probably traced most directly to {% wiki Felix_and_Regula|the third-century saint|en %}, a patron of Zürich.
...
The only reference to a "Nibia" that I can find is the late Uruguayan activist {% wiki Nibia_Sabalsagaray|Nibia Sabalsagaray|en %}.  {% wiki Antares|Antares|en %} has come up several times since [*The Trouble with Tribbles*]({% post_url 2020-11-19-trouble %}), though other things---a song and a ship---have the name before the star itself gets its mention.
...
Also, he refers to being senile, when...that's not a great term.  Today, we're more likely to refer to {% wiki Dementia|dementia|en %}.
...
We see a fair amount of space-borne funerary rights, in fact.  Maybe most notably, Scott plays {% wiki Amazing_Grace|*Amazing Grace*|en %}, which implies a religious tradition, somewhere.  However, we don't know if it's a choice made by Starfleet as a standard, Spock as a final wish, or Scott as the only song that he knows how to play.
