...
labels: [blog, dashboard, html, library-update, thue]
...
Today is {% wiki International_Mother_Language_Day|International Mother Language Day|en %}, a celebration promoting linguistic and cultural diversity.  It derives from the Bengali language movement in Bangladesh.
