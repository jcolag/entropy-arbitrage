...
We open with a somewhat loose adaptation of {% wiki Henry_V_%28play%29|**The Life of Henry V**|en %}, by William Shakespeare, Act IV, Scene 1.  Hologram-Patrick Stewart and "Bates" try to muddle through a Yorkshire accent, while Brent Spiner...does not.  Yes, Picard apparently created a hologram of himself, in a play that he seems to want to direct.

 > **DATA**: Freeze program. Thank you, sir. I plan to study the performances of Olivier, Branagh, Shapiro, Kullnark...

Data name-drops {% wiki Laurence_Olivier|Laurence Olivier|en %}, {% wiki Kenneth_Branagh|Kenneth Branagh|en %}, and possibly {% wiki Mel_Shapiro|Mel Shapiro|en %}.  At the time this aired, Branagh had a {% wiki Henry_V_%281989_film%29|production of **Henry V**|en %} in theaters.
...
We could reasonably argue that the difference comes from major events such as the {% wiki Great_Famine_of_1315%E2%80%931317|Great Famine of 1315 -- 1317|en %} and {% wiki Black_Death|Black Death|en %} (1346 -- 1353) accelerating cultural change as a byproduct of wiping out a significant percentage of the population.  However, between the time that this aired and when it takes place, their version of Earth goes through multiple global wars that similarly wipe out large parts of the population, plus they discover extraterrestrial life and interact with their cultures, begin colonizing planets, witness the destruction of entire solar systems, and more, meaning that they probably also would have seen rapid cultural changes.
...
You might recognize Setal/Jarok as {% wiki James_Sloyan|James Sloyan|en %}, who...well, he shows up as a guest star a lot on television, including a total of five characters on this era of *Star Trek*.
...
This line *probably* refers to the war mentioned in [*Balance of Terror*]({% post_url 2020-04-16-trek-balance %}).  We had a planet named Cheron in [*Let That Be Your Last Battlefield*]({% post_url 2021-05-27-battle %}), which I assume has no relation, since they set that planet near the {% wiki Coalsack_Nebula|Southern Coalsack Nebula|en %}.

I should note that the confusion in names, at the time, caused the writers of secondary sources---unofficial reference material based on the shows, from independent publishers, not to mention licensed works---no end of grief, with many explanations for where the Battle of Cheron took place, because similar-sounding name {% wiki Charon_%28moon%29|Charon|en %} also indicates a moon of the dwarf planet Pluto.

Also, we've mentioned the Federation's apparently love of twentieth-century animation, and naming a star after {% wiki Nelvana|Nelvana|en %} seems to reinforce that idea.
...
Like Sloyan, {% wiki John_Hancock_%28actor%29|John Hancock|en %} made a lot of appearances, maybe most prominently in **Roots:  The Next Generation**.
...
The {% wiki Battle_of_the_Little_Bighorn|Battle of Little Bighorn|en %} occurred in late June 1876.  And we have yet another case in this show where I can't tell if the writers have any self-awareness of how their characters sound.  I say this, because the entire {% wiki Great_Sioux_War_of_1876|Black Hills War|en %} began as an attempt to force the Cheyenne off their gold-rich land, and became a campaign policing the movements of all regional Native American groups.
