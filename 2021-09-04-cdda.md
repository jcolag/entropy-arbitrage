...
labels: [apocalypse, cc-by-sa, rogue-like, video-game]
...
On the technical side, you can type {% key ? %} at any time, to get a reminder on which key does what, instead of the game assuming that we all memorized {% wiki NetHack|NetHack|en %}'s control scheme as teenagers.  Similarly, while I'll complain later about everything being hard to read, a significant amount of control is put into pop-up menus, which means that there isn't much that a player needs to actually know.
