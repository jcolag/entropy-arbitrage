...
By the way, I don't fully agree with the article, taking issue with its vague complaints about the two-party system.  While I don't love it, I know that the solution lies in focusing on moving local races and building from there, not trying to take the White House without any preparation.  Think about it in terms of the {% wiki REDMAP|REDMAP|en %} project, not {% wiki Brewster%27s_Millions_%281985_film%29|**Brewster's Millions**|en %}[^2]...
