...
Considering that we're still dealing with the {% wiki Fukushima_Daiichi_nuclear_disaster|Fukushima disaster|en %} and who knows what else, information like this can be critical for both cleaning up and reducing the chances of disasters in the future.
...
It really says everything that you need to know about Silicon Valley that there is far more talk about how to tie the fate of cryptocurrencies---inherently [wasteful and destructive]({% post_url 2021-05-16-crypto %}) as they are---to pornography in the wake of {% wiki OnlyFans|OnlyFans|en %} eliminating the adult content that (as I understand it) makes their platform viable than there is about companies finding better solutions to wildfires that directly threaten their homes.
