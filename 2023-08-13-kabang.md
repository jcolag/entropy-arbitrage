...
thumbnail: /blog/assets/kabang-astronaut.png
offset: -40%
...
![Hypothetical "cabinet" art for the Kabang! arcade game, featuring an astronaut holding a glowing white orb, which attracts elements in a field of debris](/blog/assets/kabang-astronaut.png "A bit too fancy for a painted cabinet, and the meteors might look a bit too much like cheese-puffs, but let's roll with it for now")
...
{% imgr A revised logo for Kabang! in vaguely futuristic, letters|replacement-kabang-logo.png|It should've occurred to me that the font mostly existed... %}
...
**Update**, 2026 September 17:  I finally replaced the AI-generated images, here.  I now assembled it from more usable art.  See below for details on the faux arcade cabinet art.  The logo, as it turns out, already closely resembled the [Audiowide font](https://fonts.google.com/specimen/Audiowide?preview.script=Latn), so I created a new *N* glyph (based on the mediocre AI job) that echoed the idea of the character holding a horseshoe magnet, and modified the *K* glyph to have more curves and form a single piece.
...
**Credits**:  I created the game---itself released under the terms of the [GNU Affero General Public License, version 3](https://www.gnu.org/licenses/agpl-3.0.html)---with all assets made available under the terms of the [Creative Commons Attribution Share-Alike 4.0 International](http://creativecommons.org/licenses/by-sa/4.0/) license.  The TIC-80 project has released its player code under the terms of the [MIT license](https://github.com/nesbox/TIC-80/blob/main/LICENSE).  I created the (revised) fake cabinet art using [Roscosmos cosmonaut Sergey Ryzhikov during a spacewalk](https://images.nasa.gov/details/iss073e0981126) (in the public domain by NASA policy) and [Asteroid Sprite Sheet](https://opengameart.org/content/asteroid-sprite-sheets) by [statico](https://opengameart.org/users/statico), made available under the terms of the [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) license.  As mentioned in the text, the revised logo uses the Audiowide font by [Astigmatic](https://fonts.google.com/?query=Astigmatic), made available under the terms of the [SIL Open Font License Version 1.1](https://openfontlicense.org/open-font-license-official-text/).
