...
Naming the protagonist Scott Peterson (presumably a coincidence and not named for the {% wiki Scott_Peterson|wife-murderer|en %}) hasn't aged particularly well.  As mentioned, the acting isn't spectacular and a lot of the jokes fail to land, especially where the joke is meant to be edgier.
...
Despite it never making an appearance in any of the storytelling, the website also suggests that **Orang-U**'s Boston has a public transit system (the {% wiki Massachusetts_Bay_Transportation_Authority|MBTA|en %}) that's haunted.
