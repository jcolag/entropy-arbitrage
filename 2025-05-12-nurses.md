...
labels: [codidact, mystic-t-square, stenotype]
...
Today marks the {% wiki International_Nurses_Day|International Nurses Day|en %}, based on {% wiki Florence_Nightingale|Florence Nightingale|en %}'s birthday.  In the United States, we have started transitioning health care to vitamin supplements and bear carcasses, so treat your nurses extra-nicely...
