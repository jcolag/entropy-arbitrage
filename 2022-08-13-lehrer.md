...
labels: [classic, music, public-domain, satire]
...
Simple English Wikipedia {% wiki Tom_Lehrer|describes Lehrer|simple %} as follows.
...
Then, we have the unnamed but long-lived mathematician, born early enough for {% wiki Nikolai_Lobachevsky|Nicolai Lobachevsky|en %} (1792 -- 1856, though no longer teaching by 1827) to have taught him, and survived long enough for a Soviet parody of {% wiki Metro-Goldwyn-Mayer|MGM|en %} to buy the rights for a film starring (in the public domain instance) {% wiki Ingrid_Bergman|Ingrid Bergman|en %} (1915 -- 1982, not a star prior to 1935).  And don't forget **The Eternal Triangle** film itself, where Bergman plays the hypotenuse of a right triangle...
