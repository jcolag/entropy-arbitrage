...
What makes all of this even more amazing is that messaging hasn't really changed significantly since the UNIX `{% wiki Talk_%28software%29|talk|en %}` command that I used to keep in contact with people in the mid-1990s, and was at least a decade old by then.
