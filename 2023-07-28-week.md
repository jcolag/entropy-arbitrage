...
It occurs to me that we have a lot of hand-wringing about the artificial and unconstitutional "expiration date" put on the ERA, and we don't talk enough about how the {% wiki Corwin_Amendment|Corwin Amendment|en %} still quietly waits for some right-wing state legislator to push the idea that the Federal government has no right to interfere with how the states prevent---or more to the point, *fail* to prevent---slavery within their borders.
