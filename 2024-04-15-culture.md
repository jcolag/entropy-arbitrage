...
labels: [blog, earburn, lights-edge]
...
Today, we observe the {% wiki Universal_Day_of_Culture|The Universal Day of Culture under the Banner of Peace|en %}, the prepositional phrase often dropped for convenience, promoting the protection of culture in general, and the {% wiki Roerich_Pact|Treaty on the Protection of Artistic and Scientific Institutions and Historic Monuments|en %} (Roerich Pact) as a specific instance.  Conveniently, it coincides with {% wiki World_Art_Day|World Art Day|en %}, celebrating the fine arts.

Over in the United States, Major League Baseball will spend a lot of today patting itself on the back on {% wiki Jackie_Robinson_Day|Jackie Robinson Day|en %}, honoring the debut of the sport's first major-league Black player.

**And** also in the United States, if you haven't {% wiki Tax_Day|filed your taxes|en %}, yet, you'll probably want to either get on that now or file for an extension.  If you fall under certain conditions, you can use the [IRS Direct File](https://www.irs.gov/about-irs/strategic-plan/irs-direct-file-pilot) pilot program and save yourself the hassle of working with one of the big providers, finally giving us a baby step closer to the rest of the civilized world.  I didn't quite qualify, myself, but the program has gotten good reviews from people who did.
