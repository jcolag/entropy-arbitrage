...
Then, Mudd indicates that there is a movement against intellectual property like patents, predating Stewart Brand's "{% wiki Information_wants_to_be_free|information wants to be free|en %}" assertion by almost twenty years.  That may be of particular interest to readers like yourself, because that ethos led to the founding of [Creative Commons](https://creativecommons.org/), whose licenses this blog is published under.

 > **MUDD**: I sold the Denebians all the rights to a Vulcan fuel synthesizer.

I've discussed {% wiki Deneb|Deneb|en %} (α Cyg) in [*The Conscience of the King*]({% post_url 2020-04-09-trek-conscience %}) and [*Operation:  Annihilate!*]({% post_url 2020-07-30-opann %}), and it was mentioned in [*Where No Man Has Gone Before*]({% post_url 2020-01-23-trek-no-man %}), so I won't go into that story, here.  The takeaway, though, is that the star hosts one of those "struggling" civilizations.
...
Oddly, a {% wiki Kulak|kulak|en %} is a property-owner, basically, whose property was seized as they were sent to labor camps or killed by Stalin's {% wiki First_five-year_plan|first five-year plan|en %}.  If the term is still being used derisively, that suggests that Russia---which we believe, from [**The Apple**]({% post_url 2020-09-10-apple %}) might not be a formal part of the Federation---might still be largely Stalinist in its political attitudes.
...
This is now the show's third reference (that I've noticed) to {% wiki Alice%27s_Adventures_in_Wonderland|**Alice's Adventures in Wonderland**|en %}, which probably means it's still extremely popular.
...
We get a heaping helping of racism in this episode, both in the form of human-Vulcan-android antipathy and among human races, the latter more prominent in the adaptation.  Sexism rears its ugly head, too, both in the glee several members of the crew have in the idea that the androids---well, I suppose {% wiki Gynoid|gynoid|en %} is technically the more appropriate term in context---are sexually available and in allowing Stella Mudd to be characterized as a shrewish, nagging wife.
