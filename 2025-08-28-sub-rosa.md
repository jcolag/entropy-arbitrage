...
That ties in directly with one of the recurring threads that we've needed to talk about in these posts, the New Age influence on the show.  Since laundered through what we now call {% wiki Conspirituality|conspirituality|en %} and now {% emoji eyeroll %} {% wiki Make_America_Healthy_Again|Make America Healthy Again|en %}, the era found people insisting in hushed tones that "they" have withheld household remedies for all manner of illnesses from us.
...
You, too, can visit {% wiki Glamis_Castle|Glamis Castle|en %}, apparently.
