...
One of the most important realizations about history revolves around how Christianity compromised itself and rejected its own lofty principles in its expansion, particularly the push to attract and convert leaders.  Legends around the {% wiki Battle_of_Tolbiac|Battle of Tolbiac|en %} say that {% wiki Clovis_I|Clovis|en %} swore that he would convert to Christianity, if its God would help him split his enemies' skulls.

His conversion meant rapid spread across the now-French landscape, but it also meant allowing the Christian God to serve as a war-god.  Support of the {% wiki Divine_right_of_kings|divine right of kings|en %} concept means explicitly rejecting equality.  The church rarely even fights against {% wiki Jewish_deicide|anti-Semitic tropes about the execution of Jesus|en %} in its own ranks, except for a couple of Popes or other leaders mentioning it occasionally.
