...
A new discovery for me---only about two months ago---the twtxt network is a decentralized microblogging system that is built exclusively around accessing text files over {% wiki Hypertext_Transfer_Protocol|HTTP|en %}.
