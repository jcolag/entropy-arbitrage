...
The word "lapis" generally refers to {% wiki Lapis_lazuli|lapis lazuli|en %}, an intensely blue semi-precious gem found primarily in Afghanistan.  The word itself comes from the Latin word for "stone," suggesting that the Federation has a constellation "shaped like" a stone.
...
You might think that I'll talk about brand-name drugs, here, since this doesn't conform to generic roots.  However, given the context and upcoming lines, chances are good that "norep" refers to the neurotransmitter and hormone {% wiki Norepinephrine|norepinephrine|en %}, which *would* make this...well, not a generic drug as such, because we don't actually consider it a drug, but at least an unbranded chemical compound.
...
Picard slightly misquotes Shelley's lyrical drama {% wiki Prometheus_Unbound_%28Shelley%29|**Prometheus Unbound**|en %}, {% wiki Demogorgon|Demogorgon|en %}---something between a generic supernatural being and an uncaring creator god, depending on whose religious traditions you interact with, and how seriously you take ancient typos---speaking of the difference between slavery and freedom among gods as "All spirits are enslaved *which* serve things evil: Thou knowest if Jupiter be such or no."
