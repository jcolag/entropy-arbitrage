...
Depending on where you are, today *might* celebrate the oh-so-appealing-sounding {% wiki Ratcatcher%27s_Day|Ratcatcher's Day|en %}, commemorating one of two dates that medieval traditions used for the story of {% wiki The_Pied_Piper_of_Hamelin|*The Pied Piper*|en %}, but also honoring literal rat-catchers and presumably most modern exterminators.
...
Maybe more interestingly to some, because I started rambling about {% wiki Planck_units|Planck units|en %} and {% wiki Gravitational_binding_energy|gravitational binding energy|en %} in the [**ST:TNG** *New Ground*]({% post_url 2024-07-18-new-ground %}) post, I assembled ideas from a bunch of pages and put together an I-hope-working-for-everybody way of adding [Mathjax](https://www.mathjax.org/).  This means that I can now insert arbitrary mathematical expressions in a post, such as $$\frac{-b \pm \sqrt{b^2 - 4ac}}{2a}$$ the {% wiki Quadratic_equation|quadratic formula|simple %} for one that most readers will probably at least recognize.  But we could also do something fussier, like $$\lim_{x\to 0}{\frac{e^x-1}{2x}} \overset{\left[\frac{0}{0}\right]}{\underset{\mathrm{H}}{=}} \lim_{x\to 0}{\frac{e^x}{2}}={\frac{1}{2}}$$, an application of {% wiki L%27H%C3%B4pital%27s_rule|L'Hôpital's rule|en %}[^1].
...
[^2]:  The rest of you can ask your nearest middle-aged person {% wiki Airplane!|or Wikipedia|en %}, I guess, though the former will enjoy the conversation more.  Also, I now find myself trying to calculate the probability that somebody will figure out where I went to school based solely on that one joke...

Most usefully for some applications, you can click on the math to get a zoomed-in version in a pop-up, or right-click for a context menu that'll give you the {% wiki LaTeX|$$\LaTeX$$|en %} or {% wiki MathML|MathML|en %} equivalent, in case you need to reproduce something that I did elsewhere.  I [played with MathML]({% post_url 2023-09-11-nayrouz %}) with similar intentions almost a year ago, but that went nowhere, and this makes a tidier solution, I think.
