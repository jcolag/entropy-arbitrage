...
The most likely reference for {% wiki Gideon|Gideon|en %} is the Biblical character, the soldier, judge, and prophet.  That said, it doesn't appear to be particularly symbolic, so the planet (and story) could also easily be named for any number of people whose given or family name is Gideon.
