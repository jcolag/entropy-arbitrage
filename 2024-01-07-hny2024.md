 ...
 * {% wiki Plum_Bun|**Plum Bun: A Novel Without a Moral**|en %}, a major work out of the Harlem Renaissance.
 * Esther Forbes's {% wiki A_Mirror_for_Witches|**A Mirror for Witches**|en %}.
 * {% wiki Quicksand_%28Larsen_novel%29|**Quicksand**|en %} by Nella Larsen.
 * Dhan Gopal Mukerji's {% wiki Gay_Neck,_the_Story_of_a_Pigeon|**Gay Neck, the Story of a Pigeon**|en %}.
 * {% wiki Millions_of_Cats|**Millions of Cats**|en %} by Wanda Gág.
 * Eugene O'Neill's {% wiki Strange_Interlude|**Strange Interlude**|en %}.
 * {% wiki Machinal|**Machinal**|en %} by Sophie Treadwell.
 * Stephen Vincent Benét's {% wiki John_Brown%27s_Body_%28poem%29|*John Brown's Body*|en %}.
 ...
 * {% wiki Treasure_Girl|**Treasure Girl**|en %}, most prominently *(I've Got a) Crush on You*
 * {% wiki Paris_%281928_musical%29|**Paris**|en %}, most prominently *Let's Do It (Let's Fall in Love)*
 * {% wiki Whoopee!|**Whoopee!**|en %}
 * {% wiki Room_1411|*Room 1411*|en %}
 * {% wiki West_End_Blues|*West End Blues*|en %}
 * {% wiki An_American_in_Paris|*An American in Paris*|en %}
