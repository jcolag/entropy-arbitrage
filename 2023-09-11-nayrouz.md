...
Today, the Coptic Christian world celebrates {% wiki Nayrouz|Nayrouz|en %}---which you shouldn't confuse with {% wiki Nowruz|Nowruz|en %}, though it does have related roots---or (in Ethiopia) {% wiki Enkutatash|Enkutatash|en %}, the start of their new year.
...
This week?  If you've ever wanted to compare the dates of files in a shell script or look at some rudimentary {% wiki MathML|MathML|en %} embedded in an HTML file, well...do I have good news for you!?
