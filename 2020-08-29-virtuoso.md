...
The most obviously useful aspect is that this is a Free Culture {% wiki Afrofuturism|Afro-Futurist|en %} setting.  Yes, it appears to be written and illustrated by White people, but the license means that a Black writer can and *should* run with Mahanake and turn it into something exciting, because I'm not aware of anything else like it.  From that perspective, its mere *existence* works well.
