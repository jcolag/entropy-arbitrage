...
We can probably all recite the famous versions of this in our sleep.  {% wiki Roman_Polanski#Sexual_abuse_case|Roman Polanski|en %} has spent over forty years in self-imposed exile from the United States, rather than face justice for forcibly having sex with a minor.  Directory {% wiki Bryan_Singer#Sexual_abuse_allegations|Bryan Singer|en %} has a shopping list of sexually related abuse accusations against him, in addition to treating his cast and crew more generally inappropriately.  {% wiki Politics_of_J._K._Rowling#Transgender_people|J.K. Rowling|en %} frequently repeats transphobic propaganda.
...
No, it's not ideal.  Yes, some criteria on the list might conflict at points.  However, it's not only a start, some aspects of {% wiki Ethical_eating|ethical eating|en %}---such as ordering seafood---can be distilled down to a wallet-sized card that includes ratings for things like mercury levels and sustainability.
