...
{% wiki Polycythemia|Polycythemia|en %} is a real disease, basically too many red blood cells for the amount of plasma.  The xeno- prefix just denotes that it's considered foreign in some way.
...
It's worth pointing out that, without permission or in tandem with the locals, this is awfully close to looting an ancient cultural site.  To put this into perspective, imagine discovering {% wiki G%C3%B6bekli_Tepe|Göbekli Tepe/Xirabreşkê|en %} and assuming that providing a service to the locals means that you have the right to paw through any records that might have been there, in case they knew something that might help a friend.
