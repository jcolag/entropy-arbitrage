...
Apart from a couple of real words chosen for their obscurity that you can look up on your own time, you might want to know that {% wiki Gondal_%28fictional_country%29|Gondal|en %} comes from early and mostly unpublished work by {% wiki Emily_Bront%C3%AB|Emily|en %} and {% wiki Anne_Bront%C3%AB|Anne Brontë|en %}, and the gavvo served as the currency of Anthony Hope's {% wiki Graustark|Graustark|en %}, though I thought of the gavvo's use here as similar to the dollar, the peso, the rial, or the like, a name shared by many different currencies, rather than choosing the name to set the scene in Graustark, because the specific country doesn't matter to the story, other than making them roughly European so that I didn't need to cram in mockery of the {% wiki White_savior|white savior|en %} trope on top of everything else.  Both sources long ago fell into the public domain due to expired copyrights.
