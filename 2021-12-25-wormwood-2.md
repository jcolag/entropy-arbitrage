...
Some cultural references are also a bit too precious for my tastes, such as "{% wiki Three_Mile_Island_accident|Three Myland|en %}."  I realize that the idea is to simulate linguistic simplification over time, but it doesn't seem to happen anywhere else, to any significant extent.
