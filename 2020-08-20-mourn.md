...
Before jumping in, the title of the episode is part of a line from Percy Shelley's {% wiki Adonais|*Adonais*|en %}, an elegy for John Keats in 1821.
...
{% wiki Pollux_%28star%29|Pollux|en %} (β Gem) is around thirty-four light-years from Earth, our nearest giant star, and one of the stars with the longest credible presumptions of hosting at least one exoplanet before the discovery of {% wiki Pollux_b|Thestias|en %} in 2006.
...
It's strongly implied by their mention, here and earlier, that {% wiki Agamemnon|Agamemnon|en %}, {% wiki Hector|Hector|en %}, and {% wiki Odysseus|Odysseus|en %} have all been revealed to be real people, rather than legendary figures of questionable authenticity.
...
It's not entirely clear, given that it's a throwaway quip, but Chekov is probably referring to the {% wiki All-Russian_nation|All-Russia nation|en %}, which mostly amounts to modern Russia ("Greater Russia"), Ukraine ("Little Russia"), and Belarus ("White Russia").  It's an old idea that became racialized under the Soviet Union and has since been revived in right-wing circles.
...
While the simple "aliens visiting prehistoric people" trope comes a bit earlier (I intend to provide a translation for the one I know about it soon), the earliest version of aliens having been worshiped as gods that I've been able to find is {% wiki Edison%27s_Conquest_of_Mars|**Edison's Conquest of Mars**|en %} (1898) by science writer (dabbling in scientific romances) Garrett P. Serviss, where there's a brief mention of the Martians resembling the {% wiki Great_Sphinx_of_Giza|Sphinx|en %} and may have inspired its creation during a mass abduction nine thousand years before.  The first "serious" version comes from Charles Fort's {% wiki The_Book_of_the_Damned|**The Book of the Damned**|en %}, where the author proposes many "but what if it's true" stories, on the basis that you can't prove the absence of a phenomenon.
...
The book they're arguing over is {% wiki Lewis_Carroll|Lewis Carroll|en %}'s {% wiki Alice%27s_Adventures_in_Wonderland|**Alice's Adventures in Wonderland**|en %}, which previously got a mention in [*Shore Leave*]({% post_url 2020-04-23-leave %}).

The argument itself is a sly reference to the Soviet Union rewriting classic literature to better fit the way the government viewed the world.  I'm not aware that this happened with **Alice**, specifically, but I see two possible translations that might have been known to the writers:  {% wiki Vladimir_Nabokov|Vladimir Nabokov|en %}'s **Аня в стране чудес** ("Anya in Wonderland," 1923) and Nina M. Demurova's **Приключения Алисы в стране чудес** (1967).  For those of you familiar with the translations, I'm ignoring 1879's **Соня въ царствѣ дива** ("Sonya in the Diva's Kingdom"), since it's pre-Revolution, though it's also the translation that you can find online, since it's been in the public domain a good while.
...
I hesitate to say that they're Christians, because monotheistic religions date back at least as far as the fourteenth century BCE, when {% wiki Akhenaten|Amenhotep IV|en %} declared the obscure Egyptian Sun god {% wiki Aten|Aten|en %} to be the supreme, and then later *only*, god of the Egyptians.  Recent monotheistic religions that aren't Abrahamic sects include {% wiki Caodaism|Cao Đài (道高臺)|en %} and {% wiki Seicho-no-Ie|Seicho-no-Ie (生長の家)|en %}.  Add in possible alien influence on Earth culture since, potentially, the 1990s, and the possibilities are endless.
...
The adaptation comes from **Star Trek 7**, so it's mostly just an abridgment of the script.  The introduction is a bit different, setting Pollux in something called the "Cecrops cluster" that I can't find any other reference to, and some minor deviations like using the name Latona for {% wiki Leto|Leto|en %}.
