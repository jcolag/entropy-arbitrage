...
I should say that, in all honesty, I don't find Mickey Mouse a particularly compelling or useful character.  To borrow somebody else's explanation, Wikipedia {% wiki Mickey_Mouse|describes him|en %} as follows.
...
Potentially more relevant, we should note that---much as almost every other popular cartoon character of the day---Mickey's appearance and behavior reflects {% wiki Minstrel_show|minstrelsy|en %}.  This should make us think twice about using the character at all, or at least take care around the related cluster of ideas that live in that world.
...
We should note that, related to the uncomfortable minstrel character attributes mentioned earlier, Mickey and Minnie play {% wiki Turkey_in_the_Straw|*Turkey in the Straw*|en %}, originating in minstrel shows and originating with outright racist language.  Not related to the character appearances, though, Mickey seems extraordinarily fond of animal cruelty, here, and continues to obsess over Minnie's underwear.
...
With a title translating to English as the entirely unenlightening *Toy Box Series 3: Picture Book 1936*, JO Studios released this 1934 right-wing propaganda piece apparently about how, when the {% wiki Washington_Naval_Treaty|Washington Naval Treaty|en %} would expire in two years, the United States would attack Japan.  As far as I can tell, {% wiki Copyright_law_of_Japan|Japanese copyright|en %} for (corporate) works published in 1934 would have expired in 1984, putting this in the public domain with a wide margin for error.
...
For a summary, for those of you not interested in watching, I need to work from {% wiki %E3%82%AA%E3%83%A2%E3%83%81%E3%83%A3%E7%AE%B1%E3%82%B7%E3%83%AA%E3%83%BC%E3%82%BA%E7%AC%AC3%E8%A9%B1_%E7%B5%B5%E6%9C%AC%E4%B8%80%E4%B9%9D%E4%B8%89%E5%85%AD%E5%B9%B4|Japanese Wikipedia's summary|ja %}.
...
By the way, not mentioned in the summary, the island natives call on {% wiki Momotar%C5%8D|Momotarō|en %} the peach boy---Japanese animation darling of the day---and super-strong {% wiki Kintar%C5%8D|Kintarō|en %} the golden boy, with Rip van Winkle counterpart {% wiki Urashima_Tar%C5%8D|Urashima Tarō|en %} delivering the final blow.  Look, I may not know the language, but after decades of trying to build superhero universes that make some kind of sense, I have a decent grasp on powerful folklore characters...
 ...
 * The 1930 comic strip, but rather than trusting the word of Malibu Comics in {% wiki The_Uncensored_Mouse|**The Uncensored Mouse**|en %}, double-check the copyrights on each strip and filter out each entry with a renewal.
...
If we ignore the framing sequence for *The Mad Doctor*---and also ignore Pluto, since he apparently first appears in {% wiki The_Chain_Gang_%281930_film%29|*The Chain Gang*|en %}---that also gives us the doctor in the title.
...
Our protagonist has big dreams.  He wants to emulate Charles Lindbergh---minus the love of antisemitism and eugenics, I would hope---and builds two airplanes.  He tries to become a {% wiki Gaucho|gaucho|en %}.  Working on a steamboat, he shows a love of music.  And, assuming that we ignore the dream aspect, he fights off a dangerous, unethical scientist.
...
Pete needs a new name, not so much because of concerns about Disney, but from an {% wiki Pete_the_Cat|entirely different cat named Peter|en %}.  Due to the similarities in structure, sound, and even appearance of the name, though not meaning, I propose that we name the cat Fedor, the Slavic (mostly Russian) equivalent of Theodore.
