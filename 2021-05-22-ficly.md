...
Ficly was an attempt to revive Lawver's prior {% wiki Ficlets|Ficlets|en %} community at America Online, the [archive of which](https://ficlets.com/) is *also* free-licensed, though lacks the convenient database export that I'll talk about shortly.

They mostly shut down the interactive parts of the site in 2014, putting up the static archive, which is basically a large anthology that includes well over thirty thousand works of {% wiki Flash_fiction|flash fiction|en %}.
