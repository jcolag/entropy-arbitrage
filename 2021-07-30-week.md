...
It seems odd that the word "{% wiki Book_of_Revelation|revelation|en %}" doesn't appear anywhere in the analysis, since it's been fairly clear that anticipating the end of the world has influenced a lot of right-wing thought.  I've been thinking of writing a blog post about those converging influences, so this might be the prodding that I need.
