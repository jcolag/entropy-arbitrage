...
A {% wiki Triskelion|triskelion|en %} is a triple-spiral design motif---sometimes, the spirals are legs, instead---that dates to Iron Age Europe.  The logo on the arena floor and throughout the facility are the leg-based version.
...
You might think that I'm going to complain about the meaningless star name, right?  Nope.  M24 or Messier 24 is the {% wiki Small_Sagittarius_Star_Cloud|Small Sagittarius Star Cloud|en %}, a cluster in our galaxy's {% wiki Carina%E2%80%93Sagittarius_Arm|Carina-Sagittarius Arm|en %}.  Earth is on the neighboring {% wiki Orion_Arm|Orion-Cygnus Arm|en %}.
...
Spock, again, pulls out a Biblical reference, this time to {% wiki Daniel_%28biblical_figure%29|Daniel|en %} (דָּנִיֵּאל), who was {% wiki Daniel_in_the_lions%27_den|thrown into a lions' den|en %} for worshiping the Hebrew God instead of the king, until an angel rescues him.
...
I called out Kirk's comments on love and marriage as good, but it's also worth pointing out that "especially to a man and a woman" erases entire classes of relationship, such as same-sex couples and polyamorous groups.  Granted, the {% wiki Stonewall_riots|Stonewall riots|en %} were still a year and a half into the audience's future, but people involved in the production were certainly aware that {% wiki George_Takei|George Takei|en %} is gay.
