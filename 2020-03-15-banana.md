...
There's an old {% wiki Vaudeville|Vaudeville|en %} gag that I'm fond of, which---usually inside of a wider context---generally goes something like this.
...
If you're my age, you'll probably also recognize [a version of this sketch](https://www.youtube.com/watch?v=zwsmqZLCKPE) from early {% wiki Sesame_Street|**Sesame Street**|en %}---hence the post's title and header image---but either way, it brings up an important point:
...
This boils down to what the statistics people constantly remind us, {% wiki Correlation_does_not_imply_causation|*correlation is not causality*|en %}.  Or in other words, we can't see causality.
...
So...don't do that.  Besides, your bread is going to go stale and your milk will go sour.  And [soap is far better than hand sanitizer](https://www.cdc.gov/handwashing/show-me-the-science-hand-sanitizer.html), so you're not even stocking up on the right thing.  The alcohol-goo doesn't release debris/dirt or clean underneath it, just drying things out (which kills bacteria, but is shakier on viruses), while the soap {% wiki Surfactant|surfactants|en %} disrupt the fatty envelope that gives viruses a physical presence that isn't just genetic material.  And, if you're *that* worried about running out of toilet paper, why wouldn't you just attach one of those add-on mini-bidets!?
