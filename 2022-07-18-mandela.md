...
labels: [javascript, license, mystic-t-square]
...
Today celebrates {% wiki Mandela_Day|Mandela Day|en %}, honoring the late activist and eventual head of state Nelson Mandela.
...
While it has other uses, I meant the term "mystic square" to refer to a variation of the {% wiki 15_puzzle|15 puzzle|en %}.  This, technically, qualifies as an "8 puzzle," where the Tic-Tac-Toe game plays out on sliding blocks.  You might capture a corner, but your opponent can slide that corner square away.
