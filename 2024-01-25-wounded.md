...
You might recognize Macet as {% wiki Marc_Alaimo|Marc Alaimo|en %}, who previously appeared as the Romulan Tabok in [*The Neutral Zone*]({% post_url 2022-11-10-neutral-zone %}), and will go on to show up somewhat regularly as a different Cardassian Gul on **Deep Space Nine**.
...
We get a surprising amount of Thomas Moore's {% wiki The_Minstrel_Boy|*The Minstrel Boy*|en %}.  Maybe interestingly, if it sounds familiar to you today---as opposed to 1991, when this aired---you might recognize it from {% wiki Eleanor_McEvoy|Eleanor McEvoy|en %}'s 2017 recording of it.
