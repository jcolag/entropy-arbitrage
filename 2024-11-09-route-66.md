...
The website describes the film as follows, in German.
 ...
 > Im Dezember 2004 wurde der Debütfilm „Route 66 - Ein amerikanischer albTraum“ zum {% wiki Herunterladen|Herunterladen|de %} bereitgestellt.
 >
 > Drei Sachsen machen sich in einem alten {% wiki Cadillac|Cadillac|de %} auf den Weg von der US-amerikanischen Ost- zur Westküste. Dazu besteht offensichtlich kein anderer Anlass als ein als Roadtrip geplanter Urlaub. Der an allen Ecken und Enden marode, aber originale Cadillac macht dem von Anfang an einen Strich durch die Rechnung. Das ständig nötige Aufsuchen fremder Hilfe bei den kleineren und größeren Reparaturen führt zu merkwürdigen Gegebenheiten. Nach 100 Filmminuten kommen die drei in {% wiki San_Diego|San Diego|de %} an.
 >
 > Gedreht wurde der {% wiki Roadmovie|Roadmovie|de %} im Mai 2002 mit zwei Kameras von den drei Hauptdarstellern selbst. Es gab offenbar keinerlei Skript, die Aufnahmen sind oft in einem videotypischen Stil, wie er auch durch Formate wie „{% wiki Mein_neuer_Freund|Mein neuer Freund|de %} bekannt wurde. Der Film wurde auf der Website des {% wiki Netlabel|Netlabels|de %} veröffentlicht und mithilfe von Traffic-Sponsoren und auch via Tauschbörsen wie {% wiki BitTorrent_(Protokoll)|BitTorrent|de %} oder eMule verteilt. Der {% wiki Soundtrack|Soundtrack|de %} von {% wiki valleyforge|Valleyforge|de (Seite nicht vorhanden) %} wurde separat und auch unter einer {% wiki Creative_Commons|Creative Commons|de %}Lizenz veröffentlicht.
 >
 > Die {% wiki Informationstechnik|IT|de %}-{% wiki Nachrichtenticker|Nachrichtenticker|de %} und Offline-Presse berichteten in der Folge vom „ersten 'Open Source'-Film der Welt“ („Spiegel Online“), andererseits aber auch von „Open Soße“, bei der das Etikett „Open Source“ lediglich als PR-Gag genutzt werde („Telepolis“).
 >
...
Finally, note that this skirts the line between a fictionalized account of events---many sequences look outright staged to heighten the reality---and {% wiki Gonzo_journalism|gonzo journalism|en %}, so it might not *quite* fit the usual criteria for these posts.

## What Works Well?

The cinematography occasionally has some beautiful shots.  The brief {% wiki Washington_Metro|DC Metro|en %} sequence almost feels like it belongs in a trendy advertisement, for example.  It doesn't always go anywhere useful, such as the pseudo-CGI effects, but they also don't always have the best source material to work with.  As the narration points out, after all, the actual {% wiki U.S._Route_66|Route 66|en %} doesn't actually have much drama or romance to it, beyond having gotten unified and paved before other routes to the West Coast.  It gets most of its cultural status from 1939's {% wiki The_Grapes_of_Wrath|**The Grapes of Wrath**|en %} the {% wiki %28Get_Your_Kicks_on%29_Route_66|1946 song|en %} and the {% wiki Route_66_%28TV_series%29|1960 crime drama|en %}.
...
Of the trip itself, getting stranded near the border between New Mexico and Texas---the {% wiki Glenrio,_New_Mexico_and_Texas|Glenrio|en %}s, it would appear---the film feels like it makes more progress than the rest of the trip, as we actually meet people and see some of the country that the travelers wanted to see.
...
It looks like you can still purchase downloads of the film and the soundtrack---non-commercial, {% wiki VEB_Film_Leipzig|according to Wikipedia|en %}---for 10 € apiece through the Gumroad links on VEB's website, and can (still?) snag a copy of the DVD from Amazon for about 40 €.  Otherwise, I don't see much evidence of working with a project over twenty years old...
