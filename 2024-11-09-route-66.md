...
The website describes the film as follows, in German.
 ...
 >
 > Drei Sachsen machen sich in einem alten {% wiki Cadillac|Cadillac|de %} auf den Weg von der US-amerikanischen Ost- zur Westküste. Dazu besteht offensichtlich kein anderer Anlass als ein als Roadtrip geplanter Urlaub. Der an allen Ecken und Enden marode, aber originale Cadillac macht dem von Anfang an einen Strich durch die Rechnung. Das ständig nötige Aufsuchen fremder Hilfe bei den kleineren und größeren Reparaturen führt zu merkwürdigen Gegebenheiten. Nach 100 Filmminuten kommen die drei in {% wiki San Diego|San_Diego|de %} an.
 >
 > Gedreht wurde der {% wiki Roadmovie|Roadmovie|de %} im Mai 2002 mit zwei Kameras von den drei Hauptdarstellern selbst. Es gab offenbar keinerlei Skript, die Aufnahmen sind oft in einem videotypischen Stil, wie er auch durch Formate wie „{% wiki Mein neuer Freund|Mein_neuer_Freund|de %} bekannt wurde. Der Film wurde auf der Website des {% wiki Netlabels||Netlabel %} veröffentlicht und mithilfe von Traffic-Sponsoren und auch via Tauschbörsen wie {% wiki BitTorrent|BitTorrent_(Protokoll)|de %} oder eMule verteilt. Der {% wiki Soundtrack|Soundtrack|de %} von {% valleyforge|Valleyforge|de (Seite nicht vorhanden) %} wurde separat und auch unter einer {% wiki Creative Commons|Creative_Commons|de %}Lizenz veröffentlicht.
 >
 > Die {% wiki IT|Informationstechnik|de %}-{% wiki Nachrichtenticker|Nachrichtenticker|de %} und Offline-Presse berichteten in der Folge vom „ersten 'Open Source'-Film der Welt“ („Spiegel Online“), andererseits aber auch von „Open Soße“, bei der das Etikett „Open Source“ lediglich als PR-Gag genutzt werde („Telepolis“).
 >
