...
labels: [blog, globe, iungimoji, javascript, library-update, yaml]
...
Today marks the 179<sup>th</sup> anniversary of the opening of {% wiki Tivoli_Gardens|Tivoli Gardens|en %}, the oldest amusement park still standing.
...
It requires slightly *more* than that, though, because this game involves more than one random choice.  The biggest difference involves what to do with the doubled-and-shuffled emoji list.  In the original version of the game, it iterates through the list to generate plain HTML.  Here, though, I need to insert {% wiki Document_Object_Model|DOM|en %} elements into the existing page.
