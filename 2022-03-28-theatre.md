...
Yesterday, people celebrated {% wiki World_Theatre_Day|World Theatre Day|en %}, an event promoting live theater.  They obviously have a harder sell during a pandemic---in fact, I wrote about the issues in [large indoor audiences]({% post_url 2020-07-05-pmedia %}) and how we might improve on them---but theater still represents an important part of any culture.
