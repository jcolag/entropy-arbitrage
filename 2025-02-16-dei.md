...
First, I should point out that DEIA policies *implement* the civil rights laws, not violate them, as you probably already know.  In addition, he blamed the {% wiki 2025_Potomac_River_mid-air_collision|Potomac River midair collision|en %} on a process that *verifies* that you have the best candidates, doubling down on it in [another Executive Order](https://www.whitehouse.gov/presidential-actions/2025/01/immediate-assessment-of-aviation-safety/)[^1].
...
In a lot of ways, this makes history deep resistance and diversity initiatives a competitive advantage.  Learn about {% wiki Phillis_Wheatley|Phillis Wheatley|en %}, {% wiki Benjamin_Banneker|Benjamin Banneker|en %}, {% wiki Sally_Hemings|Sally Hemings|en %}, {% wiki Harriet_Tubman|Harriet Tubman|en %}, {% wiki Nat_Turner|Nat Turner|en %}, {% wiki Frederick_Douglass|Frederick Douglass|en %}, {% wiki Zora_Neale_Hurston|Zora Neale Hurston|en %}, {% wiki Florence_Price|Florence Price|en %}, {% wiki Claudette_Colvin|Claudette Colvin|en %}, and so many more.  Learn about our country's system of slavery, subsequent {% wiki Jim_Crow_laws|Jim Crow laws|en %}, and its modern equivalents in racialized prison sentences and forced labor; race riots such as the {% wiki Tulsa_race_massacre|Tulsa massacre|en %} and the {% wiki Wilmington_massacre|Wilmington coup|en %}; and other events illustrating that Black history and white supremacist history substantially overlap.
