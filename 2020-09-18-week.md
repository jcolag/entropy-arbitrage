...
This quote marks the start of {% wiki National_Hispanic_Heritage_Month|National Hispanic Heritage Month|en %}.  At the end of the first week, what I think that I've discovered is that the Latinx American community has historically...not been chronicled, possibly ignored more than any other group I've looked at.  So, if you catch me trying to find something useful said by {% wiki Ted_Cruz|Ted Cruz|en %} or {% wiki Marco_Rubio|Marco Rubio|en %}, that's why.  I hope it doesn't come to that, but keeping to public domain sources and an ethnicity Americans traditionally don't care about is going to make for a rough month.
