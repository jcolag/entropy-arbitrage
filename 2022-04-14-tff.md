...
Our introductory character---probably named for a certain {% wiki Martian_Manhunter|green-skinned superhero|en %}---looks to be some sort of extremely poor miner or farmer.  He implies that he might own the land or the rights to the land.  Maybe interestingly, it's hard to tell whether he's supposed to be human.
...
It's unclear whether writers meant"marsh melons" to be a joke about Spock misreading {% wiki Marshmallow|marshmallow|en %}, or if this is some modern replacement of the candy.
...
*Moon over Rigel VII* is apparently a common campfire song.  McCoy also suggests {% wiki Camptown_Races|*Camptown Races*|en %}, which is incredibly racist, originally titled as *The Celebrated Ethiopian Song* as part of a minstrel show act.  Kirk inexplicably suggests {% wiki Pack_Up_Your_Troubles_in_Your_Old_Kit-Bag|*Pack Up Your Troubles in Your Old Kit-Bag, and Smile, Smile, Smile*|en %}, a marching song from World War I.
...
The Klingon ship destroys either {% wiki Pioneer_10|Pioneer 10|en %} or {% wiki Pioneer_11|Pioneer 11|en %}, given that we see the plaque.  NASA launched them in 1972 and 1973, respectively, traveling at roughly 51,800 kilometers per hour.  Assuming no interference, that puts them 8.5x10<sup>12</sup> km from Earth, or a bit more than one thousandth of a light year from Earth, which seems...improbable for a Klingon to find it, unless they routinely fly near Earth.
...
Kirk quotes [*Sea-Fever*](https://en.wikisource.org/wiki/Sea-Fever), published in 1902 as part of Masefield's {% wiki Salt-Water_Poems_and_Ballads|**Salt Water Ballads**|en %}.  McCoy somehow mistakes it for {% wiki Herman_Melville|Herman Melville|en %}.
...
Spock admits that Sybok is also Sarek's son, which Kirk believes is a lie.  While actor {% wiki Laurence_Luckinbill|Lawrence Luckinbill|en %} looks much younger, he and Nimoy are only a couple of years apart.  But it does imply that this attempted revolutionary action occurred in recent memory, given Spock's age.
...
In addition to the barrier we had in [*Where No Man Has Gone Before*]({% post_url 2020-01-23-trek-no-man %}) around the galaxy, there is also a Great Barrier around the {% wiki Central_massive_object|galactic core|en %}.

 > **SPOCK**: It's a primitive form of communication known as Morse Code.

Starfleet apparently still teaches {% wiki Morse_code|Morse code|en %}.  In turn, this reinforces that the Federation largely uses English, since we probably wouldn't expect interstellar languages to use the Latin alphabet.
