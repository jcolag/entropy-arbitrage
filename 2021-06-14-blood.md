...
In the United States, it's {% wiki Flag_Day_%28United_States%29|Flag Day|en %}, but that's (frankly) a silly, faux-patriotic holiday that's most notable for its nearer proximity *as* a patriotic holiday to the summer solstice next week than Independence Day is.  So, instead, I'm going with {% wiki World_Blood_Donor_Day|World Blood Donor Day|en %}, since blood donation is fairly important.
...
Anyway, I haven't decided on a license (if any) for the main page, yet.  Unlike the blog, I can't see much use for recycling any of that content that's both beyond {% wiki Fair_use|Fair Use|en %} doctrine and something that I'd be comfortable allowing.  And anybody who sees another use can always ask, until I make a real decision.
