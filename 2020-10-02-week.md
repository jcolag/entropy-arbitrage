...
It's a shame that there's no easy way to track the spread of ideas, because this self-written epitaph---based on the era it was written---might easily have influenced the introduction to {% wiki The_Adventures_of_Superman_%28radio_series%29|**The Adventures of Superman**|en %} and so the lore of the character in general.
