...
I haven't decided whether I find it acceptable enough to link to the front page, and may take it down.  But for now, it gives a tour of where you might find me.
...
If you wanted the language distribution, though---ignoring books published in a variety of African and Indian languages---over the last almost-six years, we have managed to track down works in Farsi, French, German, Hungarian, Japanese, Polish, Swedish, and Tamil, though I might have missed one or two.  I could have sworn that we checked out something from China, but I suppose not.
