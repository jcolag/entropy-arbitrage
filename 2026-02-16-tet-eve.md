...
Because we can't rightly overlook the boisterous festivities in places like Rio and New Orleans, {% wiki Carnival|Carnival|en %} started yesterday and continues through tomorrow, the big period of indulgence for mostly-Catholics before heading into Lent.  As with many Catholic holidays, it may have its roots in the {% wiki Navigium_Isidis|Navigium Isidis|en %} festival.
