...
That the aliens choose {% wiki Abraham_Lincoln|Abraham Lincoln|en %} as their proxy further reinforces the idea that we saw floated early in the series, suggesting that Earth is basically an expanded version of the United States.
...
While "Louis of France" could mean any of the French kings from {% wiki Louis_the_Pious|Louis the Pious|en %} to {% wiki Louis_Antoine,_Duke_of_Angoul%C3%AAme|Louis XIX|en %}, though probably not him, given that he was king for about fifteen minutes.  {% wiki Robert_the_Bruce|Robert the Bruce|en %} was a medieval Scottish hero.
...
As to the word under discussion, "[negro](https://en.wiktionary.org/wiki/negro)" and "negress" are considered somewhere between archaic and offensive, a relic of the {% wiki Jim_Crow_laws|Jim Crow|en %} era, and so particularly sensitive at the time the episode aired.  However, it's worth pointing out that the connection to {% wiki Slavery#Chattel_slavery|chattel slavery|en %} is because Black people were considered property in the United States, not because the *word* was used to dehumanize people.
...
Back in [*Conscience of the King*]({% post_url 2020-04-09-trek-conscience %}), there was an {% wiki Arcturus|Arcturan|en %} **Hamlet**.  The area is apparently known for animal life, too.
...
I've pointed out the {% wiki Toxic_masculinity|toxic masculinity|en %} and how toxic masculinity basically relies on people---mostly men---policing each other.  And here, we see that in action, with Spock immediately concerned that he's being judged and feeling the need to repent for that brief flash of emotion.
...
We've mentioned {% wiki Genghis_Khan|Genghis Khan|en %} in episodes as far back as [*What Are Little Girls Made Of?*]({% post_url 2020-02-27-trek-girls %}).  Green apparently started a genocide *after* the Eugenics Wars discussed in [*Space Seed*]({% post_url 2020-12-31-force %}), which has another mention of Genghis Khan, by the way.  *Tiburón* is Spanish for "shark," though it's also used as a place name in areas like California and Haiti.  {% wiki Zora_%28given_name%29|Zora|en %} has tended to be a name given to girls, especially in Eastern Europe, though it's most likely recognized today for {% wiki Zora_Neale_Hurston|Zora Neale Hurston|en %}.  And we should probably take it as given that Kahless was known in the Federation, given that the whole point of the exercise is to pick historical figures that the crew recognizes.  And if you know the franchise, then you probably know him better from later shows, where we could probably piece together Kahless's entire life story without much trouble.

Two additional details of note are that Genghis Khan---perhaps shockingly, for the period---is played by an actor of actual Chinese descent, Nathan Jung, and that there's a string similarity of Green's uniform to the costume worn by Robin Williams a decade later on {% wiki Mork_%26_Mindy|**Mork & Mindy**|en %}, with many people thinking that it was reused.  I'm guessing that a one-off costume from 1966 wasn't used every week for four years, personally, plus it doesn't seem to be the same material, but I suppose that it's possible.
...
That's a reference to {% wiki Ulysses_S._Grant|Ulysses S. Grant|en %}.
