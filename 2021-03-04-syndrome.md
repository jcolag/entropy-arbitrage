...
The idea of "primitive" cultures needing aliens to build things from them is right out of {% wiki Chariots_of_the_Gods%3F|**Chariots of the Gods?**|en %}, released around the same time as this episode.  You can also find precursors to those ideas in {% wiki The_Morning_of_the_Magicians|**The Morning of the Magicians**|en %}, {% wiki At_the_Mountains_of_Madness|**At the Mountains of Madness**|en %}, and Charles Fort's **The Book of the Damned**.  So, while there's a hint of racism to all of it, it's a common trope.
...
Today, the {% wiki Navajo|Navajo Nation|en %} is the largest of the federally recognized native tribes, centered in the Southwest United States.  The {% wiki Mohegan|Mohegans|en %} are one of the tribes centered in Connecticut in the Northeast, though it's possible that the script specifies the {% wiki Mohicans|Mohicans|en %}, instead, who live somewhat further northwest.  The {% wiki Lenape|Lenape|en %} (or "Delaware") stretched from Delaware, through New Jersey, into western New York and Connecticut.
...
{% wiki Shangri-La|Shangri-La|en %} comes from a popular 1933 novel.
...
Probably the nearest equivalent that we have on Earth is a {% wiki Whistled_language|whistled language|en %}, which has had some representation among North American natives, particularly among the {% wiki Taos_language|Taos|en %} people and many Mexican tribes.  There's also the early constructed language {% wiki Solresol|Solresol|en %}, which had multiple representations for its "letters," including musical notes.
