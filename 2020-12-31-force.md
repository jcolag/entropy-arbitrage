...
Of course, "rubindium" is original to the episode and seems like just a typo for {% wiki Rubidium|rubidium|en %}, often used in lasers.
...
Now, I certainly realize that the Nazi Party was dismantled, and Germany---first divided between empires, now unified---has grown into one of history's best examples of being an important non-militant power.  But a *lot* of work went into making that happen, rather than just hoping that the Germans elect a couple of Jewish men into minor political positions and heading home on VE Day.
 ...
 >
 > **SPOCK**: Yes. Earthmen like {% wiki Ramesses_II|Ramses|en %}, {% wiki Alexander_the_Great|Alexander|en %}, {% wiki Julius_Caesar|Caesar|en %}, {% wiki Napoleon|Napoleon|en %}, {% wiki Adolf_Hitler|Hitler|en %}, Lee Kuan. Your whole Earth history is made up of men seeking absolute power.

I linked the real-world names to their Wikipedia pages.  Lee Kuan *might* be a reference to then-Singaporean Prime Minister {% wiki Lee_Kuan_Yew|Lee Kuan Yew|en %}, who was an authoritarian and eugenicist.  However, Lee *also* pushed for a bilingual, multiracial society where government employees were tested for qualifications before promotions, which speaks against the comparison.
...
Granted, I can understand that {% wiki Hari_Singh_Nalwa|Hari Singh Nalwa|en %} might be too obscure for a 1960s American audience, but {% wiki Genghis_Khan|Genghis Khan|en %} got a shout-out in one of these lists in [*What Are Little Girls Made Of?*]({% post_url 2020-02-27-trek-girls %}), along with Caesar, Hitler, and two future names.
