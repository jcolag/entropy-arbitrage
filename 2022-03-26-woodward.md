...
Even in this tiny selection, we have a wide range of topics from domestic abuse to science fiction to politics.  The political issues range from the specific---I didn't bother with any, here, since they're not exactly fiction, but there are quite a few that primarily express opposition to the {% wiki Iraq_War|Iraq War|en %} or the {% wiki Patriot_Act|Patriot Act|en %}---to the broader concerns that people express about underserved communities or the difference between stating support for causes and actually supporting them.
