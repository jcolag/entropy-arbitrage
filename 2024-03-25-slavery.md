...
labels: [blog, earburn, html, library-update, newsletter]
...
Wait.  We have an actual holiday, kinda-sorta, today?  Indeed, sit down, because this one will take a bit, but today, we observe the {% wiki International_Day_of_Remembrance_of_the_Victims_of_Slavery_and_the_Transatlantic_Slave_Trade|International Day of Remembrance of the Victims of Slavery and the Transatlantic Slave Trade|en %}, which I feel like I shouldn't need to explain, because the name has all the relevant words in it, and I have to imagine that anybody reading my blog understands the importance of this sort of observation.

If you don't like that one, then the United Nations observes the not-quite-as-wordy {% wiki International_Day_of_Solidarity_with_Detained_and_Missing_Staff_Members|International Day of Solidarity with Detained and Missing Staff Members|en %} today, also pretty much what the name says.  Given the various political campaigns to undermine the United Nations and its projects, it seems particularly important to watch out for its workers.
