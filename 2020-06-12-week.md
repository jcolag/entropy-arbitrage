...
This is for those of you who have been trying to digest four centuries (and a year) of racist governance in the United States.  It's overwhelming, but today makes far less sense without understanding the background of (random examples) {% wiki First_Africans_in_Virginia|United States slavery pre-dating the *Mayflower*|en %}, the difference between Thomas Jefferson's [views on equality](https://www.monticello.org/slavery-at-monticello/liberty-slavery) versus his {% wiki Sally_Hemings|ownership of human beings|en %}, {% wiki Nat_Turner's_slave_rebellion|Nat Turner's slave rebellion|en %}, {% wiki Juneteenth|Juneteenth|en %}, the {% wiki Tulsa_race_massacre|Tulsa race massacre|en %}, {% wiki Ax_Handle_Saturday|Ax Handle Saturday|en %}, the {% wiki Stonewall_riots|Stonewall uprising|en %}, the {% wiki Kent_State_shootings|Kent State massacre|en %}, and so forth, this month seems like a mystery.
...
**Credits**:  Header image is {% wiki Week#/media/File:CLM_14456_71r_detail.jpg|Circular diagrams showing the division of the day and of the week|en %} from a manuscript drafted during the Carolingian Dynasty.  [Tree Roots](https://www.flickr.com/photos/davidstanleytravel/33446766913/) by [David Stanley](https://www.flickr.com/photos/davidstanleytravel/) is made available under the terms of the [Creative Commons Attribution 2.0 Generic](https://creativecommons.org/licenses/by/2.0/) license.
