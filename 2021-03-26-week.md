...
To be fair, this isn't new.  It has just been more overt since the {% wiki Dakota_Access_Pipeline_protests|Dakota Access Pipeline protests|en %} spooked Republican donors.  Members of the Nixon administration have been open about the fact that the [War on Drugs was meant to stop the movement against the Vietnam War](https://www.vox.com/2016/3/22/11278760/war-on-drugs-racism-nixon).  They keep trying to {% wiki Flag_Desecration_Amendment|ban burning the American flag|en %}.  And while both parties have used the idea, Republicans have been the most aggressive with {% wiki Free_speech_zone|free speech zones|en %} as a way of ensuring that protests aren't heard.
