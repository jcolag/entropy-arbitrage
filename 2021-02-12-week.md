...
If the aphorism hasn't been so widely misused, we'd all understand that {% wiki A_rising_tide_lifts_all_boats|a rising tide lifts all boats|en %}.  But because the aphorism is deliberately used to hide the damage done by only lifting up certain people, we need studies to tell us that raising the lowest point (what high tide does in a harbor) makes everybody's life better.  For example, here, if people have housing and utilities, they don't get sick as often and don't spread a deadly disease.
