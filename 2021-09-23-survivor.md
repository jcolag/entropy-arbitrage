...
{% wiki Cerberus|Cerberus|en %} was the mythological multi-headed dog guarding the gates of the underworld in Greek mythology.  I feel like, when you name your municipality after anything related to the gateway between life and death, you should maybe not be surprised when people are having a rough time surviving.

 > **WINSTON**: My fiancée? Anne's aboard this starship?

At least in some circles, a formal engagement to be married is still normal.

Carter Winston, incidentally, is voiced by {% wiki Ted_Knight|Ted Knight|en %}, which feels like it makes covering the episode at this time appropriate, since he was the first among the cast of {% wiki The_Mary_Tyler_Moore_Show|**The Mary Tyler Moore Show**|en %} to pass away, and we also lost {% wiki Cloris_Leachman|Cloris Leachman|en %}, {% wiki Gavin_MacLeod|Gavin MacLeod|en %}, and {% wiki Ed_Asner|Ed Asner|en %}, this year.
...
It's not an acid---which might be the point of the scene, a joke that Kirk is only bluffing---but {% wiki Orientin|orientin|en %} is a flavone found in bamboo, passion flower, açaí, buckwheat, and millet.
...
To be clear, I'm fine with her asking a squid-dude out on a date.  Even Earth-cephalopods are oddly {% wiki Cephalopod_intelligence|intelligent|en %}, and there are {% wiki Tentacle_erotica|entire genres|en %} devoted to this sort of thing, so it's not my place to judge her, there.

However, I'm admittedly a *bit* put off by how quick she is to date the man who stole her fiancé's identity and essentially {% wiki Catfishing|catfished|en %} or {% wiki Spanish_Prisoner|Spanish prisoner|en %}'d her.  For all the talk about Vendorian dishonesty, nobody seems concerned about this little detail...
...
Valeria is a somewhat common name seemingly prominent due to the {% wiki Valeria_gens|gens Valeria|en %} of the Roman Republic.  It's probably most relevant in science fiction circles for the character in [*Red Nails*](https://en.wikisource.org/wiki/Red_Nails) and a planet mentioned in [**First Lensman**](https://standardebooks.org/ebooks/e-e-smith/first-lensman).
...
While Darius is a fairly common given name, if it referred to anybody other than {% wiki Darius_the_Great|the ancient Iranian king|en %} (𐎭𐎠𐎼𐎹𐎺𐎢𐏁), I'd expect a scene where some politician explains that, while most people assume that, it's really in honor of this other person.
