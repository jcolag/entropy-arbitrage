...
First, yes, absolutely go read **Maus**.  While supplies are tight at the moment---not only did Tennessee make it known to a much larger audience, but {% wiki Holocaust_memorial_days|Holocaust Memorial Day|en %} (for most of the world) is just over a week ago---you can order a copy just about anywhere.
