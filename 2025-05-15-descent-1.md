...
Not the actual scientists, but we also see holograms of {% wiki Albert_Einstein|Albert Einstein|en %} who you might recognize as {% wiki Tests_of_general_relativity#Perihelion_precession_of_Mercury|Jim Norton|en %} (not the one that came to your mind, thank goodness) and {% wiki Isaac_Newton|Isaac Newton|en %} in the game who you might recognize as {% wiki John_Neville_%28actor%29|John Neville|en %}.

Oh, and so that we don't need to endure the "Data explains the joke but doesn't understand humor" bit, {% wiki Tests_of_general_relativity#Perihelion_precession_of_Mercury|Mercury's precession|en %} indeed presented significant problems to Newtonian physics, resolved with general relativity.
...
We met the admiral in [*Chain of Command*]({% post_url 2025-01-23-chain-command-1 %}).  She mentions ships named after the Klingon chancellor in [**The Undiscovered Country**]({% post_url 2022-04-21-tuc %}), the nineteenth century {% wiki Crazy_Horse|Lakota war leader|en %}, and the {% wiki Agamemnon|Greek prince|en %} known for his Trojan War exploits.
