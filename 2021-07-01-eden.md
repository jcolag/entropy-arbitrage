...
This episode was enough of a problem---the central relationship in early drafts was between Kirk and McCoy's daughter Joanna, for example---that the "Michael Richards" credited as the writer was a pseudonym for {% wiki D._C._Fontana|D.C. Fontana|en %}.  Having seen a summary of the draft---if I could find the script, I'd add a section for it---I can see her point, because that was a far better story.  So, we're in for a bumpy ride.

 > **SPOCK**: It is definitely the stolen space cruiser, Captain, the Aurora. I read six aboard.

The most likely references for the *Aurora*'s name are the {% wiki Aurora_%28mythology%29|Roman goddess of the dawn|en %} and the {% wiki Aurora|atmospheric disturbance|en %}.
...
Behind-the-scenes stories have always claimed that "Herbert" was intended as a reference to the show's former Executive Producer, {% wiki Herbert_Franklin_Solow|Herb Solow|en %}.

 > **SCOTT**: I don't know. They're sitting on the floor, the lot of them. You can hear for yourself. Shall I send for security?

For any readers who might be too young to recognize it from 1960s news footage, this is a clumsy attempt to reference the {% wiki Sit-in_movement|sit-in movement|en %}, used as a form of non-violent protest.
...
We don't even see it from Spock, who would normally be the first to interrupt a conversation to blurt out something like, "I fail to see how the lengths of your post-{% wiki Glenohumeral_joint|glenohumeral|en %} appendages are of any importance in this situation."  So, as I've suspected through most of the series, he just does that to bother his colleagues.

 > **SEVRIN**: The planet Eden.

We talked about references to the {% wiki Garden_of_Eden|Garden of Eden|en %} in [*The Apple*]({% post_url 2020-09-10-apple %}) and [*A Private Little War*]({% post_url 2020-12-17-war %}).
...
{% wiki Patronymic|Patronyms|en %} have been a common element of Slavic names for a long time, so it's probably notable that it's still in use at the family level, even if it doesn't seem like they use their "middle names" professionally.
...
A {% wiki Coccus|coccus|en %} is a single-celled organism with a round shape, the *syntho-* prefix implying that it's synthetic and not "evolved."  *Nova* is Latin---specifically the feminine nominative singular---for "new;" today, the word is usually used in the context of a star that was previously inconspicuous in the night sky, but has suddenly brightened.  The upshot is that this sounds like a biological warfare project that was accidentally released.

Typhoid Mary was the derisive name given to {% wiki Mary_Mallon|Mary Mallon|en %} in the early 1900s.  To this day, the law and culture isn't settled on the ethics of forcibly quarantining sick people.
...
The quick reaction shots of the crew around the ship bopping along with the music suggests that this style---I want to call it {% wiki Psychedelic_rock|psychedelia|en %}, but given the lack of electronic effects, it's probably closer to {% wiki Raga_rock|Raga rock|en %}---is probably fairly popular.  Adam plays a handful of songs, apparently written by actor Charles Napier, with similar (but distinct) styles, but this is clearly the work that the crew openly enjoys.
...
**Credits**: The header image is [The Garden of Eden](https://commons.wikimedia.org/wiki/File:Cole_Thomas_The_Garden_of_Eden_1828.jpg) by {% wiki Thomas_Cole|Thomas Cole|en %}, long passed into the public domain.
