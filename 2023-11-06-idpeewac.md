...
labels: [ham-newsletter, library-update, pebble, periodic-scripts]
...
Today, we observe (deep breath, now) the {% wiki International_Day_for_Preventing_the_Exploitation_of_the_Environment_in_War_and_Armed_Conflict|International Day for Preventing the Exploitation of the Environment in War and Armed Conflict|en %}, which I feel like I shouldn't need to explain when it already has more than half a dozen of clarifying words in the name.  I also apologize for the unfortunate (on so many levels) acronym.
