...
labels: [blog, codidact, library-update, lights-edge, social-media]
...
Every October, I take a moment to mercilessly mock {% wiki Christopher_Columbus|Christopher Columbus|en %}, the man who even Imperial Spain decided had crossed enough lines to throw him in prison.  It only seems fair, then, to use the 523<sup>rd</sup> anniversary of {% wiki Amerigo_Vespucci|Amerigo Vespucci|en %} sailing west under a Portuguese flag to make fun of *that* utter clown.
