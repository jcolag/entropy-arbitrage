...
Given the show's connections to **Macbeth**---it's one of the main components of [*The Conscience of the King*]({% post_url 2020-04-09-trek-conscience %}), after all---these minor characters and their shared dialogue in verse are likely a reference to the {% wiki Three_Witches|Weird Sisters|en %} from that play.
...
It seems hard to believe that {% wiki Dungeon|dungeons|en %} (underground prisons), {% wiki Curse|curses|en %} (a wish of misfortune), or {% wiki Skeleton|skeleton|en %} (...bones) would be unique to Earth.  Even an {% wiki Iron_maiden|iron maiden|en %} seems fairly straightforward, given the constraints of the murder it's trying to commit.
...
{% wiki Familiar|Familiars|en %} don't actually have that cohesive a story behind them, but the broad idea of a mystic having an assistive servant---usually an animal, but not always---are common enough.
...
Jewels are, in fact, {% wiki Synthetic_diamond|easily manufactured|en %}, natural gemstones usually only keeping their values by [artificially limiting <i class="far fa-copyright"></i>](https://priceonomics.com/post/45768546804/diamonds-are-bullshit) the supply.  So unfortunately, that doesn't tell us as much as it would if they had been offered gold, since the United States was and would continue to be on the {% wiki Gold_standard|gold standard|en %} until 1976 and the writers would have considered gold to have an "intrinsic value."

 > **SPOCK**: Precisely. I refer you to the psychological theory of the racial subconscious. The universal myths, symbols.

Spock is referencing {% wiki Genetic_memory_%28psychology%29|genetic memory|en %}, which is a real phenomenon, though not of the kind Spock is implying.  The idea of biologically encoded stories is, however, a common pop culture extrapolation of the idea.
