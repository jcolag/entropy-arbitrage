...
Today Koreans (often?) observe the birthday of {% wiki Deposed_Queen_Yun|Deposed Queen Yun|en %}, whose murder caused turmoil that included the first {% wiki Korean_literati_purges|literati purges|en %}.  And yes, I largely picked a historical birthday at random.
