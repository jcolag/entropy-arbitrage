...
labels: [blog, ham-newsletter, library-update, quotation-extractor, tool-trunk, twitter-archive]
...
Primarily in Maharashtra, today people celebrate {% wiki Marathi_Language_Day|Marathi Language Day|en %}, sometimes referred to as a Pride Day, set to the birthday of poet {% wiki Kusumagraj|Kusumāgraj|en %} (Vishnū Vāman Shirwādkar).  You all know, by now, that I can't really pass up a minority language...
