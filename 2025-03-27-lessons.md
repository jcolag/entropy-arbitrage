...
Picard has Bach's {% wiki Brandenburg_Concertos#Concerto_No._3_in_G_major,_BWV_1048|Brandenburg Concerto No. 3|en %} on.  He'll mention it later, but I might as well link while we have the music fresh.
...
Oh, she has his number with {% wiki Fr%C3%A8re_Jacques|*Frère Jacques*|en %}, seemingly Picard's favorite song, recurring at least since [*Disaster*]({% post_url 2024-06-13-disaster %}).
...
You presumably recognize the definitely-not-{% wiki The_Skye_Boat_Song|*The-Skye-Boat-Song*|en %} from [*The Inner Light*]({% post_url 2024-10-31-inner-light %}).  He'll later recount the plot for those among us who might have missed it.
