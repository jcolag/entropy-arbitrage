...
Despite my disinterest in the cheapened American version of {% wiki Labor_Day|Labor Day|en %} that tries to pretend that social progress doesn't exist through aggression, I can't find a more interesting holiday.  As such, enjoy mattress discounts celebrating *the unofficial end of summer* or whatever your local morning news team decides to say.  (And I suppose that I did take a lazy morning for myself...)
