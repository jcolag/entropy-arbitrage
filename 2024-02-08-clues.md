...
Adjacent to that, I have to laugh at how the codependent bridge crew unwinds by awkwardly pretending to do martial arts together, except for Crusher, who apparently uses her free time to manage her {% wiki Chia_Pet|Chia Pets|en %}.

Also, one imagines that they named the planet for {% wiki Arrakis|Arrakis|en %}, the central planet in the *Dune* franchise.
...
Apparently, the Federation still operates on {% wiki Network_Time_Protocol|NTP|en %} or something like it.
