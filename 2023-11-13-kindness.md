...
labels: [blog, library-update, notoboto, pebble, small-things, social-media]
...
Today, we celebrate {% wiki World_Kindness_Day|World Kindness Day|en %}, which seeks to highlight local good deeds and the power of kindness in general.

If you prefer outdated stereotypes, today also marks (ugh) {% wiki Sadie_Hawkins_Day|Sadie Hawkins Day|en %}, a fictional holiday from a comic strip where---miracle of miracles {% emoji eyeroll %}---women have permission to ask men on a date.  You know, as if women existed in the world as humans and had agency of their own.
