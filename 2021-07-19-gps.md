...
Today marks the anniversary of the first signal received by the {% wiki Global_Positioning_System|Global Positioning System|en %}.  NTS-2 came online and was detected by {% wiki Rockwell_Collins|Rockwell Collins|en %} contractors in Iowa around lunchtime.

![GPS Satellite, Artist's Conception](/blog/assets/GPS-Satellite-NASA-art-iif.png "GPS Satellite, Artist's Conception")

I've surely mentioned before that GPS is one of my favorite stories from the {% wiki Space_Race|Space Race|en %}.  In essence, part of the {% wiki Sputnik_1|Sputnik|en %} project was gloating.  The Russian government widely published the satellite's path and radio frequency, so that anybody could verify that it was there.  In performing this verification, William Guier and George Weiffenbach realized that they could reverse the math used to find the satellite and use the {% wiki Doppler_effect|Doppler effect|en %} to use the satellite's known location to find *their* location.
