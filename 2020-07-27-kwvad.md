...
labels: [blog, git, github-profile, library-update, newsletter, uxuyu]
...
Today marks the seventy-seventh Anniversary of the {% wiki Korean_Armistice_Agreement|Korean Armistice Agreement|en %}, bringing an unofficial end to a war marked by international posturing, war crimes, and relative abandonment of troops, civilians, and refugees.
