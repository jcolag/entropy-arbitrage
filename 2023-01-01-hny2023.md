 ...
 * [My Mastodon account](https://mastodon.social/@jcolag/), which now gets the sorts of things that I used to post on Twitter, plus the automatic blog-update notices that it has always gotten;
 * [My Diaspora account](https://nota.404.mn/people/e4313920967a0136074b076893c08a76), where I mostly post blog-update notices, because I haven't found much of a community, *and* the server sometimes vanishes for a few days;
