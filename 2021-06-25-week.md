...
This is the central problem whenever somebody tries to "improve" the War on Drugs:  It's doing exactly what it's *designed* to do.  We could solve far more problems with drug use by mailing people {% wiki Naloxone|naloxone|en %}---which is literally as old as the War on Drugs, by the way---and similar overdose and addiction drugs than we ever could by paying to prosecute or incarcerate someone.
