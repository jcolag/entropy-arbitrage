 ...
 * If anything from early issues of {% wiki Amazing_Stories|**Amazing Stories**|en %} is still under copyright---I haven't checked---then that's no longer the case
 * {% wiki Winnie-the-Pooh_%28book%29|**Winnie-the-Pooh**|en %}, the original collection of short stories
 * William Faulkner's {% wiki Soldiers%27_Pay|**Soldiers' Pay**|en %}
 * Ernest Hemingway's {% wiki The_Sun_Also_Rises|**The Sun Also Rises**|en %}
 * D.H. Lawrence's {% wiki The_Plumed_Serpent|**The Plumed Serpent**|en %}
 * S.S. Van Dine's {% wiki The_Benson_Murder_Case|**The Benson Murder Case**|en %}
 * Sylvia Townsend Warner's {% wiki Lolly_Willowes|**Lolly Willowes**|en %}
 * Ruth Plumly Thompson's {% wiki The_Hungry_Tiger_of_Oz|**The Hungry Tiger of Oz**|en %}

#### Film

 * {% wiki Don_Juan_%281926_film%29|**Don Juan**|en %}
 * {% wiki The_Black_Pirate|**The Black Pirate**|en %}
 * {% wiki The_Son_of_the_Sheik|**The Son of the Sheik**|en %}
 * {% wiki The_Sea_Beast|**The Sea Beast**|en %}
 * {% wiki The_Bat_%281926_film%29|**The Bat**|en %}, which is to say the second of three movies based on the same play
 * {% wiki La_Boh%C3%A8me_%281926_film%29|**La Boh&egrave;me**|en %}, based on the opera
 ...
 * {% wiki Baby_Face_%281926_song%29|*Baby Face*|en %}
 * *Gentlemen Prefer Blondes*
 * {% wiki Someone_to_Watch_Over_Me_%28song%29|*Someone to Watch Over Me*|en %}
 * Aaron Copland's {% wiki Piano_Concerto_%28Copland%29|*Piano Concerto*|en %}

There are also poems by {% wiki E._E._Cummings|E.E. Cummings|en %}, {% wiki E._E._Cummings|Langston Hughes|en %}, and {% wiki Dorothy_Parker|Dorothy Parker|en %}.
...
Unless plans change, we may also see the start of construction on the {% wiki Lunar_Gateway|Lunar Gateway|en %} space station.
...
Possibly most relevant to the blog, since I'll probably try to document my process and progress, I feel like picking up a new---human, not programming---language, since I haven't done that in decades.  I'm leaning towards {% wiki Esperanto|Esperanto|en %}.  It's not a practical choice, by any means, but it's at least *partly* designed to be learned, and {% wiki Vikipedio:%C4%88efpa%C4%9Do|Esperanta Vikipedio|eo %} and related Wikimedia projects should provide enough text to get started.  Online translation tools now also generally include the language.
