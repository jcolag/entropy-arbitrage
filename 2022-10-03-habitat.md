...
The first Monday of every October marks {% wiki World_Habitat_Day|World Habitat Day|en %}, bringing awareness of the need for and human right to shelter.  Some years, the discussion drifts more to the communal living, in the state of our cities and towns.  At a time when investors buy up rental properties to raise prices, we continue to see moves to privatize public infrastructure, and cities now worry about running out of water, you might especially see the value of such a day.
