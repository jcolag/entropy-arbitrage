...
Speaking of the New Age thing, you might notice that, overlaid on the Venetian-style masks, the props largely misappropriate symbols from haphazard Native American and Central American cultures.  For example, you might recognize Masaka's symbol from New Mexico's flag, where they adapted it from the native {% wiki Zia_people_%28New_Mexico%29|Zia|en %}, a circle with groups of spokes at the cardinal directions.  Korgano's symbol doesn't come from that part of the hemisphere, but seems to draw inspiration from the "arc of the sky" symbol depicted around {% wiki Coricancha|Coricancha|en %}.  Other glyphs seem to take loose inspiration from the composite squares used in {% wiki Maya_script|Maya script|en %}.  But it all gets used as a marker for "foreign" and "ancient," without any attempt to assimilate them into a coherent design language or show any interest in the cultures.
...
The final frontier, you might say.  Wait, did I accidentally pitch **Star Trek:  {% wiki Flatliners|Flatliners|en %}**?  I'd probably give it more of a chance than I gave **Strange New Worlds**, at least.
