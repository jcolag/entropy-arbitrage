...
I bring up bias in software a lot, because it never ceases to amaze me how an industry that talks so much about the {% wiki Scientific_method|scientific method|en %}, {% wiki Garbage_in,_garbage_out|garbage in, garbage out|en %}, and so forth, will turn around and constantly preach trust in opaque systems that have been "trained" on unaudited data in unaudited ways.
...
For those not in the know, the Ottoman Empire undertook an {% wiki Armenian_Genocide|ethnic cleansing campaign in Armenia|en %} during the First World War.  Because the Republic of Turkey maintained significant continuity with the overthrown Ottoman Empire, with many of the perpetrators now considered national heroes, Turkish nationalists (and anti-Christian bigots) twist themselves in knots trying to justify the mass killings.
