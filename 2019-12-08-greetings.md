 ...
 * Regarding Thue, I was involved with in the {% wiki Esoteric_programming_language|esoteric programming language|en %} community a *very* long time ago.  Ditto the {% wiki Interactive_fiction|interactive fiction|en %} community.  Remember me having said things I'd cringe at today?  A lot of it probably happened in one of those two places.
 ...
 * Rarely, I'm inspired to spend a few minutes/hours editing {% wiki User:Jcolag|Wikipedia|en %}.  At some point, I somehow had my own Wikipedia page, too, but the editors there *finally* realized I wasn't notable after my bringing it to their attention a few times.
