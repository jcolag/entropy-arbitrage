...
labels: [cc-by-sa, novel, prose, solarpunk]
...
Similarly, we're introduced to the idea that Narluga gets her name from the so-called narluga whale---a {% wiki Narluga|hybrid|en %} of narwhal and beluga---which are implied here to have become common in the North Atlantic waters.  We also get some insight into a system of magic of questionable reality.
