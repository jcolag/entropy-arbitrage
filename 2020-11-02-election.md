...
Today is the {% wiki International_Day_to_End_Impunity_for_Crimes_Against_Journalists|International Day to End Impunity for Crimes Against Journalists|en %}, which is important, but *far* too long for the post title.  So instead, in the United States, I'll point out that tomorrow is Election Day.  If you're in the United States and haven't done so already, **please vote**.
