...
I've already spoken about abortion rights at length.  I even wrote about {% wiki Dobbs_v._Jackson_Women%27s_Health_Organization|*Dobbs*|en %} when the draft opinion leaked, so I won't rehash it beyond a summary.
...
Also decided this week, the court found in {% wiki New_York_State_Rifle_%26_Pistol_Association,_Inc._v._Bruen|NYSRPA v Bruen|en %} that a century-old New York law couldn't ask for a justification for a concealed weapon permit.
...
Not that anybody would ask me, but I would handle gun violence by adapting {% wiki Know_your_customer|know your customer|en %} laws in business:  When someone uses a gun in an illegal manner, make the entire supply chain liable for the damage, because every link in that chain failed to understand the business of their customers.  Most critically, if someone misuses *your* gun, victims should hold you responsible for negligence, because you either lent it to someone who had a bad plan or you failed to secure it properly.  I feel that this works, because we have those rules for *money*, and the Supreme Court keeps telling us that money also needs absolute protections.
...
We also saw in {% wiki Carson_v._Makin|Carson v Makin|en %} that the rights that this Supreme Court will always uphold, beyond gun rights, center on the right of fake-Christians to use government money to indoctrinate children on hate.
