...
This is unsurprising---and we'll probably eventually discover that it was intentional, given that the housing market collapse was *driven* by exploiting non-white Americans through {% wiki Subprime_mortgage_crisis|subprime mortgages|en %}---but still worthy of making clear.
...
One of the ranting posts that I never get around to writing is about how {% wiki Corporate_capitalism|corporate capitalism|en %} is the largest bastion of pre-Enlightenment thought, a view of the world where on person---usually a wealthy white man---weilds absolute authority over everything that its organization touches, accountable only through contracts with peers and more powerful sovereigns watching the area, and the alternatives that need more attention.
