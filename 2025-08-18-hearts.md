...
labels: [blog, codidact, ham-newsletter, html, mini-server, notoboto, parchment, recipe]
...
- Ditto for anything that now requires the pain of Python virtual environments, because nobody could bother to prevent the ecosystem from descending into their own version of {% wiki DLL_hell|DLL Hell|en %} while they smugly made fun of it happening elsewhere.
...
Given the season, I also ended up with more zucchini and corn than I expected.  As such, since I almost always have plenty of dried beans on hand, more than a few recent dinners went the {% wiki Three_Sisters_%28agriculture%29|three sisters|en %} route.  It all tasted great, though I couldn't identify any more of a "recipe" than thing-that-I-wanted-to-eat...and the three sisters.  I do recommend exactly that, though, when you can get the ingredients at their peaks.
