...
I only want to call this out because a few years after this episode, {% wiki WebMD|WebMD|en %} would make "I looked up my symptoms" hypochondria a mainstream problem that happens to benefit pharmaceutical and supplement companies.
...
Also, pardon my commenting on the writing, but while I already need to talk about evolution, for the sake of having said it, evolution also doesn't work *this* way, either, because we don't have arachnid and amphibian ancestors.  Best that we can reconstruct the early development of vertebrate life, the early {% wiki Tetrapod|tetrapods|en %} separated into amphibians and {% wiki Amniote|amniotes|en %}, the earliest of which probably resembled reptiles more than anything else.  The amniotes divided into {% wiki Sauropsida|sauropsids|en %} (becoming reptiles and birds) and {% wiki Synapsida|synapsids|en %}, which became mammals and what we used to call "mammal-like reptiles" rather than admit that some dinosaur-looking things didn't fit with the reptiles.

Going back the other way, tetrapods seemingly evolved from fish, with jawed fish (and other vertebrates) evolving from jawless fish (like lampreys and eels), which covers only the vertebrates.  Skipping back a few more steps, the {% wiki Chordate|chordates|en %} split from the {% wiki Arthropoda|arthropods|en %} and {% wiki Mollusca|mollusks|en %} long before that, probably during or before the {% wiki Cambrian_explosion|Cambrian explosion|en %}.  The most recent common ancestor that we have with spiders, for example, goes through the {% wiki Bilateria|bilateral clade|en %}, all creatures that show bilateral symmetry.  The fossil record does *not* suggest that the early bilateral ancestors evolved into spiders, who progressively lost legs until they became fish, then evolved into amphibians, reptiles, and mammals.
...
Despite Picard's inability to pronounce the word, {% wiki Intron|introns|en %} refer to the genes in DNA that cells don't transcribe into RNA.  We call the rest {% wiki Exon|exons|en %}.

The episode's premise falls out of the understanding at the time---minus the aforementioned terrible approach to evolution---where people connected "not transcribed into RNA" to the earlier idea of {% wiki Junk_DNA|junk DNA|en %}.  And like the fictions about humans only using small parts of the brain, the myth that we didn't actively use most of our genetic material spurred a variety of wild theories about what that "extra" material might do if activated.  Those sorts of theories fell out of favor quickly as the {% wiki Human_Genome_Project|Human Genome Project|en %} progressed and ended, and as we've studied the various transcription processes more deeply.
