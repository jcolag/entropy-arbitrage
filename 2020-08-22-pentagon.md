...
Say what you will about them, but I think that Red Faction 69 are charming and could stand more attention, especially given that 2008 ended in {% wiki Financial_crisis_of_2007%E2%80%932008|a financial crisis|en %}, which spawned the {% wiki Occupy_movement|Occupy movement|en %} and provided an excuse for fascism to get a new foothold in society.  So, while the group we see doesn't get names, it would be interesting to see how twelve years of real problems has changed them, and whether a now-college-aged Isaac has grown into a stronger role.
