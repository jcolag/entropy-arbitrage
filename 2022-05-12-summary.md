...
Then, **Picard** and **Lower Decks** feel almost like the same show, in that they both want to produce the thirty-something-th seasons of **The Next Generation**.  **Picard** started out literally trying to get his family back, literally trying to bring back Data and finding a replacement, but also making time to see what Riker has done with his life.  **Lower Decks** especially feels like a disappointment, because the comedic frame and the "second contact" premise both put it in a terrific position to criticize the franchise and ask it to do better.  Instead, the show uncritically laughs along with---for example---"Klingons have similar names" jokes, the anti-Semitic portrayal of Ferengi, the ableist portrayal of the Pakled, the franchise's obsession with action, and so forth.
...
This also serves as a list of posts for the season, though ordered based on where I mention them, rather than the order that I posted them.
