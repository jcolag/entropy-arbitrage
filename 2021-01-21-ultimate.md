...
The star is more commonly known as {% wiki Canopus|Canopus|en %}, previously mentioned in [*Wolf in the Fold*]({% post_url 2020-11-12-wolf %}).
...
Two more sister ships of the *Enterprise*, named for the {% wiki Excalibur|mythical sword|en %} and...well, any number of towns, cities, schools, and ships, but most likely a direct reference to {% wiki Battles_of_Lexington_and_Concord|one of the first battles of the United States Revolution|en %}.
...
Also, {% wiki Orion_%28constellation%29|Orion|en %} comes up frequently in the series, usually as a trading hub that is at least accepting of slavery and has some antagonism with the Federation.
...
If that sounds familiar, Woden is another spelling for {% wiki Odin|Odin|en %}.
...
The youngest Nobel Prize winner in a technical field, as of 2021, is {% wiki Lawrence_Bragg|Lawrence Bragg|en %}, "for their services in the analysis of crystal structure by means of X-rays," in 1915.  Bragg was twenty-five, so the sort of breakthrough they're talking about is one that beats Bragg's record.

For completeness, I should mention that, for Nobel Prizes in general, Bragg's record as the youngest has only been beaten by {% wiki Malala_Yousafzai|Malala Yousafzai|en %}, winning the Nobel Peace Prize in 2014 at the age of seventeen.

The Zee-Magnees Prize is original to this episode, presumably along similar lines to the {% wiki Nobel_Prize|Nobel Prize|en %}.
...
I just want to point out that "I can copy a person's {% wiki Engram_%28neuropsychology%29|engrams|en %}/memories to a computer" is probably far more valuable than "steer a ship and decide who should land on a planet."
...
That's two more sister ships for the *Enterprise*.  Like the *Exeter*, the *Hood* could be named for any number of people, places, or (British Royal Navy) ships.  Likewise, the *Potemkin* could be named for any number of (primarily Russian) people by that surname, in addition to the {% wiki Russian_battleship_Potemkin|Russian battleship|en %}, known primarily from the famous {% wiki Battleship_Potemkin|silent film|en %} dramatizing the 1905 mutiny now considered an early step in the 1917 Russian Revolution.
