...
labels: [globe, iungimoji, library-update]
...
Here, I stuffed a straightforward message into an HTML `footer` element.  And while it seems entirely reasonable to expect `footer` elements to act like a {% wiki Page_footer|page footers|en %}, they do not.  Therefore, they require some quick CSS.
