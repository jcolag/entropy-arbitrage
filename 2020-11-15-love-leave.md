...
However, even though [all art is political]({% post_url 2020-10-18-stories %}), it has been disheartening to see it seep into media, since---{% wiki Digital_rights_management|DRM|en %} excepted---there are no regulations in how we *consume* media.  Unlike certain religions, such as many sects of Christianity, consuming most media isn't meant to occur in central locations, and we don't have a hierarchy of officiants who are meant to provide the faithful with the "correct" interpretations of scripture.

Rather, we read, watch, or listen to our media where and when it is convenient to us, and most people now believe in some version of {% wiki The_Death_of_the_Author|the death of the author|en %}, partly since the author's intent doesn't generally ship as part of the media product, but also because the author does not always achieve their intents.  And this calls to mind Chesterton's false patriot, imagining a one, true way to support a country.
...
While there are obviously some precursors, like Chesterton's quote above or earlier uses of certain phrases in print, the attitude doesn't seem particularly old.  The "love it or leave it" phrasing was popularized largely in response to the backlash against the Vietnam War.  The legal philosophy of {% wiki Originalism|originalism|en %} didn't exist until the 1980s.  Even the oldest versions of this attitude---{% wiki Fundamentalism|religious fundamentalism|en %}---hasn't been around for much longer than a century.
...
Another, more specific, incident that I believe changed "fan culture"---to the extent that it existed---was the release of {% wiki The_Empire_Strikes_Back|**The Empire Strikes Back**|en %} in 1980.  The original {% wiki Star_Wars_%28film%29|**Star Wars**|en %} was a self-contained story marketed primarily to children, as evidenced by the {% wiki Star_Wars_Holiday_Special|**Star Wars Holiday Special**|en %}.  But the sequel was darker and turned the movie into a franchise that continues until today, creating a kind of schism between fans as to whether the franchise is a story about space wizards that can't be taken too seriously or a solemn epic.

Do you like Ewoks from {% wiki Return_of_the_Jedi|**Return of the Jedi**|en %}?  According to the people who don't, you're a child who isn't fit to understand the full scope of the story.  Do you hate them?  Then you're a self-serious person who doesn't understand the point of enjoying movies about wizards having sword-fights in space.  Do you not care either way, but wonder what religious beliefs led them to assume that C-3PO was a god or why they were willing to eat humans?  Both groups hate you for not participating in their tribal rivalry.
...
To unconditionally embrace the destructive flaws in person, organization, or object isn't love.  That's apathy when it's voluntary, {% wiki Emotional_blackmail|emotional blackmail|en %} when it's in reaction to an ultimatum.
