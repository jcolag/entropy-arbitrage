...
I was going to complain about the use of the {% wiki Corporation_for_Public_Broadcasting|Corporation for Public Broadcasting|en %} logo for the mini-documentary that starts the episode, but it quickly becomes interesting enough and appropriate enough to the context that even I can accept the brief lapse relying on Fair Use.
