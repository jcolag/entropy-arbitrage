...
Today is {% wiki World_Teachers%27_Day|World Teachers Day|en %}, meant to bring attention to how teachers affect students and society.
...
It's also {% wiki Child_Health_Day|Child Health Day|en %}, {% wiki Australian_Architecture_Association|World Architecture Day|en %}, and {% wiki World_Habitat_Day|World Habitat Day|en %}.  Is it a coincidence that I was just talking about a health crisis (that affects children directly and indirectly) and architecture?  Probably, but there's a connection, regardless.
