...
I considered writing a full post on this topic, and may still do so.  But honestly, this sums it all up.  And I mean thirty years *fairly* literally, by the way.  In the early-to-mid '90s, at least one company---I've forgotten the name, but it sounded a lot like the description---that had a {% wiki Prolog|Prolog|en %}-based system along the lines of but not *quite* an {% wiki Expert_system|expert system|en %}.
