...
This post is based on [Why are good software engineers so hard to find?](https://www.quora.com/Why-are-good-software-engineers-so-hard-to-find), which I originally answered on Sunday, May 18<sup>th</sup>, 2014.  Obviously, it has been edited substantially to better fit the tone, format, and time of **Entropy Arbitrage**, in this case also combined with more recent discussion that I've had on how to coax prospective employees into taking job offers.
...
This style of job posting is related to the recruiter e-mail that generally goes something like this.
 ...
 > We have such a great opportunity that you seem perfectly suited for!  Please respond with résumé and hourly rate.  Must relocate to North {% wiki Shambhala|Shambhala|en %}.  Four to six week term.  Ten years expertise in {% wiki Whitespace_%28programming_language%29|Whitespace|en %} required.
