 ...
 * Definitely legal but ethically dubious approaches, such as {% wiki Gerrymandering|gerrymandering|en %}, where the votes of certain neighborhoods are diluted in importance.
 * Probably illegal approaches, such as {% wiki Voter_caging|voter caging|en %} or {% wiki Electoral_fraud#5|voter|en %} [intimidation](https://www.commondreams.org/news/2020/10/09/threat-fair-election-experts-warn-danger-posed-armed-pro-trump-poll-watchers), to directly prevent people from voting.
