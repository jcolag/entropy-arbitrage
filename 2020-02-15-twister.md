...
Twister tries to combine the immutability and audit capabilities of blockchains (more precisely, {% wiki Distributed_hash_table|Distributed Hash Tables|en %}) with the ease of download of {% wiki BitTorrent|BitTorrent|en %}.
