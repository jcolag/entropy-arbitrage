...
I'm not thrilled with the framing of "human nature spoiled it," in an article that presents a {% wiki Nature_versus_nurture|nature versus nurture|en %} question, since that shows an obvious bias in the reporting.  But Owen's is still an interesting story.
