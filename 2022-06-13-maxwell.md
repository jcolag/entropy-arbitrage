...
labels: [recipe, library-update, small-things]
...
Today marks the 191<sup>th</sup> birthday of {% wiki James_Clerk_Maxwell|James Clerk Maxwell|en %}, who formalized the body of knowledge---"theory" in the technical sense---describing electricity, magnetism, and light as all stemming from the same phenomenon.
