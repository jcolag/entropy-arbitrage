...
I won't be using it, because getting a [Node.js](https://nodejs.org/en/) server to run over {% wiki HTTPS|Secure HTTP|en %} through my web server (like I do for [my "person generator"](https://colagioia.net:5000/)) is too much trouble.  But the idea has a lot of potential.
...
**Credits**: The header image is the system architecture diagram from the [gitgeist repository](https://github.com/opersys/gitgeist-poc), made available under the terms of the [ASF License v2.0](https://www.apache.org/licenses/LICENSE-2.0).
