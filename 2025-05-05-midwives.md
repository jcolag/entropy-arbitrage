...
labels: [javascript, mystic-t-square, stenotype]
...
Today marks the {% wiki International_Day_of_the_Midwife|International Day of the Midwife|en %}, celebrating and raising awareness of the profession.  Here in the United States, we've begun the process of replacing reproductive care with illegally trafficked whale-heads, worm medication, and probably Folgers Crystals, to see if anybody notices the difference.

Or if you want something more celebratory, then the United States has so fully appropriated {% wiki Cinco_de_Mayo|Cinco de Mayo|en %}---without having the foggiest idea about any relevance of the {% wiki Battle_of_Puebla|Battle of Puebla|en %}, I might add---that I can *probably* get away with offering *Mayo de Cinco B---*OK, maybe not.
