...
And like the piece says, if we accept these bombings as reasonable, then the administration *will* turn the same tactics to American cities, especially given that policing in this country has turned to {% wiki 1985_MOVE_bombing|bombing residential neighborhoods|en %} only forty years ago.
