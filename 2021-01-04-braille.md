...
Today, as perhaps implied by the post title, is World {% wiki Braille|Braille|en %} Day, celebrating the writing system on {% wiki Louis_Braille|Louis Braille|en %}'s birthday.
