...
The ship last got a mention in [*Descent*]({% post_url 2025-05-15-descent-1 %}), as I mentioned there, named for the nineteenth century {% wiki Crazy_Horse|Lakota war leader|en %}.
...
You almost *certainly* recognize Pressman, played by {% wiki Terry_O%27Quinn|Terry O'Quinn|en %}, who feels like he has shown up everywhere, but you probably know him best for his role on **Lost**, though I don't, because I never bothered to watch it.  Where I recognize him from, though, I couldn't tell you...
...
The quick reference, the one that most people at the time probably recognized, pointed to the so-called {% wiki Philadelphia_Experiment|Philadelphia Experiment|en %}, a conspiracy theory about the United States Navy trying to make the USS *Eldridge*[^1] invisible in 1943.  Depending on the retelling, this supposedly had bad side effects on the crew ranging from damaging the rational parts of their brain to destabilizing their atomic structure so that they passed through the ship's bulkheads and fused with them when the invisibility dropped.
...
By the time this episode had come out, the Philadelphia Experiment story had mostly run its course, but especially in my area, the {% wiki Montauk_Project|Montauk Project|en %} picked up as the "sequel"/replacement to the original.  In various versions of this story, including the one in a shockingly popular book by locals---as in, I had people in my life who worked with each of them---{% wiki Camp_Hero_State_Park|Camp Hero|en %} took over the military's weirdest research, sort of a low-rent version of the {% wiki SCP_Foundation|SCP Foundation|en %}.  They allegedly engaged in psychological warfare, the successor technologies to the Philadelphia experiment, {% wiki Moon_landing_conspiracy_theories|faking the Moon landings|en %}, exploring the {% wiki Cydonia_%28Mars%29|Martian pyramids and face|en %}, dealt with alien governments, traveled through time and alternate dimensions, and more.
