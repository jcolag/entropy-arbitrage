...
The quick reference, the one that most people at the time probably recognized, pointed to the so-called [Philadelphia Experiment](https://en.wikipedia.org/wiki/Philadelphia_Experiment), a conspiracy theory about the United States Navy trying to make the USS *Eldridge*[^1] in 1943.  Depending on the retelling, this supposedly had bad side effects on the crew ranging from damaging the rational parts of their brain to destabilizing their atomic structure so that they passed through the ship's bulkheads and fused with them when the invisibility dropped.
