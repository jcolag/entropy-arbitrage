...
The *Ariel* is presumably named for the {% wiki Ariel_%28The_Tempest%29|Shakespeare character|en %}, though the crew may have also had the {% wiki Ariel_%28poem%29|Sylvia Plath poem|en %} in mind, too.
...
{% wiki Canopus|Canopus|en %} has come up in the series since [*Where No Man Has Gone Before*]({% post_url 2020-01-23-trek-no-man %}), though I don't believe that an episode has actually taken place there.
...
This may be a reference to {% wiki Val-Maravel|Val-Maravel|en %}, a somewhat-famous French commune.
...
Anyway, in case anybody feels like the plot about people used as zoo exhibits is implausible, I'd be remiss if I neglected to point people at {% wiki Ota_Benga|Ota Benga|en %}, a Congolese man who was exhibited at the Bronx Zoo in 1906, "partnered" with a feral chimpanzee.
...
Weirdly, {% wiki Epsilon_Scorpii|Epsilon Scorpii|en %} (ε Sco, about 65 light years from Earth) is named Larawag from a {% wiki Wardaman_people|Wardaman|en %} word---not Lactra, the name of the star in the episode---though the names do bear some mild resemblance to each other.  Larawag is probably best known for representing {% wiki Cear%C3%A1|Ceará|en %}, the Brazilian state, on the national flag.  Foster has changed star names before, and seems to have delighted in filling his background with non-European names, so it's surprising that he didn't make the change, here.
