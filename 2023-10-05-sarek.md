...
I don't know that I have anything to say about this episode that won't come out during the regular discussion, other than mentioning a vague memory of how much Paramount publicized the return of {% wiki Mark_Lenard|Mark Lenard|en %} to the franchise.
...
Oddly, despite its common use in the series--- most recently in [*Encounter at Farpoint*]({% post_url 2022-05-19-farpoint1 %})---we generally refer to Alpha Cygni as {% wiki Deneb|Deneb|en %}, but they have reversed the relationship on us, this time.
...
We have references to {% wiki Daniel_Heifetz|Daniel Heifetz|en %} and {% wiki Yehudi_Menuhin|Yehudi Menuhin|en %}, with one presumed non-human and a likely later human.
...
You can find the ordinary {% wiki Thalamus|thalamus|en %} near the bottom of the brain.  One imagines that a "metathalamus" envelops or manages the Vulcan thalamus.
...
The United States Navy has had about seven {% wiki USS_Merrimack|ships named *Merrimac* or *Merrimack*|en %}, all named for the {% wiki Merrimack_River|river that flows in New Hampshire and Massachusetts|en %}, which among other things, has been seen as one of the {% wiki Clean_Water_Act|Clean Water Act|en %}'s biggest victories...which certain communities have recently worked to undo.
