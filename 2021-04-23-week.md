...
So, you can see how we might get from there to insisting that every hate crime, every police execution of a Black man, and every under-funded school is just another coincidence.  It's why activists have started making the distinction between "non-racist" (an identity where you can pat yourself on the back) and "anti-racist" (actively challenging yourself and systems), and why racists always complain about being "made" to feel {% wiki White_guilt|white guilt|en %}.
