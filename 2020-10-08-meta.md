...
I can't find any evidence of a real constellation named Canaris or any variation, which is interesting, since they made sure to get the format right, for once.  If it's meant to be based on real constellations, then the most likely candidate would be some combination of {% wiki Canis_Major|Canis Major|en %} and {% wiki Canis_Minor|Canis Minor|en %}, since the term *canary* refers to the Latin for "dog."
...
So, he's a big deal, the status today that we reserve for iconic heads of state who oversaw or preceded a massive expansion, such as {% wiki List_of_memorials_to_George_Washington|George Washington|en %}, {% wiki List_of_places_named_after_Vladimir_Lenin|Vladimir Lenin|en %}, or {% wiki List_of_places_named_after_Queen_Victoria|Queen Victoria|en %}.  Many people have had a variety of locations named for them, of course, but the mention of multiple planets implies numerous smaller locales that would outstrip a {% wiki List_of_places_and_things_named_after_Sim%C3%B3n_Bolivar|Simón Bolívar|en %} or {% wiki List_of_places_named_after_Guru_Gobind_Singh|Guru Gobind Singh|en %}, who were influential and are still important, but don't have a similar name recognition.
...
{% wiki Judas_goat|Judas goats|en %} are herders, given the name through the analogy of (eventually) herding animals to the slaughterhouse to the story of Judas betraying Jesus to the Romans.
...
It's also possibly noteworthy that the {% wiki Carrot_and_stick|carrot and stick|en %} metaphor is still common.
...
Just to be clear, this isn't even true at any level in humans.  I won't go into too much depth, here, but I'll point to Wikipedia's {% wiki Gender_taxonomy|gender taxonomy|en %} article, which describes:
...
Spock is really reaching for his "gotcha moment," here, in comparing two people living on a planet to marriage, but he also exposes what seems to be an ongoing debate about the nature of marriage, in that {% wiki Bigamy|bigamy|en %} is illegal and reviled in much---but not all---of the Federation.
