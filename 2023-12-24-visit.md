...
I desperately wanted to post this for *last* Christmas, when I first heard about it, but its copyright didn't lapse until the first of this year, and I try to carefully abide by copyrights, so 'til now it has awaited.  In short, the infamous {% wiki James_Thurber|James Thurber|en %} rewrote Clement Clarke Moore's {% wiki A_Visit_from_St._Nicholas|*A Visit from St. Nicholas*|en %} in 1927 while aping the style of then-rising-star {% wiki Ernest_Hemingway|Ernest Hemingway|en %}.
