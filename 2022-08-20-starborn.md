...
labels: [interactive-fiction, mit, sci-fi, video-game]
...
Despite the presentation and implementation of **Starborn** as {% wiki Interactive_fiction|interactive fiction|en %}, I'd call it more of a short {% wiki Hypertext|hypertext|en %} story.
...
While this occurs in many interactive fiction stories and books in general, it feels like a serious cheat to not tell us about the protagonist or their family.  We know that the parents took a trip to {% wiki Epsilon_Eridani|Epsilon Eridani|en %}, and the lack of results ("just some rocks and gas planets") and the ship's name suggest that they might have made the trip for exploratory reasons, despite the mother's pregnancy.  And yet, nobody pays any mind to the first and possibly only child born during interstellar travel, and nothing in the story mentions the parents or doctor having any cultural prominence.
...
Assuming that I interpret the trip to Epsilon Eridani correctly, then we have the historically important ship *Magellan* and its doctor Strepke, plus Foucault Station---presumably referencing {% wiki L%C3%A9on_Foucault|Léon Foucault|en %}, for his work in verifying the Earth's shape---as Earth's orbiting space-port.
 ...
 * The creator of the work must have released it under a public license that would allow me to use parts of it in a work (the blog) licensed under CC-BY-SA.  For some common examples, CC0, MIT, BSD, ASF, MPL (I think), CC-BY, and CC-BY-SA itself.
