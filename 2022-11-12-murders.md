...
labels: [cc-by-sa, mit, programming, video-game]
...
Less plausible?  I suppose that the Museum of {% wiki Bash_%28Unix_shell%29|Bash|en %} History and TCSU---presumably, Terminal City State University---*could* theoretically exist, but they feel more like jokes than anything else.
