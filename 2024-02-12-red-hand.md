...
We observe {% wiki Red_Hand_Day|Red Hand Day|en %}, today, also known as the International Day against the Use of Child Soldiers, which...deals with what the more verbose name says.  If you prefer something a bit lighter-hearted, in the United States, many people celebrate today as {% wiki National_Freedom_to_Marry_Day|Freedom to Marry Day|en %}, part of the movement to destigmatize support of same-sex marriage.
