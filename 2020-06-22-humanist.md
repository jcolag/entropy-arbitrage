...
Yesterday was {% wiki World_Humanist_Day|World Humanist Day|en %}, celebrating a philosophical position that the value and agency of human beings is important, both individually and collectively.  As we wind down a month that, in the United States, is traditionally labeled {% wiki Gay_pride#LGBT_Pride_Month|LGBT Pride Month|en %} and has been packed with reasons to remind people that {% wiki Black_Lives_Matter|Black Lives Matter|en %}, that might not be worst idea to consider.
...
Of course, if you're Croatian, you may also be celebrating {% wiki Anti-Fascist_Struggle_Day|Anti-Fascist Struggle Day|en %} 🇭🇷, which...you'd think more countries would do that, given how much work the world has put into stopping fascists, and they *still* haven't gotten the hint.
