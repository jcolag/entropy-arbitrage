...
labels: [blog, mini-server, newsletter, notoboto, stenotype, tcl, yacy]
...
Today, at least for Eastern Canada and tiny parts of the United States (northern Maine), we memorialize the {% wiki Expulsion_of_the_Acadians|Expulsion of the Acadians|en %}, also known as the Grand Upheaval, an ethnic cleansing by British colonists, forcing out or killing about eighty percent of the native population, the survivors actively dodging capture.  If you know Longfellow's {% wiki Evangeline|*Evangeline*|en %}, then you know the broad strokes of the incident, except for descendants of the survivors fighting for recognition in court for two hundred, forty-three years.
...
Anyway, YaCy doesn't do any of that.  By contrast...actually, rather than try to explain it, I'll cite {% wiki YaCy|Wikipedia's article|en %} on YaCy, which seems fairly clear.
