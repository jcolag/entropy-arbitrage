...
In all "fairness," if these studies didn't exist, then the judges would probably do what Alito did in {% wiki Burwell_v._Hobby_Lobby_Stores,_Inc.|*Burwell v Hobby Lobby*|en %}, blocking scientific evidence that Plan B medication didn't cause abortions, in order to allow the defendant corporation to have "strongly held religious beliefs" about the abortion that doesn't happen.
