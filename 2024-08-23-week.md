...
I don't know how much of the industry (or the world, for that matter) quantum computing will *actually* change, but I've loved these tiny glimpses into the field since seeing the then-new {% wiki Shor%27s_algorithm|Shor's algorithm|en %} in graduate classes.
