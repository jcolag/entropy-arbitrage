...
Today, we celebrate {% wiki Hangul_Day|Hangul Day/한글날|en %}---Chosŏn'gŭl Day/조선글날 in the North---marking the fifteenth-century introduction of Korea's alphabet by {% wiki Sejong_the_Great|Sejong of Joseon|en %}.

If you don't go in for languages like I do, you might find {% wiki World_Post_Day|World Post Day|en %} more interesting, celebrating the anniversary of the Universal Postal Union.
