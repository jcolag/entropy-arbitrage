...
labels: [dashboard, iungimoji, nonogram]
...
Shockingly little is recorded as occurring on February 28<sup>th</sup>, so the most prominent and interesting item I could find is the anniversary of the {% wiki February_28_incident|February 29 Massacre|en %}, a Taiwanese anti-government uprising that governor Chen Yi brutally suppressed, leading to thousands of deaths, martial law, and the {% wiki White_Terror_%28Taiwan%29|White Terror|en %}.
