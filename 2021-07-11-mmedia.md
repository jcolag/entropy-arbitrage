...
Err...sorry, that's actually not an accurate assessment.  What I meant was that every conception *in a woman's womb* needed to be carried to term.  When a conservative comes along who believes that {% wiki In_vitro_fertilisation|IVF clinics|en %} should be regulated to bring each of their embryos to term and prosecuted when they're destroyed, that's considered an *extreme* position.
