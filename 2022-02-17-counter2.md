...
{% wiki Theta_Draconis|Theta Draconis|en %} (θ Dra) sits around seventy light years from Earth, and appears to be a binary star system.
...
Less useful but maybe amusing to some, in searching to see if the character was meant as a reference to something---other than {% wiki Kumara_%28plant%29|the plant|en %}, I mean---I stumbled on a website suggesting that a live-action Kumara should have been gender-swapped and played by the late {% wiki Elizabeth_Montgomery|Elizabeth Montgomery|en %}, which sounds like a fairly solid choice, to me, and is now how I see the Klingon.
...
While it's possible that the name is just fabricated, "Shakur" is an Arabic name meaning "deeply grateful," derived from one of the Islamic names of God.  And while it's entirely legitimate to believe that someone named the star for {% wiki Tupac_Shakur|Tupac|en %}---I mean, even *I* know who Tupac was---there's also {% wiki Shakhura|Shakhura|en %}, a village in Bahrain with burial mounds that are likely to become a UNESCO World Heritage Site.

 > "Lieutenant, there is a game humans play, a game Vulcans play.  It is called chess.  Ever hear of it?"

Given how anti-human the Vulcans we have met seem to be, it's probably notable that {% wiki Chess|chess|en %} has almost become considered a Vulcan game.
