...
labels: [st-tng, st-tng-s2, summary]
...
The "reasons that may become clear," if you didn't notice, mostly involve the {% wiki 1988_Writers_Guild_of_America_strike|writers strike|en %}.  Without writers, we saw a short second season, without scripts written by current writers.  As a result, the episodes relied more heavily on work done for **Phase II**, including some scripts adapted directly.
