...
Yes, either we count inmates at their home addresses *or* we let them vote where we've incarcerated them.  Otherwise, we get literally the wrong extreme of the {% wiki Three-fifths_Compromise|three-fifths compromise|en %}, of a captured population that counts for political representation but doesn't have any representation of its own.
