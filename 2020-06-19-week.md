...
I'd like to wish everyone in the United States a very happy {% wiki Juneteenth|Juneteenth|en %}!  I'm not entirely sure about the copyright of the audio, but this is {% wiki Lift_Every_Voice_and_Sing|*Lift Every Voice and Sing*|en %}, a 1905 song (words written in 1900) frequently used in the celebration.
...
It's thought by some historians that the definitive version by Wallis Willis pays tribute to the {% wiki Underground_Railroad|Underground Railroad|en %}.  Then, the Nazis hated it and it became popular with the {% wiki Civil_rights_movement|Civil Rights Movement|en %}, so if you're going to celebrate, that's a pretty solid pedigree.
...
[<i class="fab fa-twitter"></i>](https://jcolag.github.io/twitter/1272560749303513090)
...
[<i class="fab fa-twitter-square"></i>](https://jcolag.github.io/twitter/1272877586926825475) [These 8 steps for police abolition go further than #8Can’tWait](https://www.fastcompany.com/90514640/these-8-steps-for-police-abolition-go-further-than-8cantwait) from Fast Company
...
[<i class="fab fa-twitter"></i>](https://jcolag.github.io/twitter/1272922633865060354)
...
I've been saying, recently, that the fact that we don't have any statues honoring {% wiki Nat_Turner's_slave_rebellion|Nat Turner|en %}, {% wiki Madison_Washington|Madison Washington|en %}, {% wiki Gabriel_Prosser|Gabriel Prosser|en %}, or anybody else who led a slave rebellion disproves the assertion that the statues are meant to teach history or honor heritage.  The sole purpose of the statues is to remind people of white supremacy.

## 12:01 -- Wed 17 June 2020

[<i class="fab fa-twitter"></i>](https://jcolag.github.io/twitter/1273284518300934145)
...
[<i class="fab fa-twitter-square"></i>](https://jcolag.github.io/twitter/1273601607817547776) [A Judge Said George Floyd’s Name When He Denied Qualified Immunity to 5 Cops](https://www.vice.com/en_us/article/xg8yzk/a-judge-said-george-floyds-name-when-he-denied-qualified-immunity-to-5-cops) from VICE
...
[<i class="fab fa-twitter"></i>](https://jcolag.github.io/twitter/1273647661309202434)
...
[<i class="fab fa-twitter-square"></i>](https://jcolag.github.io/twitter/1273964498882383872) [Facebook Pitched New Tool Allowing Employers to Suppress Words Like “Unionize” in Workplace Chat Product](https://theintercept.com/2020/06/11/facebook-workplace-unionize/) from The Intercept
...
[<i class="fab fa-twitter"></i>](https://jcolag.github.io/twitter/1274009545858113538)
