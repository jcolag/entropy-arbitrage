...
Informal versions of Free Culture have always existed, in a sense, because copyright holders have wide discretion in whether they want to prosecute any given instance of infringement[^CDTMJP], and haven't always had much authority to do so.  Jonathan Swift's {% wiki Gulliver%27s_Travels|**Gulliver's Travels**|en %} (1726), for example, inspired a seemingly endless array of what we would now identify as fan fiction, including unauthorized sequels and deeper explorations of popular events from the book.  Similarly, Johann Wolfgang Goethe's {% wiki The_Sorrows_of_Young_Werther|**The Sorrows of Young Werther**|en %} (1774) inspired *Werther Fever*, where young Europeans in droves dressed as the author described Werther, acting in character as they went through their days, in effect *sturm und drang*'s version of Trekkies.  I can't find any evidence of Swift's or Goethe's reaction to any of them, and most of the world didn't really see derivative works as part of copyright until the {% wiki Berne_Convention|Berne Convention|en %} (1886), but the fact remains that many popular works spawned not only imitators, but direct adaptation.
...
Likewise, throughout modern history, you can find plenty of authors who absolutely did *not* appreciate imitations of their work.  The second part of {% wiki Don_Quixote|**The Ingenious Gentleman Don Quixote of La Mancha**|en %} (1615) has an entire passage where the characters mock and complain about an unauthorized continuation of their adventures that became popular during the ten years between parts, for a clear example, showing that many writers did feel a sense of ownership over their creations.  Some probably always have, despite the insistence of the people opposed to copyright---more about that later in the post---that something (increasingly, capitalism gets the blame) spoiled our ancestral consensus of creative works in some communal possession that everybody loved.
...
Back to the cultural side, as we slid to the end of the twentieth century in the United States, Congress passed the {% wiki Copyright_Term_Extension_Act|Sonny Bono Copyright Term Extension Act|en %} to tack twenty years onto all current copyright terms, followed the next day by the {% wiki Digital_Millennium_Copyright_Act|Digital Millennium Copyright Act|en %} to make a bunch of changes to the law, such as the following.
...
- Ban the circumvention of digital locks, allowing companies to control audience access through {% wiki Digital_rights_management|digital rights management|en %}
...
And because Congress for the first time extended the lengths of copyrights already granted, many people---including myself, by the way---feared that this would pretty much end the growth of the public domain, since the precedent would allow the government keep extending terms indefinitely.  That fear resulted in {% wiki Eldred_v._Ashcroft|*Eldred v Ashcroft*|en %}, challenging the constitutionality of the Copyright Term Extension Act.  {% wiki Lawrence_Lessig|Larry Lessig|en %} led Eldred's legal representation in front of the Supreme Court, and...by all accounts (including his own) "phoned it in," as they say, thinking that the bare facts spoke for themselves, so they lost.

Mind you, normal people didn't think of Supreme Court cases as political forums where you need to sway nine humans on an emotional level at the time, or at least a place where you shouldn't dryly lecture them on the text of laws and the Constitution and expect them to upend law for you, so Lessig became something of an Internet folk hero, and the {% wiki Free-culture_movement|Free Culture movement|en %} sprung up around the defeat, followed closely by Lessig helping to found [Creative Commons](https://creativecommons.org/).  As I have described elsewhere, Creative Commons wanted to deal with (or capitalize on, if you have a more cynical bend) the anger at copyright term extensions, the ongoing fight against music sampling in hip hop, and the attacks on Napster.
