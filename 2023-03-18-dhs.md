...
labels: [cc0, jenny-everywhere, prose, short-story]
...
Scanning ahead to get the word count, I see that both stories involve {% wiki Jenny_Everywhere|Jenny Everywhere|en %}, who came up in the discussion for [**Continuity Drift**]({% post_url 2021-01-30-drift %}), a bit more than a year ago.  There, I indicated that I disliked the character, so I figure that I should mention that again *now*, so that you can use that knowledge to counter any bias that might creep into the descriptions.
