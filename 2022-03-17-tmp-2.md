...
While we can't quite be certain with such tiny pictures and an incomplete historical record, it appears that the ship diagrams illustrate {% wiki HMS_Enterprise_%281705%29|the French frigate captured by the British|en %}, the {% wiki USS_Enterprise_%28CVN-65%29|American aircraft carrier|en %}, the {% wiki Space_Shuttle_Enterprise|first Space Shuttle|en %} (depicted in the header image), an unknown rocket-propelled vessel, and the *Enterprise* from the series.
...
Also, I can't help but notice that something that *McCoy* doesn't understand is called a "thing."  {% wiki Physician,_heal_thyself|Physician, heal thyself|en %}, right...?
...
*Voyager 6* launched "more than three hundred years ago," later mentioned as the late twentieth century, with NASA apparently all but forgotten, the way Decker reaches for the full name.  For context, {% wiki Voyager_program|*Voyagers 1* and *2*|en %} launched in 1977, meaning that this film takes place sometime later than 2277.
...
Since then, in 2012, *Voyager 1* became the first human artifact to cross the heliopause, entering what we think of as "interstellar space," heading towards {% wiki Ophiuchus|Ophiuchus|en %}.  Then, *Voyager 2* followed it across the heliopause in 2018, heading in the direction of {% wiki Pavo_%28constellation%29|Pavo|en %}.  Straddling the latter, we've had interstellar visitors {% wiki %CA%BBOumuamua|ʻOumuamua|en %} in 2017 and {% wiki 2I/Borisov|Borisov|en %} in 2019.
...
It seems unfair to their families, even cruel, to mark them as {% wiki Missing_in_action|missing in action|en %}.  Unless he expects super-V'Ger to stop by their family homes for holidays, Kirk chooses to deprive the survivors of emotional closure and probably insurance payments.
...
I can't find any references to the "necklace of energy collectors," so whoever published the idea probably didn't use that phrasing.  It bears at least some similarity, though, to a {% wiki Dyson_sphere|Dyson Sphere|en %}, which {% wiki Olaf_Stapledon|Olaf Stapledon|en %} described similarly.  Some suggest simplifying the sphere to a "Dyson ring," which would make an even closer match to the necklace analogy.

The other reference, though, probably intends to hint at {% wiki Gerard_K._O%27Neill|Gerard K. O'Neill|en %}, who developed plans for human space settlement in the 1970s, and so roughly contemporary to writing the book.
...
So far, characters have generally implied and even stated that the Federation officially speaks or most commonly speaks the English language, so either that idea has retroactively changed, or there we have some range of centuries far enough back that people call it "old"---but *not* referring to {% wiki Old_English|Old English|en %} as such---that they consider to have a rich pool of obscenities.  This also seems to indicate that their modern English might not have significant words considered profane.
...
I can't say whether this fictional history includes decades of {% wiki Surveillance_capitalism|surveillance capitalism|en %} like our world currently deals with, precisely, but it sounds like it might have, leading to a significant backlash.
