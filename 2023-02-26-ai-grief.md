...
thumbnail: /blog/assets/cyberpunk-wanderer.png
offset: -21%
...
![A cyberpunk-style picture of a trench-coated person on a purple-lighted dock looking out at a misty neon skyline](/blog/assets/cyberpunk-wanderer.png "Wanderer above Cheap LED Lighting and Fog")
...
Regardless, a lot of this comes from a variation on the {% wiki ELIZA_effect|ELIZA Effect|en %}, people assuming that we can and should trust a system that "speaks" in a friendly manner.  But it also seems bizarre for any adult to imagine that a language model would have any way of distinguishing fact from fiction.  You'd have nearly as much luck asking a medical expert system to proofread your essay; it *might* produce usable results, but I wouldn't trust it.
...
**Credits**: The header image adapts [Cyberpunk Seoul View](https://commons.wikimedia.org/w/index.php?curid=110405804) by mauveine.kim and [Ox1997cow](https://commons.wikimedia.org/wiki/User:Ox1997cow) and [More Than a Feeling](https://www.flickr.com/photos/41890311@N06/31662435116) by [Simon Jowett](https://www.flickr.com/photos/41890311@N06/31662435116), both made available under the terms of the [Creative Commons CC0 1.0 Universal Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0/deed.en), plus [Wanderer above the Sea of Fog](https://commons.wikimedia.org/wiki/File:Caspar_David_Friedrich_-_Wanderer_above_the_Sea_of_Fog.jpeg) by Caspar David Friedrich, in the public domain due to an expired copyright.  That composite image replaces one generated using NightCafé Studio.
