...
On the technical side, to generate the skeleton of this post, I had my feed-reader export an {% wiki OPML|Outline Processor Markup Language|en %} file, then wrote some boring code to pull out the names and URLs for each category as a Markdown list of links.  From there, I added the text.
