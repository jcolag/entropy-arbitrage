...
I'm a day late---unless you count my mention [on Friday]({% post_url 2021-06-18-week %})---since it didn't seem appropriate to bring up holidays as part of the [Free Culture Book Club](/blog/tag/bookclub) except when the work fits with the holiday, but I wanted to use this Sunday's post to talk a bit about {% wiki Juneteenth|Juneteenth|en %}, in light of its [acceptance as a federal holiday](https://www.voanews.com/usa/biden-signs-law-creation-juneteenth-holiday) in the United States.
...
The short version of Juneteenth is that, much as we---I mean white Americans, here---venerate the {% wiki Emancipation_Proclamation|Emancipation Proclamation|en %}, the reality is that it was basically toothless.
...
While James Weldon Johnson's 1900 hymn {% wiki Lift_Every_Voice_and_Sing|*Lift Every Voice and Sing*|en %} was written to celebrate Abraham Lincoln's birthday, it has been largely used to celebrate Juneteenth.  Either way, there's one part of a verse that should hit hard to each of us.
 ...
 * Largely meaningless beyond the inconvenience that their celebrations cause, such as {% wiki Columbus_Day|Columbus Day|en %}, with Columbus---who died in prison for abusing his power, don't forget---basically chosen as a national hero because he was the only explorer not already claimed by a rival country.  The only reason it's recognizable from a normal three-day weekend is by parades clogging up traffic.
 * Extremely narrow in their actual audience.  Many---possibly most---non-Catholic Christians treat {% wiki Easter|Easter|en %} as (at most) a slightly fancier Sunday, rather than the core of their religion, for example.  Of those, many just treat it as a minor secular holiday with gifts (allegedly from a decidedly non-Christian anthropomorphic rabbit, no less) and a big dinner, just to do *something* on the day.
 * Whitewashed to a degree that the holiday is meaningless.  {% wiki Labor_Day|Labor Day|en %} is probably the most prominent, here, a holiday meant to celebrate the labor movement, though the labor movement is almost never mentioned in celebrations and, instead, is discussed as "the unofficial end of summer."  The superior version of the day, what's now called {% wiki International_Workers%27_Day|International Workers' Day|en %}, was denounced as communist as other countries picked up the tradition, and largely abandoned.
 * Excuses to sell things.  No offense to fathers on {% wiki Father%27s_Day_%28United_States%29|Father's Day|en %}---{% wiki I%27m_not_racist,_I_have_Black_friends|some of my best friends|en %} are fathers, after all, and I myself am the *child* of a father---but your holiday is silly.  It's literally just a "but what about the men?" version of {% wiki Mother%27s_Day_%28United_States%29|Mother's Day|en %}, and Mother's Day was created by a woman so utterly obsessed with honoring her own mother, that she destroyed her mother's legacy in hopes of forcing more people to be like her.  And the sole tradition, in either case, is for kids to buy something for their parents, with the majority of those kids getting money and transportation from the same parents for the purpose.  It's harmless to the extent that commercialism can be, but it's still just an exercise to sell things.

By contrast, Juneteenth celebrates a real event that everybody should be able to get behind, and I'm more than happy if the people opposed to the event---like Matt Rosendale---aren't going to join the party as they lose their sad little culture war.  Juneteenth is also closer to the {% wiki Summer_solstice|summer solstice|en %} than any other American holiday, and as I'll probably briefly mention in tomorrow's post, a quick skim of lists turns up that it's a time of year apparently well-suited for patriotic celebrations.  We had the more-meaningless {% wiki Flag_Day_%28United_States%29|Flag Day|en %} last week and have the often-jingoistic {% wiki Independence_Day_%28United_States%29|Independence Day|en %} in two weeks, but Juneteenth is never more than two days from the solstice.  That should count for *something*.
