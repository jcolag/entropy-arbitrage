...
labels: [blog, doritis-onomaton, fylakas-onomaton, miniboost, mozilla]
...
Today is {% wiki Pachamama_Raymi|Pachamama Raymi|en %}, the Quechua culture's Mother Earth Feast.
 ...
 * {% wiki Public_holidays_in_the_Republic_of_Ireland|August Public Holiday|en %},
 * {% wiki Civic_Holiday|Civic Holiday|en %},
 * {% wiki National_Day_%28Benin%29|National Day|en %}, and
 * {% wiki Swiss_National_Day|National Holiday|en %}

Nothing says friends, family, and community, like not bothering to insert any informative nouns into your holiday's name.  At that point, it's also the {% wiki Unbirthday|unbirthday|en %} of billions of people, I would imagine.
