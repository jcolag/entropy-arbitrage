...
At one of my first jobs, I experimented with keyboard layouts in hopes of seeing a boost in speed.  I set my home and work machines to use the {% wiki Dvorak_keyboard_layout|Dvorak|en %} keyboard layout, for example.  I picked it up quickly, but didn't type any faster with it.  And since other people sometimes needed to use my computers, that experiment didn't last more than a couple of months.
