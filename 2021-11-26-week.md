...
The background is that the Bantu's {% wiki Ubuntu_philosophy|ubuntu philosophy|en %}, which we could simplify to "I am, because we are"---or that the humanity of humans rises from our relationships---is often ignored as somehow primitive.  So, the article/paper thinks about it in terms of competing against modern ethical theories, presumably with an eye toward applying it to artificial intelligence, given the institution.
