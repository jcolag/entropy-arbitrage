...
But before we get there, it's worth pointing out that "hundreds of light years from Earth" gives sort of a boundary on the size of human settlement and exploration.  It's possible that this means that most human activity is inside the {% wiki Local_Bubble|Local Bubble|en %}.
...
It's worth comparing this sketchy idea to {% wiki CRISPR_gene_editing|CRISPR-based gene editing|en %}, since that---in its most abtract form---operates via what's more or less an artificial retrovirus to modify the subjects *in vivo*.
...
{% wiki 70_Ophiuchi|70 Ophiuchi|en %} is, indeed, a near neighbor of Earth, but was identified as a binary star in the 1700s, making it an unlikely candidate for a duplicate of Earth.  On the other hand, in 1855, it became the first system for which analysis may have detected an exoplanet; whether there actually is a planet there remains to be seen, however.

If Ophiuchus sounds familiar, it may be because it has been occasionally touted as the {% wiki Ophiuchus_%28astrology%29|thirteenth sign|en %} of the zodiac over the last few decades.  If the star sounds familiar, {% wiki Dune_%28novel%29|**Dune**|en %} has "Sikun" as the third planet in the system as well as a few lesser-known novels and a variety of games.
...
{% wiki Spirochaete|Spirochaete|en %} are coiled bacteria with their flagella between a pair of membranes.  Not important, but surprisingly specific.
...
I expected Koch's Postulates to be a one-off invention for the episode, but {% wiki Koch's_postulates|nope|en %}, they describe four steps or criteria in identifying causation betwen a microbe and disease.
...
**Credits**: The header image is [The Blue Marble](https://commons.wikimedia.org/wiki/File:The_Earth_seen_from_Apollo_17.jpg) by the {% wiki Apollo_17|Apollo 17|en %} astronauts on December 7, 1972, placed in the public domain as a work of NASA and not otherwise noted.  What better representation for an exact duplicate of Earth than the exact duplicate's exact duplicate...?
