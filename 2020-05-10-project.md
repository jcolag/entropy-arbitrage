...
As you get more experience, you might want to consider putting the testing first, in fact.  Almost every modern programming language can take advantage of an automated testing system and {% wiki Test-driven_development|test-driven development|en %}, where you write a series of tests (small programs) that you know will fail, then write the code that makes them pass.
