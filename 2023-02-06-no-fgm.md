...
labels: [blog, social-media, tool-trunk]
...
However, today marks the (deep breath) {% wiki International_Day_of_Zero_Tolerance_for_Female_Genital_Mutilation|International Day of Zero Tolerance for Female Genital Mutilation|en %}, bringing awareness of the need to move societies beyond the urge to harm women as a means of controlling them.  If you haven't had need to learn about the topic, it involves removing or damaging the external female genitals of a young woman, with the intent of making sex less pleasant for her, all in pursuit of the poorly defined concept of virginity.  It carries no actual health benefits, but opens the patient up to a variety of medical risks.
...
If you'd prefer something to celebrate, instead, we have {% wiki S%C3%A1mi_National_Day|Sámi National Day|en %}, celebrating the heritage and culture of the ethnic minority in Scandinavia and parts of Russia.  If you enjoyed {% wiki Frozen_II|the sequel to the Disney movie with the Ice Queen, her sister, and the irritating snowman|en %}, the writers loosely based the displaced culture on the Sámi.
