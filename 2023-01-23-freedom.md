...
labels: [blog, dashboard, boring-css, miniboost, tool-trunk]
summary: Progress on assorted projects
thumbnail: /blog/assets/Sun-Yat-Sen.png
proofed: true
---
...
While the organization behind the holiday doesn't have the best history---The World League for Freedom and Democracy began as the World Anti-Communist League, and the change in name stems from the {% sfx ahem %} change in management in China---but {% wiki World_League_for_Freedom_and_Democracy#World_Freedom_Day|World Freedom Day|en %} celebrates the return of prisoners of the Korean War.  Part of me wants to appropriate it for something else, like a broader call for releasing prisoners of war...

Also, {% wiki Chinese_New_Year|Chinese New Year|en %} happened yesterday, kicking off the spring festival, so a happy new year to anyone celebrating it or the various new year celebrations derived from it.  🐇🐈  It takes two weeks, though, so it feels unfair to grab it as a holiday unless I happen to land on the actual new year.

![A portrait of Sun Yat-Sen](/blog/assets/Sun-Yat-Sen.png "This seemed less objectionable than showing the return of prisoners of war and the like")
...
**Credits**:  The header image comes from [Portrait of Sun Yat-sen](https://commons.wikimedia.org/wiki/File:%E6%9D%8E%E9%90%B5%E5%A4%AB%E5%AD%AB%E4%B8%AD%E5%B1%B112345.jpg) by Li Tiefu, in the public domain due to expired copyrights.
