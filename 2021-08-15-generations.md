...
{% wiki Steve_Bannon|Steve Bannon|en %} loves the idea.  That's the sort of issue that we're talking about, here.

## Strauss and Howe

Let's start with the basics.  The idea of fixed generations with predefined sociological characteristics comes from {% wiki Strauss%E2%80%93Howe_generational_theory|Fourth Turning theory|en %}.  It's barely coherent pseudoscience that would have made for a decent novel in the style of Isaac Asimov.  But instead, it tries to present a grand unified theory of history, where events magically transpire in eighty-or-so-year cycles of events...except when they don't.  Seriously, the chart has a generation missing, because the {% wiki American_Civil_War|American Civil War|en %} started "too early."
...
For example, given the theory's 1991 publication date, the theory's most important challenge was going to be to see what the {% wiki Millennials|Millennial generation|en %} would do, since they were about to come of age---hence the name---and were predicted to be similar to the so-called {% wiki Greatest_Generation|Greatest generation|en %} and the generations active during the aforementioned Civil War, the {% wiki Atlantic_Revolutions|Atlantic Revolutions|en %}, and similar major wars.  So, we're already off to a scheme that says that kids about to come of age were ideal for shipping off to wars.
...
Specifically, {% wiki Millennialism|**Millennialists**|en %} and {% wiki Millenarianism|**Millenarianists**|en %} are on the lookout for some version of {% wiki Last_judgment|final judgment|en %} that will issue in a new era, the {% wiki World_to_Come|World to Come|en %}, after all the terrible people have been judged unworthy and destroyed.
...
For Christians, ideas of this final judgment and World to Come are drawn from the {% wiki Book_of_Revelation|Book of Revelation|en %}, which---to simplify---involves a devastating war between good and evil in the vicinity of {% wiki Israel|Israel|en %}.  Good people get rewarded.  Bad people get punished.  Jesus comes to life for a third time, to rule over whatever's left of Earth as its king.

With any luck, the knot in your stomach increasing through the last couple of paragraphs is *not* because I've butchered Christian lore, but, because you might be lining up dates and seeing the similarities between the above prophecies and the {% wiki War_on_terror|War on Terror|en %}---focused on the Middle East, starting as close to the age of majority of Millennials as possible, pitched as a final battle of good and evil, and so forth---as being almost scripted precisely to fit these converging predictions/prophecies, and willing to sacrifice millions of human lives and faith in governments to do it.  You can see a similar influence in the obsession by some with recognizing Jerusalem as Israel's capital:  The city is named in the lore around *Revelations*.

The frustration with {% wiki Year_2000_problem|Y2K|en %} not triggering any disasters and making the doomsday preppers feel foolish *probably* didn't make this a less compelling connection.

### Millennials Ruin Everything

Many readers might also see the seed of the media obsession's with Millennials.  You---I mean those people who were young adults or nearly so, in 2001---were theorized to all line up dutifully to fight in...I don't know, maybe we can call it the "{% wiki Hipster_%28contemporary_subculture%29|Hipster|en %}'s {% wiki Popular_crusades|Crusade|en %}."  Instead, you largely stayed home, expecting to be able to earn a decent living and not spend money on useless services like people.
...
Like the Civil War "coming too early" instead of the theory just being wrong, I guess that we must have just received a bad batch of Millennials, who didn't know their place, generally preferring to oppose genocide and torture than to engage in it.  The {% wiki Donald_Rumsfeld|powers that be|en %} had a perfect plan to bring about the end of the world, and they would have succeeded, too, {% wiki Scooby-Doo|if it hadn't been for you meddling kids|en %} and your {% wiki Grumpy_Cat|dumb dog|en %}.  You ruined the end of the world...

If this sounds like *I'm* spinning a fringe political theory, I'd point out that {% wiki John_Hagee|John "Blood Moon Prophecy" Hagee|en %} was called John McCain's "spiritual advisor" until Hagee made some anti-Catholic statements and everybody stopped talking about him; McCain, you might recall [sang to an audience](https://citizentruth.org/john-mccain-sings-bomb-bomb-bomb-iran/) about bombing Iran to protect Israel.  The likes of {% wiki Nazim_Al-Haqqani|Nazim Al-Haqqani|en %}, {% wiki Edgar_Cayce|Edgar Cayce|en %}, {% wiki Sun_Myung_Moon|Sun Myung Moon|en %}, {% wiki Tynnetta_Muhammad|Tynnetta Muhammad|en %}, {% wiki Ed_Dobson|Ed Dobson|en %}, {% wiki True_and_Living_Church_of_Jesus_Christ_of_Saints_of_the_Last_Days|James Harmston|en %}, and {% wiki Jerry_Falwell|Jerry Falwell|en %} all picked 1999--2001 for their end of the world.  The big-name televangelists have also preached some version of the End Times being imminent---I've already mentioned Falwell, {% wiki Pat_Robertson|Pat Robertson|en %} published a book suggesting 2007, and {% wiki Harold_Camping|Harold Camping|en %} and {% wiki Jack_Van_Impe|Jack Van Impe|en %} pick new dates whenever another date passes and we're still here---and are open about their support of Israel being connected to the end of the world.  If you wonder why voters of certain political parties tend not to care about corruption, it's because they're banking on things in this world being hopeless.
