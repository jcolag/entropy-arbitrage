...
For older audiences, possibly the most notable thing about this episode is that it was co-written by actress and ventriloquist {% wiki Shari_Lewis|Shari Lewis|en %} and her second husband.
...
It's difficult to guess where the name itself might come from, though if you forced me to guess, I'd suggest that Zetar could refer to {% wiki Zeta_Reticuli|zeta Reticuli|en %} (ζ Reticuli), about forty light-years from Earth, and largely known for UFO lore that talks about {% wiki Grey_alien|gray aliens 👽|en %}.  If that's the case, then this episode would be the first mainstream reference to the star in fiction.
