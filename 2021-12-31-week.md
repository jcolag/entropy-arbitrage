...
**Credits**:  Header image is [Circular diagrams showing the division of the day and of the week](https://commons.wikimedia.org/wiki/File:CLM_14456_71r_detail.jpg) from a manuscript drafted during the Carolingian Dynasty.  The subway map is {% wiki File:NYC_subway-4D.svg|NYC subway-4D|en %} by {% wiki User:CountZ|Jake Berman|en %}.
