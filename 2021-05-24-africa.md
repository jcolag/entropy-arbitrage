...
labels: [blog, fylakas-onomaton, miniboost]
...
Tomorrow is {% wiki Africa_Day|Africa Day|en %}, commemorating the founding of the organization that has since become the {% wiki African_Union|African Union|en %} in 1963.
...
I eventually needed to call in technical support.  The solution still looks suspicious to me, but it can wait.  And as an aside, it looks like my site is now ready for when software finally starts taking {% wiki IPv6|IPv6|en %} seriously.  Apparently, wildcard records don't work for the names that people actually use?  I don't get it...
