...
{% wiki Trillium|Trillium|en %} last got a mention in [*Errand of Mercy*]({% post_url 2020-07-09-mercy %}), where I mentioned that the name *probably* refers to the flowering plant, despite the context---a presumed atomic weight---strongly implying a chemical element.
