...
labels: [recipe, library-update, social-media]
...
Today, or rather in this day from 1843 -- 1898 or so, Hawaii celebrated the recognition of its sovereignty and independence by England and France, as {% wiki Independence_Day_%28Hawaii%29|Lā Kūʻokoʻa|en %}.  Mostly vanished since, adherents to {% wiki Hawaiian_sovereignty_movement|Hawaiian sovereignty|en %} do still celebrate it as a recognition that Hawaii became...oh, "significantly less independent and sovereign," let's call it, in the 1890s.
