...
Hoping to head off the inevitable response where it repeats whatever appears at the first search results for the keywords, I specified that I did *not* want a list of novels where something mathematical happens or gets mentioned in the story.  I already know that {% wiki Flatland|**Flatland**|en %} exists, for example, and know that it does *not* contain references to any fictional branches of mathematics.
