...
labels: [blog, dashboard, html, tool-trunk]
...
Today, but for the infamous American allergy to communism, everybody would celebrate {% wiki May_Day|May Day|en %} as Labor Day.  However, because the United States associated the holiday with the Soviet Union we have our own Labor Day in September, and this day became referred to as {% wiki International_Workers%27_Day|International Workers' Day|en %}, celebrated pretty much everywhere except the United States.
