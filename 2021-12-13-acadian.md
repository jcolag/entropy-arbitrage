...
labels: [auto-story, blog, doritis-onomaton, hardware, intern, miniboost, nonogram]
...
Far from a happy celebration, in certain communities, today marks {% wiki Acadians|Acadian|en %} Remembrance Day, the anniversary of the deaths of two thousand deported Acadians.  If that's not enough of a downer, this is also {% wiki Nanjing_Massacre|Nanjing Massacre|en %} Memorial Day in China.
