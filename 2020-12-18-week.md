...
In telecommunications terms, you'll usually hear problems like this referred to as {% wiki Metcalfe%27s_law|Metcalfe's law|en %}, the idea that the value of a network is in the number of connected "terminals."  But there's an added aspect, here, of algorithmic promotion.
