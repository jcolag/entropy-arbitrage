...
You probably want to know that {% wiki Lorelei|Lorelei or Loreley|en %} is a rock on the Rhine's bank.

![The Lorelei, in 1900](/blog/assets/Loreley-LOC.png "It was a BIG rock...")

It's relevant to this story's title, because of {% wiki Clemens_Brentano|Clemens Brentano|en %}'s 1801 *Zu Bacharach am Rheine* ballad, about "Lore Ley," a woman accused of bewitching men and leading them to their deaths, ultimately dying when she falls from the Lorelei thinking that she saw her lover's face in the river.  {% wiki Heinrich_Heine|Heinrich Heine|en %} adapted the idea for his 1824 poem *Die Lorelei*, who's a {% wiki Siren_%28mythology%29|siren|en %} or similar creature who lives on the Lorelei.  The header image is a memorial to Heine.
...
I can't find a reference to anything (except for a young basketball player) named Taurean, so I assume that this is a reference to the constellation {% wiki Taurus_%28constellation%29|Taurus|en %}, in an adjectival form.
...
Scott is singing *Yr Hufen Melyn* ("The Yellow Cream"), a Welsh song with lyrics adapted from a poem of the same name by {% wiki Eliseus_Williams|Eifion Wyn|en %}.

 > **MCCOY**: Cortropine. Could help. It's a strong stimulant.

Cortropine appears to be original to the episode, and also another brand name, since it doesn't really match up to the generic stems.  Technically, *-cort-* can be used for {% wiki Cortisone|cortisone|en %} derivatives, but cortisone isn't a stimulant and the stem isn't interior to the word, so we can rule that out.
...
Rifton might be named for {% wiki Rifton%2C_New_York|the New York hamlet|en %} primarily known for including the site of {% wiki Sojourner_Truth|Sojourner Truth|en %}'s birth.
...
He also objects to the orders themselves, though I won't quote it.  Here, they're escorting an ore caravan, from "Carson's World" to Bethulia III, the latter presumably named for {% wiki Bethulia|the Biblical city|en %}, whereas there are too many possible Carsons to even try to guess Foster's intended reference.
...
The episodes actual plot comes courtesy of Vice Admiral for Science Julianna van Leenwenhook, presumably named in honor of {% wiki Antonie_van_Leeuwenhoek|Antonie van Leeuwenhoek|en %}.  Kirk mentally compares the stakes to "the Mantilles Incident," as a reference to [*One of Our Planets Is Missing*]({% post_url 2021-09-02-missing %}).
...
The facility seems to have been named for {% wiki Kinshasa|the capital|en %} of the Democratic Republic of the Congo.
...
**Credits**: The header image is [The Loreli, the Rhine, Germany](https://www.loc.gov/pictures/collection/pgz/item/2002714142/) by an unknown photographer.  The picture of {% wiki Ernst_Herter|Ernst Herter|en %}'s [the Lorelei Monument](https://commons.wikimedia.org/wiki/File:Heine_Bronx_1.jpg) is by {% wiki Benutzer:Schreibkraft|Schreibkraft|de %}, made available under the terms of the [Creative Commons Attribution-Share Alike 2.0 Germany](https://creativecommons.org/licenses/by-sa/2.0/de/deed.en) license.
