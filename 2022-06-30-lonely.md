...
I have no evidence of this, but I assume that the Renner constellation (original to this episode) formed to relaunch the {% wiki Jeremy_Renner_Official|Jeremy Renner app|en %}.  Look, I *could* tell you about various people and places named Renner, but none of them seem like a likely candidate to name a planet, let alone an entire constellation with at least two stars.

The word {% wiki Parliament|parliament|en %} refers to certain unicameral legislative bodies, primarily---though not exclusively---those where the executive office derives its power from that legislature.  It derives from the French, basically "a speakers' forum," or literally "a speaking."
...
Also note that our own society will need to start dealing with these issues.  Many investors consider {% wiki Cultured_meat|cultured meat|en %} to have the potential to become a big industry.  And because they'll need to, those companies will advertise based on the conceptual distance between meat and animal, while also avoiding the perception that...you'll find a difference between their product and killing an animal.
...
The man who won't shut up about his French heritage loves {% wiki Sherlock_Holmes|Sherlock Holmes|en %}, but doesn't want to talk about {% wiki Eug%C3%A8ne_Fran%C3%A7ois_Vidocq|Eugène François Vidocq|en %}, the basis for almost all fictional and *real* detective work?  Not even {% wiki Monsieur_Lecoq|Lecoq|en %}, from whom Holmes directly borrows?
...
We discussed this line in---though produced and released later, due to our initial focus on the original cast---[**The Undiscovered Country**]({% post_url 2022-04-21-tuc %}), likewise paraphrasing (not quite quoting) {% wiki The_Adventure_of_the_Beryl_Coronet|*The Adventure of the Beryl Coronet*|en %}.
