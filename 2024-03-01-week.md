...
Before [moving to Linux]({% post_url 2024-02-18-linux %}), I briefly tried Avast when then-competitor {% wiki AVG_AntiVirus|AVG|en %}, before the scandals and acquisition by Avast, seemed to have a few problems running on my computer at the time.  Avast didn't last long, because even then, it felt too invasive.
