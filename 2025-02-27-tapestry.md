...
The town(?) presumably refers to {% wiki Chesley_Bonestell|Chesley Bonestell|en %}, Californian artist known mostly for his astronomical work.  A [crater on Mars](https://planetarynames.wr.usgs.gov/Feature/814) takes its name from him, which maybe implies the location.
...
Presumably, they named the base after celebrity pilot {% wiki Amelia_Earhart|Amelia Earhart|en %}, important enough to so many people that even the Wikipedia page punts on the matter of her legacy to tell us that "countless tributes and memorials" take her name.
...
{% wiki Rigel|Rigel|en %} has gotten fairly regular mentions since [*Mudd's Women*]({% post_url 2020-02-20-trek-m-women %}), so I won't go into the naming and location, but I don't think that we've met anybody *from* that solar system prior to Penny.
...
Does Starfleet not teach *any* restraint?  This seems like the lowest bar of insults, petty enough that they made it a recurring comedic plot point in the {% wiki Back_to_the_Future_%28franchise%29|*Back to the Future*|en %} franchise years earlier.
