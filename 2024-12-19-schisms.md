...
{% wiki Amargosa_Valley,_Nevada|Nevada|en %}, (formerly) {% wiki Death_Valley_Junction,_California|California|en %}, {% wiki Amargosa,_Texas|Texas|en %}, and {% wiki Amargosa,_Brazil|Brazil|en %} all have places named Amargosa.
...
This sounds like a new catalog, because I can only find {% wiki FGC-9|ghost guns|en %} and locomotives using those initials as a prefix.
