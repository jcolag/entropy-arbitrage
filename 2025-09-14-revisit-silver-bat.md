...
As a basis for the general idea, I took Batman as a broad archetype.  I grew up on Batman comics and the Adam West-led TV series, plus the character has one of the strongest trademarks in the world, as I understand it.  And at the time, the movies had recently "rebooted" the character to fit the Superman films, and *already* started talking about the next reboot, giving the impression that I probably couldn't find a more mainstream inspiration.
