...
I love that "the Melkotian's concept of an American frontier town" is basically a {% wiki Potemkin_village|Potemkin village|en %} with some props, almost certainly a Western movie set for with fewer interior walls for easier filming.

![Titles for Mazeppa](/blog/assets/Mazeppa.png "Titles for Mazeppa")

There's a poster for the (real, if fairly obscure) play **Mazeppa**---about {% wiki Ivan_Mazepa|Ivan Mazeppa|en %} and based on {% wiki Mazeppa_%28poem%29|the Byron poem|en %}, probably the version by {% wiki Henry_M._Milner|Henry M. Milner|en %}---starring Angela Rossini, the character played by Sophia Loren in {% wiki Heller_in_Pink_Tights|**Heller in Pink Tights**|en %} in 1960.
...
The events represented in the episode are referred to as the {% wiki Gunfight_at_the_O.K._Corral|Gunfight at the O.K. Corral|en %}, though it's a safe bet that the episode is highly influenced by contemporary depictions, particularly the {% wiki Gunfight_at_the_O.K._Corral_%28film%29|movie of the same name|en %} ten years prior and {% wiki Hour_of_the_Gun|**Hour of the Gun**|en %} the year before.
...
Here's another reference to {% wiki Cossacks|Cossacks|en %}, and I've already discussed the implications of using that as a slur in [*The Trouble with Tribbles*]({% post_url 2020-11-19-trouble %}).

 > **KIRK**: Chekov, mortar and pestle.

I'm admittedly impressed that Chekov even knows what a {% wiki Mortar_and_pestle|mortar and pestle|en %} are.  Today, the primary use is among people who cook and want a small amount of an ingredient ground down instead of chopped and shredded, as happens in a food processor.  It's possible that's still true in the future, though I have trouble imagining that hundreds of years of technology has *not* included a mechanical equivalent.
...
M-rays are original to this episode, but we could probably assume that they're higher-frequency radiation than {% wiki Gamma_ray|gamma rays|en %}.  The name evokes {% wiki N_ray|N rays|en %}, previously known forms of electromagnetic radiation that were misidentified as something novel.
...
He's talking about a more mystical version of {% wiki Genetic_memory_%28psychology%29|genetic memory|en %}---bordering on {% wiki Akashic_records|Akashic records|en %}---where anybody with a family history on the so-called American frontier probably has some latent skill as a gunfighter.

There's also a mention of [*City on the Edge of Forever*]({% post_url 2020-07-23-edge %}), apparently the official name of the ruins where the Guardian sits, comparing Spock's ability to build a computer from his tricorder in 1930 New York and his stricter limitations in 1881 Arizona.  There's also a mention that "Preliform D" is the future all-purpose anesthetic that's analogous to {% wiki Chloroform|chloroform|en %}.
...
McCoy shows that a large part of his practice involves something similar to {% wiki Acupressure|acupressure|en %}.  He also mentions that, like {% wiki Doc_Holliday|"Doc" Holliday|en %}, he's from the {% wiki Atlanta|Atlanta|en %} metropolitan area.  The entire scene is fleshed out more, with Holliday trying to convince McCoy-as-{% wiki Frank_McLaury|McLaury|en %} (spelled "McClowery," here) to join with the Earps.
