...
The holidays for today are a bit thin, but having something of an interest of languages, Old Permic Alphabet Day, celebrating the {% wiki Old_Permic_script|Old Permic script|en %}, an adaptation of the more common {% wiki Cyrillic_script|Cyrillic alphabet|en %}.
