...
labels: [cc-by-sa, prose, short-story]
summary: Discussing short fan fiction
thumbnail: /blog/assets/duelyst-frostfire-background.png
...
![A city with strange architecture lit in bold colors](/blog/assets/duelyst-frostfire-background.png "I couldn't find any images that actually made sense.")
...
*Shattering Bullet* describes itself as fan fiction for {% wiki Sword_Art_Online|*Sword Art Online*|en %}, which I have no exposure to beyond this post.  It provides the following summary.
...
**Credits**:  I adapted the header image from [**Duelyst**](https://github.com/open-duelyst/duelyst)'s "Frostfire" scene background, made available under the terms of the [Creative Commons CC0 1.0 Universal Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0/).
