...
labels: [common-calendar, library-update]
...
Today marks the 113<sup>th</sup> anniversary of the founding of {% wiki Tel_Aviv|Tel Aviv-Yafo|en %} (תֵּל־אָבִיב-יָפוֹ).  While I realize that any discussion of modern Israeli settlement quickly becomes fraught with recriminations on all sides for what details get a voice and which do not, starting with whether to include {% wiki Jaffa|Yafo|en %} in the name at all, and what name to use.  However, given the lack of holidays today, the anniversary of a major metropolis seems fair, regardless of the policies of the parent government.
