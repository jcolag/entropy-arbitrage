...
This would basically be that, but with a single place to fill in a URL (maybe validate it) and, optionally, a switch to turn the feature on and off to allow people to step out of the {% wiki Panopticon|Panopticon|en %} when necessary.
