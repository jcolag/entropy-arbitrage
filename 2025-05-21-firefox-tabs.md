...
Notice the filename's extension, though.  We have JSON, but compressed with {% wiki LZ4_%28compression_algorithm%29|LZ4|en %}.  I compiled [lz4json](https://github.com/andikleen/lz4json), which...oh, let's let the author explain.
