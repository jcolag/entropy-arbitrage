...
labels: [roku-wake, twitterbot, uxuyu]
...
There isn't much to choose from, in terms of holidays, but it happens to be portrait painter {% wiki Mary_Brewster_Hazelton|Mary Brewster Hazelton|en %}'s birthday, the first woman known to win a non-gendered award---the first Julius Hallgarten Prize---in the United States.
