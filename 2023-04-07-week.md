...
It goes to show how weak even they see themselves, doesn't it?  After spending untold sums of money to capture the Supreme Court to {% wiki Citizens_United_v._FEC|protect dark money|en %}, over twenty years revitalizing moves to suppress voting, a bit more than a decade to {% wiki REDMAP|capture state legislatures|en %}, and more.  But even with all those advantages---effectively cheating, in any other context---they *still* can't win, and now want to give themselves the right to overrule what their constituents vote on.
