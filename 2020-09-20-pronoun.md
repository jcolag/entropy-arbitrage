...
First, if you need an overview of what role a pronoun serves, try {% wiki Pronoun|the article on Simple English Wikipedia|simple %}.  Instead, if you just need to get up to speed on personal gender pronouns, you want {% wiki Preferred_gender_pronoun|this Wikipedia article|en %}.  I'm just going to assume that anybody who managed to find my blog and not run in horror is already on-board with the idea of thinking that validating other people's identities is a good way to live life.  You're allowed to stay here, if you don't, but it's a safe bet that you're not going to find much to read that doesn't make you angry...
...
It also feels comparable to---though obviously not the same as---{% wiki Cultural_appropriation|cultural appropriation|en %}, in that it takes something that is special to an oppressed minority and pushes it into wider adoption without the context that makes it important.  Specifically, it turns gender identity into a box to performatively check on a checklist.

Likewise, there's an unmistakable resemblance to the people who shout "{% wiki All_Lives_Matter|All Lives Matter|en %}," too, in that it feels like an attempt to assert that my pronouns "matter."  They don't, not even to me, and certainly not to the degree that someone else's pronouns matter in this context.  So who am I to interject my pronouns into the conversation?
