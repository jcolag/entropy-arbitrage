...
Highlander is one of those places that gets some occasional, quiet press like this, but is actually {% wiki Highlander_Research_and_Education_Center|an organization|en %} that we should all be much more familiar with.
