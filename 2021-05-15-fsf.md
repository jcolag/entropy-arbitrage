...
labels: [animation, cc-by-sa, film, series, superhero]
...
If you're here, I'd guess that you probably already have *some* exposure to the FSF.  But if you don't, they're a non-profit organization promoting the idea that consumers should be allowed to modify and redistribute software without restriction, recommending software released under public licenses that support that end.  In recent years, they've expanded to oppose the use of {% wiki Digital_rights_management|digital rights management|en %} and sometimes software patents or other issues.
