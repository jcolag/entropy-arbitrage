...
Thank you, comic. {% emoji raised fist %} This section includes a significant run of related comics, too, some taking even more direct aim[^1].  And I should mention that many of those comics have some annotations citing the arguments that it rebuts, verifying that it hasn't created a {% wiki Straw_man|straw man argument|en %}.
