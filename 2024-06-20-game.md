...
The *Zhukov* got a mention in [*Hollow Pursuits*]({% post_url 2023-09-21-hollow-pursuits %}) and [*Data's Day*]({% post_url 2024-01-18-data-s-day %}), so you can read about {% wiki Georgy_Zhukov|Georgy|en %} (Георгий Жуков) and his (alleged) obsession with smuggling Coca-Cola into the Soviet Union by camouflaging it as vodka in the latter post.
...
Or maybe this has nothing to do with fascism.  After all, one other organization has regularly obsessed over Latin in the modern era, the Catholic Church.  Perhaps instead of seeing fascism, the Federation represents a Catholic state, in a timeline where the {% wiki Second_Vatican_Council|Second Vatican Council|en %} didn't allow for substituting vernacular language in Mass.  That would fit with Spock pulling out so many Biblical references in the original series.  Doesn't that make you feel cozier...?
...
OK, a {% wiki Sadie_Hawkins_dance|Sadie Hawkins dance|en %} derives from a 1937 {% wiki Li%27l_Abner|**Al Capp**|en %} comic strip, and posits a topsy-turvy world where women and girls can ask men and boys to escort them.  Let me rephrase that for clarity:  For this single event, women may ask men out on dates.  And why do I need to deal with this nonsense?
...
Ugh.  Did Wesley invent {% wiki Negging|negging|en %}, here?  Worse, did this episode train a generation of television viewers to believe that insulting a woman would make Ashley Judd like you...?
...
The {% wiki Septal_area|septal area|en %} does, in fact, exist.
