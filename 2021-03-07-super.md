...
{% imgr Green Turtle checking his keys|GreenTurtle.png|Green Turtle checking his keys %}

First appearing in mid-1946 and only a couple more times after, you *might* notice that Major Randy Ronald looks like every other comic book white guy that you're likely to run across.  Like the caption says, though, he "has been disfigured beyond recognition."  Alec Hope---a pseudonym for {% wiki Alvin_Hollingsworth|Alvin Hollingsworth|en %}---intended for Ronald to have been a Black pilot wearing a bronze mask, hence the character's name.  Color in early comic books was hard, though, so we got what we got, apparently also wearing bronze gloves and a wig.
...
No, I don't mean being sent to Earth when his home planet was about to blow up.  I mean that we should look at the sources that {% wiki Jerry_Siegel|Jerry Siegel|en %} and {% wiki Joe_Shuster|Joe Shuster|en %} used to create one of the world's most famous characters.

### Mythology

Some aspects of Superman are clearly drawn from mythological and religious figures.  Siegel credited {% wiki Hercules|Hercules|en %} and {% wiki Samson|Samson|en %} frequently enough that it's just taken as an article of faith by fans, at this point.  {% wiki Gilgamesh|Gilgamesh|en %}, {% wiki C%C3%BA_Chulainn|Cú Chulainn|en %}, and others would have been far more obscure at the time, but filled a similar mythological role.

![Samson Slaying the Lion](/blog/assets/Sansón-matando-al-león.png "Samson Slaying the Lion")

Never mentioned by Siegel that I can find, but extremely obvious and frequently noted, is the similarity in origin stories to {% wiki Moses|Moses|en %}.  Moses was sent in a tiny ship by his parents to escape the imminent devastation of his people, so that he could grow up with parents of another race, and would ultimately discover that he has abilities that nobody else has and set himself to the task of making the world a better place.  The details are different, of course.  The crisis Moses escapes is the mass execution of Hebrew boys, rather than the destruction of a planet, for example.  The ship his mother uses is a small raft, rather than an interstellar rocket.  His "power" is relaying messages from the Biblical God, rather than leaping over tall buildings in single bounds and so forth.  But the shape of his story is too similar to ignore.
...
The first example is that the initial conceit of the book---secretly dosing Matilda with a mystery chemical---brings to mind medical experimentation on Black people, including Black women, which dates at least as far back as {% wiki J._Marion_Sims|J. Marion Sims|en %}.
...
Her family is known for its strength.  Her maiden name is also similar to that of {% wiki Frederick_Douglass|Frederick Douglass|en %}.
 ...
 * {% wiki Olga_Mesmer|Olga Mesmer|en %}, the Girl with the X-Ray Eyes, was a comic strip in Pulp magazines from one of the companies that would become DC Comics, published for about the year or so prior to Superman's release.  She's the daughter of a foreign queen with great strength (that she occasionally loses) and X-Ray vision that can sometimes blast people.  Her mother is from "Sitnalta," with no real indications of ethnicity in the run of the strip beyond that fictional lost civilization that's eventually revealed to be on Venus.  She probably wasn't a strong influence on Superman, given that Siegel and Shuster were already trying to sell the character, but the strong similarity is worth mentioning.
 * Bingham Harvard, protagonist of {% wiki Alias_the_Night_Wind|**Alias the Night Wind**|en %}, the novel it's based on, and the novel's sequels.  Given that Harvard was adopted by a wealthy banker and spent his teenage years in the high society of Manhattan, with nobody commenting on it---despite making *absolutely* sure that we know that a servant is Black---he's probably white.  However, it's also unlikely that the stories were a significant influence on Superman, given how infrequently Harvard uses his strength, though he could have easily inspired **Gladiator**.
 * {% wiki Hugo_Hercules|Hugo Hercules|en %}, a brief weekly comic strip, where this Hugo is the sort of superhero who just runs errands for people.  Like Mesmer, the simplified line art shows no real indicator of race, as you can see at the link.
 * {% wiki Popeye|Popeye|en %}, eventual star of **Thimble Theater**, who I assume everybody is at least superficially familiar with.  I don't seriously consider him to be in the vein of Superman, but he's a comic strip character who's strong, so maybe I'm wrong.
 * {% wiki Harold_Lloyd|Harold Lloyd|en %}'s "Glasses" character, who may as well have been Clark Kent, which I believe Siegel has admitted.  Lloyd identified as Welsh.
 * {% wiki Maciste|Maciste|en %} is an Italian movie hero with incredible strength, who was popular for the first half of the twentieth century.
...
As long as we're going to talk about whitewashing superheroes, we should talk about one of the only early successful *copies* of Superman, too:  {% wiki Wonder_Woman|Wonder Woman|en %}.  Given that her movie launch was one of DC's first recent box office successes, you're probably already aware of the broad outlines of the character, daughter of Hippolyta (who fought Hercules), who comes to the United States in hopes of putting an end to war.  But you're *probably* not aware that she was originally Superman's competition.
...
The two companies published what today would be surprisingly similar line-ups.  Where National had {% wiki Batman|Batman|en %} (1939) as a dark avenger of the night, All-American had {% wiki Doctor_Mid-Nite|Dr. Mid-Nite|en %} (1941).  As wizards with foreign headgear, {% wiki Doctor_Fate|Dr. Fate|en %}'s (1940) counterpart was {% wiki Sargon_the_Sorcerer|Sargon the Sorcerer|en %} (1941).  For flying guys using ancient weapons to fight modern crime in a golden helmet, you have {% wiki Shining_Knight_%28Sir_Justin%29|Shining Knight|en %} (1941) or {% wiki Hawkman#The_Golden_Age_Hawkman_%28Carter_Hall%29|Hawkman|en %} (1940).  Running fast in a red outfit is handled by {% wiki Johnny_Quick_%28Johnny_Chambers%29|Johnny Quick|en %} (1941) and the {% wiki Flash_%28Jay_Garrick%29|Flash|en %} (1940).  And for super-strong foreigners dressed like the American flag to inspire hope, there's Superman (1938) and Wonder Woman (1941).  I don't know how intentional that similarity was, but the similarity between Superman and Wonder Woman is undeniable, and it's consistent with how the publisher operated.

![Amazons vs Greeks](/blog/assets/Amazons-vs-Greeks.png "Amazons vs Greeks")

And it's with Wonder Woman that we have (with Bronze Man and Green Turtle, from the start of this discussion) the clearest example of whitewashing a superhero's identity.  After all, our premiere heroine is Diana, princess of the {% wiki Amazons|Amazons|en %}, a legendary tribe of warrior women from ancient Greek myth.  They weren't Greek, but rather presumed to be from beyond where the Greeks had explored, usually described as Anatolia (modern-day Turkey) or Libya.  Modern archaeology---analyzing skeletons of high-ranking military women who had been wounded in battle---suggests modern day Turkey and Iran.

{% imgr Seh-Dong-Hong-Beh|Seh-Dong-Hong-Beh.png|Seh-Dong-Hong-Beh %}

Of course, I'd be remiss if I failed to mention a more modern group called Amazons, the {% wiki Dahomey_Amazons|Minon|en %} from Dahomey (modern-day Benin).  There's no evidence that Wonder Woman was created with the so-called Dahomey Amazons in mind---and there's plenty of evidence to the contrary, given the Grecian trappings of the stories---but if we want to claim that {% wiki William_Moulton_Marston|William Moulton Marston|en %} wasn't thinking about Turks, then these ladies are the next in line.

Despite the fact that there's no version of the Amazon story (or evidence) where they're white, however, that's how Wonder Woman is portrayed in comics.  Even live-action versions have been limited to {% wiki Lynda_Carter|Lynda Carter|en %}---mostly northern European with some Mexican ancestry---and {% wiki Gal_Gadot|Gal Gadot|en %}, whose ancestry is central European.  They're good in their roles---my big regret as a child was not watching the **Wonder Woman** TV series, because it's a lot of fun, and Carter is still amazing decades later---but it whitewashes a character whose origin demands that she be Arabic, probably Turkish, though African (from Libya or Benin) is also possible.

For eighty years, DC's Amazons have tended to be envisioned with pale skin and mostly blonde or red, sometimes black, hair.  Recent versions of history have explained that Amazons come from *all over* the world, adding Black, East Asian, and Native American Amazons...basically just to justify Diana still being portrayed as white.  We're given {% wiki Nubia_%28character%29|Nubia|en %} and upcoming character Yara Flor as minor or alternate heroines to show that Amazons don't *need* to be white, even though the important one always is.
...
In other words, just because {% wiki Kirk_Alyn|Kirk Alyn|en %}, {% wiki George_Reeves|George Reeves|en %}, {% wiki Christopher_Reeve|Christopher Reeve|en %}, {% wiki John_Newton_%28actor%29|John Haymes Newton|en %}, {% wiki Gerard_Christopher|Gerard Christopher|en %}, {% wiki Tom_Welling|Tom Welling|en %}, {% wiki Brandon_Routh|Brandon Routh|en %}, {% wiki Henry_Cavill|Henry Cavill|en %}, {% wiki Tyler_Hoechlin|Tyler Hoechlin|en %}, and (to a lesser extent) David Wilson (from the televised version of the stage musical) and {% wiki Dean_Cain|Dean Cain|en %} all bear an unmistakable resemblance to each other and the majority of their ancestors were all born in northwestern Europe, it doesn't necessarily follow that a "real" Superman would necessarily look like them.
...
{% pull whiteness over the past eighty-plus years of superhero comic books was "checking a box."|left %}

And finally, we have the most important rebuttal:  So what?  The predominance of whiteness over the past eighty-plus years of superhero comic books was "checking a box."  In some cases, that box was nearly literal, in the form of navigating censorship from the {% wiki Comics_Code_Authority|Comics Code Authority|en %}.  I mean that literally, and there's a story about EC Comics and the Code that {% wiki EC_Comics#.22Judgment_Day.22|you should read|en %}, which verifies it.  That box was, in effect, "don't make white supremacists uncomfortable."  So, this is actually *un*checking the box that restricts most people from being chosen for roles.
...
The other common complaint is that companies should never change the race (or gender) of *existing* characters.  That is, DC should put its energy for diversity into a movie about {% wiki Icon_%28character%29|Icon|en %}---a more recent character who resembles Superman, but is explicitly Black---and leave Superman alone.  That's an assertion that's almost as straightforward to disassemble, too.
...
I mean, even {% wiki Batman_%26_Robin_%28film%29|**Batman & Robin**|en %} and {% wiki Superman_IV:_The_Quest_for_Peace|**Superman IV**|en %} doubled the studio's investment, even though they're objectively shoddy movies.  By contrast, {% wiki Green_Lantern_%28film%29|**Green Lantern**|en %} barely made a profit, because Ryan Reynolds isn't the best choice for the role *and* nobody cares enough about that brand to overcome that.  Likewise, {% wiki Steel_%281997_film%29|**Steel**|en %} was a complete failure, despite being a surprisingly fun movie, for similar reasons of Shaquille O'Neal being miscast or poorly directed (though fine) and insufficient public interest in the character to overcome the flaws.

{% pull complete failure with some slim chance of being a minor success, or...significant success that could potentially be mildly disappointing %}
