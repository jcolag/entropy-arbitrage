...
Good news, everyone:  Humanity conquered the {% wiki Common_cold|common cold|en %}, a group of minor upper respiratory tract infections caused by *hundreds* of different viruses.  (The many causes and minor inconveniences are why we haven't put work into curing it.)
...
Many Europeans, for example, associated the {% wiki Bubonic_plague|bubonic plague|en %} with the Jewish community, which contributed to vampire mythology, incidentally; this especially resonates, given that Data identified himself as a Shylock figure in [*The Naked Now*]({% post_url 2022-06-02-naked %}).  Every country blamed {% wiki Syphilis|syphilis|en %} on neighbors, from Ireland to Japan.  The United States associated {% wiki Cholera|cholera|en %} outbreaks with Irish immigration, creating a self-fulfilling prophecy, as temperance movements led people to drink infected water.  Italian immigrants took the blame for {% wiki Polio|polio|en %}.  And we all watched as the Chinese took the blame for COVID-19.
...
Anyway, you surely already know {% wiki Isaac_Asimov|Isaac Asimov|en %}'s name.  The positronic brain comes from his {% wiki Reason_%28short_story%29|*Reason*|en %} (1941), substituting electricity and electronics with the electron's antimatter counterpart, the {% wiki Positron|positron|en %}.  No, it doesn't make any sense that a computer running on anti-electricity (positricity?) would become any smarter than a commodity laptop computer.

*Reason* tells the story of a messianic computer that both no longer cares about humans, but also protects them, because of the pre-programmed laws of robotics.  Surely, that information will have nothing to do with this episode.  {% sfx ahem %}  But ignoring the plot aspects, we should wonder what kind of self-absorbed sociopath reads a cautionary tale and {% wiki Metaverse|orients its company to making it come true|en %}. {% sfx ahem, ahem %}
...
Oh, also, Lore refers to {% wiki Let%27s_Call_the_Whole_Thing_Off|*Let's Call the Whole Thing off*|en %}, a 1937 Gershwin Brothers song for Fred Astaire and Ginger Rogers.

 > **WORF**: Where he examined some micro-miniature work tools, and some fine-grind quadratanium ?

As you can guess, "quadratanium" doesn't exist outside this episode, probably named for something like {% wiki Titanium|titanium|en %}.
