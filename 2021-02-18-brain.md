...
The word "advanced" is key, here, because {% wiki Ion_thruster|ion engines|en %} have been discussed since 1911 and operated in a small scale since 1959.  So, the Federation definitely has ion propulsion, just not something that can propel a ship as fast as the *Enterprise*.
...
The remote-controlled Spock is delightfully absurd, sure, but this is mostly just an application of {% wiki Luigi_Galvani|Luigi Galvani|en %} experiments electrifying frog legs to make them twitch.

You might recognize Spock's outfit from [*This Side of Paradise*]({% post_url 2020-06-25-para %}), though.

While I'm trying to elevate this episode with references, the situation between the Morg and Eymorg (not to mention the names) resembles that of the Morlocks and Eloi from {% wiki The_Time_Machine|**The Time Machine**|en %}.
...
I can't be completely sure, since Spock---true to form---appears to have the wrong culture for this to be true, but I *believe* that this is a reference to the {% wiki Lysistrata|**Lysistrata**|en %}, a comedy about how Greek (not Roman) women ended the Peloponnesian War with a sex strike.
