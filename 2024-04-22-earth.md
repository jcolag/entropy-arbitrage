...
labels: [blog, earburn, json-resume, lights-edge, social-media]
...
Today, we observe {% wiki Earth_Day|Earth Day|en %}, demonstrating support for environmental protection.  This year has a theme of *Planet vs. Plastics*, which...I don't know, seems out of step with the modern environmental movement, but whatever.  Interestingly, the first Earth Day in 1970, particularly the protest-and-demonstration side, largely comes to us through the {% wiki Earth_Day|United Auto Workers|en %}.  Related, we also have {% wiki International_Mother_Earth_Day|International Mother Earth Day|en %}, recognizing Earth's ecosystems as our home, and promoting harmony with nature.
