...
Honestly, though, a lot of the principles involved in this argument apply more widely, so I think it's worth talking about.
...
All of those failures were not only predictable, but you can find people *complaining* about those blind spots from the start, only to be told that it didn't matter, because would never want to modify firmware or a server.
