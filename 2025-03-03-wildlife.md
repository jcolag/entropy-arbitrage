...
labels: [blog, css, open-badges, yaml]
...
Today marks {% wiki World_Wildlife_Day|World Wildlife Day|en %}, a United Nations event to raise awareness of...well, the world's wildlife and its contributions to ecology and beneficial effects on humans.
...
**Credits**:  The header image is [Australisk fauna](https://commons.wikimedia.org/wiki/File:Australisk_fauna,_Nordisk_familjebok.jpg) by an unnamed contributor to the {% wiki Nordisk_familjebok|**Nordisk familjebok**|en %}, long in the public domain due to an expired copyright.
