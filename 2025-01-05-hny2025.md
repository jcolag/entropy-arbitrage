...
The books seem more exciting than we've seen in previous years, at least to me.  However, we see more works by women and Black people---the latter, with many works as part of the {% wiki Harlem_Renaissance|Harlem Renaissance|en %}---than we have seen in recent years.

 * Stanley A. Coblentz, {% wiki After_12,000_Years|**After 12,000 Years**|en %}
 * Lloyd C. Douglas, {% wiki Magnificent_Obsession|**Magnificent Obsession**|en %}
 * Mignon G. Eberhart, {% wiki The_Patient_in_Room_18|**The Patient in Room 18**|en %}
 * William Faulkner, {% wiki The_Sound_and_the_Fury|**The Sound and the Fury**|en %}
 * Rachel Field, {% wiki Hitty,_Her_First_Hundred_Years|**Hitty, Her First Hundred Years**|en %}
 * Floyd Gibbons, {% wiki The_Red_Napoleon|**The Red Napoleon**|en %}
 * Patrick Hamilton, {% wiki Rope_%28play%29|**Rope**|en %}
 * Dashiell Hammett, {% wiki Red_Harvest|**Red Harvest**|en %} and {% wiki The_Maltese_Falcon_%28novel%29|**The Maltese Falcon**|en %} (serialized versions)
 * Ernest Hemingway, {% wiki A_Farewell_to_Arms|**A Farewell to Arms**|en %}
 * DuBose Heyward, {% wiki Mamba%27s_Daughters|**Mamba's Daughters**|en %}
 * Oliver La Farge, {% wiki Laughing_Boy_%28novel%29|**Laughing Boy**|en %}
 * Nella Larsen, {% wiki Passing_%28novel%29|**Passing**|en %}
 * Sinclair Lewis, {% wiki Dodsworth_%28novel%29|**Dodsworth**|en %}
 * Elizabeth Miller, {% wiki Pran_of_Albania|**Pran of Albania**|en %}
 * Ursula Parrott, {% wiki Ex-Wife_%28Ursula_Parrott%29|**Ex-Wife**|en %}
 * "Ellery Queen," {% wiki The_Roman_Hat_Mystery|**The Roman Hat Mystery**|en %}
 * Jessie Redmon, {% wiki Plum_Bun|**Plum Bun**|en %}
 * Helen Hoover Santmyer, {% wiki The_Fierce_Dispute|**The Fierce Dispute**|en %}
 * Agnes Smedley, {% wiki Daughter_of_Earth|**Daughter of Earth**|en %}
 * John Steinbeck, {% wiki Cup_of_Gold|**Cup of Gold**|en %}
 * Wallace Thurman, {% wiki The_Blacker_the_Berry_%28novel%29|**The Blacker the Berry**|en %}
 * Lynd Ward, {% wiki Gods%27_Man|**God's Man**|en %}
 * Arthur Wesley Wheen, the first English translation of {% wiki All_Quiet_on_the_Western_Front|**All Quiet on the Western Front**|en %} by Erich Maria Remarque
 * Thomas Wolfe, {% wiki Look_Homeward,_Angel|**Look Homeward, Angel**|en %}
 * Virginia Woolf, {% wiki A_Room_of_One%27s_Own|**A Room of One's Own**|en %}
...
This list gets fairly long, so I'll skip sifting through for specifics and point you to {% wiki List_of_American_films_of_1929|Wikipedia's list|en %}.  Of note that I see, you start to routinely see names like {% wiki Frank_Capra|Frank Capra|en %}, {% wiki Douglas_Fairbanks_Jr.|Douglas Fairbanks Jr.|en %} and {% wiki Loretta_Young|Loretta Young|en %}, {% wiki Lionel_Barrymore|Lionel Barrymore|en %}, {% wiki Barbara_Stanwyck|Barbara Stanwyck|en %}, {% wiki Rin_Tin_Tin|Rin Tin Tin|en %}, {% wiki Joan_Crawford|Joan Crawford|en %}, and many more that you'll recognize.
 ...
 * {% wiki Blackmail_%281929_film%29|*Blackmail*|en %}, directed by Alfred Hitchcock, his first sound film
 ...
 * {% wiki Am_I_Blue%3F|*Am I Blue?*|en %}, lyrics by Grant Clarke, music by Harry Akst, probably most notable for almost immediately going into the soundtrack of multiple films
 * {% wiki An_American_in_Paris|*An American in Paris*|en %}, George Gershwin
 * {% wiki Connie%27s_Hot_Chocolates|**Connie's Hot Chocolates**|en %}, most prominently {% wiki Ain%27t_Misbehavin%27_%28song%29|*Ain’t Misbehavin’*|en %} and {% wiki Black_and_Blue_%28Fats_Waller_song%29|*(What Did I Do to Be So) Black and Blue*|en %}, lyrics by Andy Paul Razaf, music by Thomas W. “Fats” Waller & Harry Brooks
 * {% wiki Crazy_About_My_Baby|*Crazy About My Baby*|en %}, by Blind Roosevelt Graves
 * FDR campaign song {% wiki Happy_Days_Are_Here_Again|*Happy Days Are Here Again*|en %}, lyrics by Jack Yellen, music by Milton Ager
 * {% wiki Honey_%28Rudy_Vall%C3%A9e_song%29|*Honey*|en %}, lyrics and music by Seymour Simons, Haven Gillespie, and Richard A. Whiting
 * {% wiki Puttin%27_On_the_Ritz|*Puttin' on the Ritz*|en %}, lyrics and music by Irving Berlin
 * {% wiki Singin%27_in_the_Bathtub|*Singin' in the Bathtub*|en %}, music by Michael H. Cleary, with lyrics by Herb Magidson and Ned Washington
 * {% wiki Singin%27_in_the_Rain_%28song%29|*Singin’ in the Rain*|en %}, lyrics by Arthur Freed, music by Nacio Herb Brown
 * {% wiki Tiptoe_Through_the_Tulips|*Tiptoe Through the Tulips*|en %}, lyrics by Alfred Dubin, music by Joseph Burke
 * {% wiki Waiting_for_a_Train_%28Jimmie_Rodgers_song%29|*Waiting for a Train*|en %}, lyrics and music by Jimmie Rodgers
 * {% wiki Wake_Up_and_Dream_%28musical%29|**Wake Up and Dream**|en %}, most notably {% wiki What_Is_This_Thing_Called_Love%3F|*What Is This Thing Called Love?*|en %}, by Cole Porter
 * {% wiki You_Rascal_You|*You Rascal You*|en %}, lyrics and music by Sam Theard
 * {% wiki You_Were_Meant_for_Me_%28Arthur_Freed_and_Nacio_Herb_Brown_song%29|*You Were Meant for Me*|en %}, lyrics by Arthur Freed, music by Nacio Herb Brown
