...
*Sargon* is an Assyrian name that dates to nearly five thousand years, including a name used by an {% wiki Sargon_of_Akkad|Akkadian emperor|en %} or {% wiki Sargon_I|two|en %}.  Well, {% wiki Sargon_II|three|en %}, actually.  There's some evidence that the name might mean "legitimate king," which, if you have to *call* yourself that, it's probably not true.

We'll also meet Thalassa and Henoch, presumably named for the pre-Greek {% wiki Thalassa|sea-spirit|en %} and one of Judaism's mythological {% wiki Thalassa|earliest humans|en %}.
...
They have the ability to keep bodies alive, but only for about a month, suggesting that this is fairly mechanical work, probably something like a sustained version of sustained {% wiki Cardiopulmonary_resuscitation|CPR|en %}, rather than stimulation or bypass techniques.
