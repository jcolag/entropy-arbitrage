...
Anyway, I have no idea what the planet's name refers to.  I choose to believe that they colonized a world based on the teachings of (at the time) **In Living Color** cast member {% wiki Marlon_Wayans|Marlon Wayans|en %}.  The episode will churn through around a lot of fictional jargon, so excuse me if I don't quote the individual lines to tell you that the words seem to originate in the script.
...
They presumably named the shuttle after {% wiki Enrico_Fermi|Enrico Fermi|en %}.

 > **WORF**: We have just received a distress signal from the Starfleet science team on Lygos Seven.

I almost missed this, but I *believe* that they named the star after the original name for {% wiki History_of_Istanbul#Lygos|Istanbul|en %}, roughly three thousand years ago at its founding.
