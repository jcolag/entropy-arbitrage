...
Today, we observe the {% wiki International_Day_for_the_Abolition_of_Slavery|International Day for the Abolition of Slavery|en %}, drawing attention to and celebrating 1949's {% wiki Convention_for_the_Suppression_of_the_Traffic_in_Persons_and_of_the_Exploitation_of_the_Prostitution_of_Others|anti-trafficking convention|en %} and a call to (like the name of the day says) end the practice of slavery.  The current estimates around fifty million victims includes employers taking the passports of migrants to pressure them into staying in construction or domestic work, forced prostitution, states using prisoners for forced labor, and forced marriages.
