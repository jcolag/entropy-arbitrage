...
As you might guess, "Questar M-17" isn't a known space object.  More likely, it's a reference to {% wiki Questar_Corporation_%28gas_company%29|the energy company|en %} now part of Dominion, the {% wiki Questar_Corporation|telescope company|en %}, or the science fiction publisher now owned and ignored by {% wiki Questar_Science_Fiction|Hachette|en %}.  It was also a {% wiki Bull_Questar|brand|en %} of mainframe computer terminals.  Wherever the name comes from, it was probably front-of-mind for the writers, because Gene Roddenberry's {% wiki The_Questor_Tapes|**The Questor Tapes**|en %} (with an **o**) made-for-TV movie would have been in production around this time.
...
I've been told that, for people who lived in the Los Angeles metropolitan area, this was *not* the first episode aired.  In 1973, {% wiki George_Takei|George Takei|en %} ran for a Los Angeles Councilman seat.  Local NBC affiliates didn't want to try to figure out how to count up the time that his lines took, in order to give equal time to the other candidates in the race.
...
I assume that's a sly reference to {% wiki Santa_Monica,_California|Santa Monica|en %}, though I can't any reference for whom *JLR* might be.
...
So, the good news is that this at least hints at a culture, with all those fields of endeavor put on the same level and...everything recorded on {% wiki Microform|microfilm|en %}.
...
{% wiki Praise_the_Lord_and_Pass_the_Ammunition|*Praise the Lord and Pass the Ammunition*|en %} is a 1942 Frank Loesser song, about an Army chaplain who abandons his duties during the {% wiki Attack_on_Pearl_Harbor|attack on Pearl Harbor|en %} to shoot back at the Japanese planes.  This song is apparently popular enough to still be known centuries later, and clearly meant to be a cultural touchstone for Scott.  The earlier series already established Scott as both militant and bigoted, so this isn't nearly as surprising as it could be.
...
Heh.  Despite my previous discussion of McCoy's presumed religion, his version of "my God" refers to (the Roman version of) {% wiki Asclepius|Asclepius|en %}, mythical hero and god of medicine.  Five syllables to announce shock...
...
While this is just used as a reason to get Spock and McCoy to bicker, Spock is basically explaining {% wiki Microaggression|microaggressions|en %}.  In this case, Kirk is unintentionally suggesting that only humans are curious.
...
Not surprisingly, {% wiki Electric_cello|electric cellos|en %} exist, though aren't particularly popular.  Of possible interest is that Kirk seems to suggest that an interest in {% wiki Classical_music|classical music|en %} is common.
